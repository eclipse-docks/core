...
`,Fr,M=class extends ut{constructor(){super(),Dr(this,Fr,!1),this.initialReflectedProperties=new Map,this.didSSR=!!this.shadowRoot,this.customStates={set:(e,t)=>{if(this.internals?.states)try{t?this.internals.states.add(e):this.internals.states.delete(e)}catch(e){if(String(e).includes(`must start with '--'`))console.error(`Your browser implements an outdated version of CustomStateSet. Consider using a polyfill`);else throw e}},has:e=>{if(!this.internals?.states)return!1;try{return this.internals.states.has(e)}catch{return!1}}};try{this.internals=this.attachInternals()}catch{console.error(`Element internals are not supported in your browser. Consider using a polyfill`)}this.customStates.set(`wa-defined`,!0);let e=this.constructor;for(let[t,n]of e.elementProperties)n.default===`inherit`&&n.initial!==void 0&&typeof t==`string`&&this.customStates.set(`initial-${t}-${n.initial}`,!0)}static get styles(){return[Pr,...Array.isArray(this.css)?this.css:this.css?[this.css]:[]]}connectedCallback(){super.connectedCallback(),this.shadowRoot?.prepend(document.createComment(` Web Awesome: https://webawesome.com/docs/components/${this.localName.replace(`wa-`,``)} `))}attributeChangedCallback(e,t,n){Er(this,Fr)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&this[t]!=null&&this.initialReflectedProperties.set(t,this[t])}),Or(this,Fr,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{e.has(n)&&this[n]==null&&(this[n]=t)})}firstUpdated(e){super.firstUpdated(e),this.didSSR&&this.shadowRoot?.querySelectorAll(`slot`).forEach(e=>{e.dispatchEvent(new Event(`slotchange`,{bubbles:!0,composed:!1,cancelable:!1}))})}update(e){try{super.update(e)}catch(e){if(this.didSSR&&!this.hasUpdated){let t=new Event(`lit-hydration-error`,{bubbles:!0,composed:!0,cancelable:!1});t.error=e,this.dispatchEvent(t)}throw e}}relayNativeEvent(e,t){e.stopImmediatePropagation(),this.dispatchEvent(new e.constructor(e.type,{...e,...t}))}};Fr=new WeakMap,D([k()],M.prototype,`dir`,2),D([k()],M.prototype,`lang`,2),D([k({type:Boolean,reflect:!0,attribute:`did-ssr`})],M.prototype,`didSSR`,2);var Ir=`important`,Lr=` !`+Ir,N=pn(class extends mn{constructor(e){if(super(e),e.type!==fn.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Lr);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Ir:``):n[e]=r}}return Ke}}),Rr=class extends M{constructor(){super(...arguments),this.localize=new T(this),this.isLoaded=!1}handleClick(){this.play=!this.play}handleKeyDown(e){(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.play=!this.play)}handleLoad(){let e=document.createElement(`canvas`),{width:t,height:n}=this.animatedImage;e.width=t,e.height=n,e.getContext(`2d`).drawImage(this.animatedImage,0,0,t,n),this.frozenFrame=e.toDataURL(`image/gif`),this.isLoaded||=(this.dispatchEvent(new lr),!0)}handleError(){this.dispatchEvent(new cr)}handlePlayChange(){this.play&&(this.animatedImage.src=``,this.animatedImage.src=this.src)}handleSrcChange(){this.isLoaded=!1}render(){let e=`${this.localize.term(this.play?`pauseAnimation`:`playAnimation`)} ${this.alt}`;return b`
    ...
    `}};Rr.css=xr,D([j(`.animated`)],Rr.prototype,`animatedImage`,2),D([A()],Rr.prototype,`frozenFrame`,2),D([A()],Rr.prototype,`isLoaded`,2),D([k()],Rr.prototype,`src`,2),D([k()],Rr.prototype,`alt`,2),D([k({type:Boolean,reflect:!0})],Rr.prototype,`play`,2),D([E(`play`,{waitUntilFirstUpdate:!0})],Rr.prototype,`handlePlayChange`,1),D([E(`src`)],Rr.prototype,`handleSrcChange`,1),Rr=D([O(`wa-animated-image`)],Rr);var zr=y`
  :host {
...
`,mo=class extends M{constructor(){super(...arguments),this.hasError=!1,this.image=``,this.label=``,this.initials=``,this.loading=`eager`,this.shape=`circle`}handleImageChange(){this.hasError=!1}handleImageLoadError(){this.hasError=!0,this.dispatchEvent(new cr)}render(){let e=b`
      <img
        part="image"
        class="image"
        src="${this.image}"
    ...
    `,t=b``;return t=this.initials?b`<div part="initials" class="initials" role="img" aria-label=${this.label}>
      ...
      `,b` ${this.image&&!this.hasError?e:t} `}};mo.css=po,D([A()],mo.prototype,`hasError`,2),D([k()],mo.prototype,`image`,2),D([k()],mo.prototype,`label`,2),D([k()],mo.prototype,`initials`,2),D([k()],mo.prototype,`loading`,2),D([k({reflect:!0})],mo.prototype,`shape`,2),D([E(`image`)],mo.prototype,`handleImageChange`,1),mo=D([O(`wa-avatar`)],mo);var ho=y`
  :host {
...
`,_o=class extends M{constructor(){super(...arguments),this.variant=`brand`,this.appearance=`accent`,this.pill=!1,this.attention=`none`}render(){return b`
      <span part="start">
    ...
    `}};_o.css=[go,ho],D([k({reflect:!0})],_o.prototype,`variant`,2),D([k({reflect:!0})],_o.prototype,`appearance`,2),D([k({type:Boolean,reflect:!0})],_o.prototype,`pill`,2),D([k({reflect:!0})],_o.prototype,`attention`,2),_o=D([O(`wa-badge`)],_o);var vo=y`
  .breadcrumb {
    display: flex;
    align-items: center;
    flex-wrap: wrap;
  }
`,yo=class extends M{constructor(){super(...arguments),this.localize=new T(this),this.separatorDir=this.localize.dir(),this.label=``}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll(`[id]`)].forEach(e=>e.removeAttribute(`id`)),e.setAttribute(`data-default`,``),e.slot=`separator`,e}handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()===`wa-breadcrumb-item`);e.forEach((t,n)=>{let r=t.querySelector(`[slot="separator"]`);r===null?t.append(this.getSeparator()):r.hasAttribute(`data-default`)&&r.replaceWith(this.getSeparator()),n===e.length-1?t.setAttribute(`aria-current`,`page`):t.removeAttribute(`aria-current`)})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),b`
    ...
    `}};yo.css=vo,D([j(`slot`)],yo.prototype,`defaultSlot`,2),D([j(`slot[name="separator"]`)],yo.prototype,`separatorSlot`,2),D([k()],yo.prototype,`label`,2),yo=D([O(`wa-breadcrumb`)],yo);var bo=y`
  :host {
...
`,Lo=class extends M{constructor(){super(...arguments),this.localize=new T(this)}render(){return b`
      <svg
        part="base"
        role="progressbar"
    ...
    `}};Lo.css=Io,Lo=D([O(`wa-spinner`)],Lo);var Ro=y`
  :host {
    display: inline-flex;
  }
...
`,zo=class extends M{constructor(){super(...arguments),this.disableRole=!1,this.hasOutlined=!1,this.label=``,this.orientation=`horizontal`}updated(e){super.updated(e),e.has(`orientation`)&&this.setAttribute(`aria-orientation`,this.orientation)}handleFocus(e){Bo(e.target)?.classList.add(`button-focus`)}handleBlur(e){Bo(e.target)?.classList.remove(`button-focus`)}handleMouseOver(e){Bo(e.target)?.classList.add(`button-hover`)}handleMouseOut(e){Bo(e.target)?.classList.remove(`button-hover`)}render(){return b`
      <slot
        part="base"
        class="button-group"
      ...
      ></slot>
    `}};zo.css=[Ro],D([j(`slot`)],zo.prototype,`defaultSlot`,2),D([A()],zo.prototype,`disableRole`,2),D([A()],zo.prototype,`hasOutlined`,2),D([k()],zo.prototype,`label`,2),D([k({reflect:!0})],zo.prototype,`orientation`,2),zo=D([O(`wa-button-group`)],zo);function Bo(e){let t=`wa-button, wa-radio-button`;return e.closest(t)??e.querySelector(t)}var Vo=y`
  :host {
    display: flex;
    position: relative;
    align-items: stretch;
...
`,Ho=class extends M{constructor(){super(...arguments),this.variant=`brand`,this.size=`m`}handleSizeChange(){Do(this.localName,this.size)}render(){return b`
      <div part="icon">
        <slot name="icon"></slot>
      </div>
    ...
    `}};Ho.css=[Vo,go,ko],D([k({reflect:!0})],Ho.prototype,`variant`,2),D([k({reflect:!0})],Ho.prototype,`appearance`,2),D([k({reflect:!0})],Ho.prototype,`size`,2),D([E(`size`)],Ho.prototype,`handleSizeChange`,1),Ho=D([O(`wa-callout`)],Ho);var Uo=y`
  :host {
...
`,Wo=class extends M{constructor(){super(...arguments),this.hasSlotController=new Oo(this,`footer`,`header`,`media`,`header-actions`,`footer-actions`,`actions`),this.appearance=`outlined`,this.withHeader=!1,this.withMedia=!1,this.withFooter=!1,this.orientation=`vertical`}willUpdate(){!this.withHeader&&this.hasSlotController.test(`header`)&&(this.withHeader=!0),!this.withMedia&&this.hasSlotController.test(`media`)&&(this.withMedia=!0),!this.withFooter&&this.hasSlotController.test(`footer`)&&(this.withFooter=!0)}render(){return this.orientation===`horizontal`?b`
    ...
    `}};Wo.css=[ko,Uo],D([k({reflect:!0})],Wo.prototype,`appearance`,2),D([k({attribute:`with-header`,type:Boolean,reflect:!0})],Wo.prototype,`withHeader`,2),D([k({attribute:`with-media`,type:Boolean,reflect:!0})],Wo.prototype,`withMedia`,2),D([k({attribute:`with-footer`,type:Boolean,reflect:!0})],Wo.prototype,`withFooter`,2),D([k({reflect:!0})],Wo.prototype,`orientation`,2),Wo=D([O(`wa-card`)],Wo),Wo.disableWarning?.(`change-in-update`);var Go=class extends Event{constructor(e){super(`wa-slide-change`,{bubbles:!0,cancelable:!1,composed:!0}),this.detail=e}},Ko=`useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict`,qo=(e=21)=>{let t=``,n=crypto.getRandomValues(new Uint8Array(e|=0));for(;e--;)t+=Ko[n[e]&63];return t};function R(e,t,n){return(e=>Object.is(e,-0)?0:e)(e<t?t:e>n?n:e)}function Jo(e=``){return`${e}${qo()}`}var Yo=class{constructor(e,t){this.timerId=0,this.activeInteractions=0,this.paused=!1,this.stopped=!0,this.pause=()=>{this.activeInteractions++||(this.paused=!0,this.host.requestUpdate())},this.resume=()=>{--this.activeInteractions||(this.paused=!1,this.host.requestUpdate())},e.addController(this),this.host=e,this.tickCallback=t}hostConnected(){this.host.addEventListener(`mouseenter`,this.pause),this.host.addEventListener(`mouseleave`,this.resume),this.host.addEventListener(`focusin`,this.pause),this.host.addEventListener(`focusout`,this.resume),this.host.addEventListener(`touchstart`,this.pause,{passive:!0}),this.host.addEventListener(`touchend`,this.resume)}hostDisconnected(){this.stop(),this.host.removeEventListener(`mouseenter`,this.pause),this.host.removeEventListener(`mouseleave`,this.resume),this.host.removeEventListener(`focusin`,this.pause),this.host.removeEventListener(`focusout`,this.resume),this.host.removeEventListener(`touchstart`,this.pause),this.host.removeEventListener(`touchend`,this.resume)}start(e){this.stop(),this.stopped=!1,this.timerId=window.setInterval(()=>{this.paused||this.tickCallback()},e)}stop(){clearInterval(this.timerId),this.stopped=!0,this.host.requestUpdate()}},Xo=y`
  :host {
    --aspect-ratio: 16 / 9;
    --scroll-hint: 0px;
...
`;function Zo(e,t){return new Promise(n=>{function r(i){i.target===e&&(e.removeEventListener(t,r),n())}e.addEventListener(t,r)})}async function Qo(e,t,n){return e.animate(t,n).finished.catch(()=>{})}function z(e,t){return new Promise(n=>{let r=new AbortController,{signal:i}=r;if(e.classList.contains(t))return;e.classList.add(t);let a=!1,o=()=>{a||(a=!0,e.classList.remove(t),n(),r.abort())};e.addEventListener(`animationend`,o,{once:!0,signal:i}),e.addEventListener(`animationcancel`,o,{once:!0,signal:i}),requestAnimationFrame(()=>{!a&&e.getAnimations().length===0&&o()})})}function $o(e){return e=e.toString().toLowerCase(),e.indexOf(`ms`)>-1?parseFloat(e)||0:e.indexOf(`s`)>-1?(parseFloat(e)||0)*1e3:parseFloat(e)||0}function es(){return window.matchMedia(`(prefers-reduced-motion: reduce)`).matches}function*ts(e,t){if(e!==void 0){let n=0;for(let r of e)yield t(r,n++)}}function*ns(e,t,n=1){let r=t===void 0?0:e;t??=e;for(let e=r;n>0?e<t:t<e;e+=n)yield e}(()=>{let e=(e,t)=>{let n=0;return function(...r){window.clearTimeout(n),n=window.setTimeout(()=>{e.call(this,...r)},t)}},t=(e,t,n)=>{let r=e[t];e[t]=function(...e){r.call(this,...e),n.call(this,r,...e)}};if(!(`onscrollend`in window)){let n=new Set,r=new WeakMap;document.addEventListener(`pointerdown`,e=>{n.add(e.pointerId)}),document.addEventListener(`pointerup`,e=>{n.delete(e.pointerId)}),t(EventTarget.prototype,`addEventListener`,function(t,i){if(i!==`scroll`)return;let a=e(()=>{n.size?a():this.dispatchEvent(new Event(`scrollend`))},100);t.call(this,`scroll`,a,{passive:!0}),r.set(this,a)}),t(EventTarget.prototype,`removeEventListener`,function(e,t){if(t!==`scroll`)return;let n=r.get(this);n&&e.call(this,`scroll`,n,{passive:!0})})}})();var rs=class extends M{constructor(){super(...arguments),this.loop=!1,this.slides=0,this.currentSlide=0,this.navigation=!1,this.pagination=!1,this.autoplay=!1,this.autoplayInterval=3e3,this.slidesPerPage=1,this.slidesPerMove=1,this.orientation=`horizontal`,this.mouseDragging=!1,this.activeSlide=0,this.scrolling=!1,this.dragging=!1,this.autoplayController=new Yo(this,()=>this.next()),this.dragStartPosition=[-1,-1],this.localize=new T(this),this.pendingSlideChange=!1,this.handleMouseDrag=e=>{this.dragging||(this.scrollContainer.style.setProperty(`scroll-snap-type`,`none`),this.dragging=!0,this.dragStartPosition=[e.clientX,e.clientY]),this.scrollContainer.scrollBy({left:-e.movementX,top:-e.movementY,behavior:`instant`})},this.handleMouseDragEnd=()=>{let e=this.scrollContainer;document.removeEventListener(`pointermove`,this.handleMouseDrag,{capture:!0});let t=e.scrollLeft,n=e.scrollTop;e.style.removeProperty(`scroll-snap-type`),e.style.setProperty(`overflow`,`hidden`);let r=e.scrollLeft,i=e.scrollTop;e.style.removeProperty(`overflow`),e.style.setProperty(`scroll-snap-type`,`none`),e.scrollTo({left:t,top:n,behavior:`instant`}),requestAnimationFrame(async()=>{(t!==r||n!==i)&&(e.scrollTo({left:r,top:i,behavior:es()?`auto`:`smooth`}),await Zo(e,`scrollend`)),e.style.removeProperty(`scroll-snap-type`),this.dragging=!1,this.dragStartPosition=[-1,-1],this.handleScrollEnd()})},this.handleSlotChange=e=>{e.some(e=>[...e.addedNodes,...e.removedNodes].some(e=>this.isCarouselItem(e)&&!e.hasAttribute(`data-clone`)))&&this.initializeSlides(),this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`region`),this.setAttribute(`aria-label`,this.localize.term(`carousel`))}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver?.disconnect(),this.resizeObserver?.disconnect()}firstUpdated(){this.initializeSlides(),this.mutationObserver=new MutationObserver(this.handleSlotChange),this.mutationObserver.observe(this,{childList:!0,subtree:!0}),this.resizeObserver=new ResizeObserver(()=>{(this.scrollContainer?.clientWidth||this.scrollContainer?.clientHeight)&&(this.synchronizeSlides(),this.resizeObserver?.disconnect(),this.resizeObserver=void 0)}),this.resizeObserver.observe(this)}willUpdate(e){(e.has(`slidesPerMove`)||e.has(`slidesPerPage`))&&(this.slidesPerMove=Math.min(this.slidesPerMove,this.slidesPerPage))}getPageCount(){let e=this.getSlides().length,{slidesPerPage:t,slidesPerMove:n,loop:r}=this,i=r?e/n:(e-t)/n+1;return Math.ceil(i)}getCurrentPage(){return Math.ceil(this.activeSlide/this.slidesPerMove)}canScrollNext(){return this.loop||this.getCurrentPage()<this.getPageCount()-1}canScrollPrev(){return this.loop||this.getCurrentPage()>0}getSlides({excludeClones:e=!0}={}){return[...this.children].filter(t=>this.isCarouselItem(t)&&(!e||!t.hasAttribute(`data-clone`)))}handleClick(e){if(this.dragging&&this.dragStartPosition[0]>0&&this.dragStartPosition[1]>0){let t=Math.abs(this.dragStartPosition[0]-e.clientX),n=Math.abs(this.dragStartPosition[1]-e.clientY);Math.sqrt(t*t+n*n)>=10&&e.preventDefault()}}handleKeyDown(e){if([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`].includes(e.key)){let t=e.target,n=this.localize.dir()===`rtl`,r=t.closest(`[part~="pagination-item"]`)!==null,i=e.key===`ArrowDown`||!n&&e.key===`ArrowRight`||n&&e.key===`ArrowLeft`,a=e.key===`ArrowUp`||!n&&e.key===`ArrowLeft`||n&&e.key===`ArrowRight`;e.preventDefault(),a&&this.previous(),i&&this.next(),e.key===`Home`&&this.goToSlide(0),e.key===`End`&&this.goToSlide(this.getSlides().length-1),r&&this.updateComplete.then(()=>{let e=this.shadowRoot?.querySelector(`[part~="pagination-item-active"]`);e&&e.focus()})}}handleMouseDragStart(e){this.mouseDragging&&e.button===0&&(e.preventDefault(),document.addEventListener(`pointermove`,this.handleMouseDrag,{capture:!0,passive:!0}),document.addEventListener(`pointerup`,this.handleMouseDragEnd,{capture:!0,once:!0}))}handleScroll(){this.scrolling=!0,this.pendingSlideChange||this.synchronizeSlides()}synchronizeSlides(){let e=new IntersectionObserver(t=>{e.disconnect();for(let e of t){let t=e.target;t.toggleAttribute(`inert`,!e.isIntersecting),t.classList.toggle(`--in-view`,e.isIntersecting),t.setAttribute(`aria-hidden`,e.isIntersecting?`false`:`true`)}let n=t.find(e=>e.isIntersecting);if(!n)return;let r=this.getSlides({excludeClones:!1}),i=this.getSlides().length,a=r.indexOf(n.target),o=this.loop?a-this.slidesPerPage:a;if(n&&(this.activeSlide=(Math.ceil(o/this.slidesPerMove)*this.slidesPerMove+i)%i,!this.scrolling&&this.loop&&n.target.hasAttribute(`data-clone`))){let e=Number(n.target.getAttribute(`data-clone`));this.goToSlide(e,`instant`)}},{root:this.scrollContainer,threshold:.6});this.getSlides({excludeClones:!1}).forEach(t=>{e.observe(t)})}handleScrollEnd(){!this.scrolling||this.dragging||(this.synchronizeSlides(),this.scrolling=!1,this.pendingSlideChange=!1,this.synchronizeSlides())}isCarouselItem(e){return e instanceof Element&&e.tagName.toLowerCase()===`wa-carousel-item`}initializeSlides(){this.getSlides({excludeClones:!1}).forEach((e,t)=>{e.classList.remove(`--in-view`),e.classList.remove(`--is-active`),e.setAttribute(`aria-label`,this.localize.term(`slideNum`,t+1)),e.hasAttribute(`data-clone`)&&e.remove()}),this.updateSlidesSnap(),this.loop&&this.createClones(),this.goToSlide(this.activeSlide,`auto`),this.synchronizeSlides()}createClones(){let e=this.getSlides(),t=this.slidesPerPage,n=e.slice(-t),r=e.slice(0,t);n.reverse().forEach((t,n)=>{let r=t.cloneNode(!0);r.setAttribute(`data-clone`,String(e.length-n-1)),this.prepend(r)}),r.forEach((e,t)=>{let n=e.cloneNode(!0);n.setAttribute(`data-clone`,String(t)),this.append(n)})}handleSlideChange(){let e=this.getSlides();e.forEach((e,t)=>{e.classList.toggle(`--is-active`,t===this.activeSlide)}),this.hasUpdated&&this.dispatchEvent(new Go({index:this.activeSlide,slide:e[this.activeSlide]}))}updateSlidesSnap(){let e=this.getSlides(),t=this.slidesPerMove;e.forEach((e,n)=>{(n+t)%t===0?e.style.removeProperty(`scroll-snap-align`):e.style.setProperty(`scroll-snap-align`,`none`)})}handleAutoplayChange(){this.autoplayController.stop(),this.autoplay&&this.autoplayController.start(this.autoplayInterval)}previous(e=`smooth`){this.goToSlide(this.activeSlide-this.slidesPerMove,e)}next(e=`smooth`){this.goToSlide(this.activeSlide+this.slidesPerMove,e)}goToSlide(e,t=`smooth`){let{slidesPerPage:n,loop:r}=this,i=this.getSlides(),a=this.getSlides({excludeClones:!1});if(!i.length)return;this.activeSlide=r?(e+i.length)%i.length:R(e,0,i.length-n);let o=this.localize.dir()===`rtl`,s=a[R(e+(r?n:0)+(o?n-1:0),0,a.length-1)];this.scrollToSlide(s,es()?`auto`:t)}scrollToSlide(e,t=`smooth`){this.pendingSlideChange=!0,window.requestAnimationFrame(()=>{if(!this.scrollContainer)return;let n=this.scrollContainer,r=n.getBoundingClientRect(),i=e.getBoundingClientRect(),a=i.left-r.left,o=i.top-r.top;a||o?(this.pendingSlideChange=!0,n.scrollTo({left:a+n.scrollLeft,top:o+n.scrollTop,behavior:t})):this.pendingSlideChange=!1})}render(){let{slidesPerMove:e,scrolling:t}=this,n=0,r=0,i=!1,a=!1;this.hasUpdated&&(n=this.getPageCount(),r=this.getCurrentPage(),i=this.canScrollPrev(),a=this.canScrollNext());let o=this.localize.dir()===`rtl`;return b`
    ...
    `}};rs.css=Xo,D([k({type:Boolean,reflect:!0})],rs.prototype,`loop`,2),D([k({type:Number,reflect:!0})],rs.prototype,`slides`,2),D([k({type:Number,reflect:!0})],rs.prototype,`currentSlide`,2),D([k({type:Boolean,reflect:!0})],rs.prototype,`navigation`,2),D([k({type:Boolean,reflect:!0})],rs.prototype,`pagination`,2),D([k({type:Boolean,reflect:!0})],rs.prototype,`autoplay`,2),D([k({type:Number,attribute:`autoplay-interval`})],rs.prototype,`autoplayInterval`,2),D([k({type:Number,attribute:`slides-per-page`})],rs.prototype,`slidesPerPage`,2),D([k({type:Number,attribute:`slides-per-move`})],rs.prototype,`slidesPerMove`,2),D([k()],rs.prototype,`orientation`,2),D([k({type:Boolean,reflect:!0,attribute:`mouse-dragging`})],rs.prototype,`mouseDragging`,2),D([j(`.slides`)],rs.prototype,`scrollContainer`,2),D([j(`.pagination`)],rs.prototype,`paginationContainer`,2),D([A()],rs.prototype,`activeSlide`,2),D([A()],rs.prototype,`scrolling`,2),D([A()],rs.prototype,`dragging`,2),D([jr({passive:!0})],rs.prototype,`handleScroll`,1),D([E(`loop`,{waitUntilFirstUpdate:!0}),E(`slidesPerPage`,{waitUntilFirstUpdate:!0})],rs.prototype,`initializeSlides`,1),D([E(`activeSlide`)],rs.prototype,`handleSlideChange`,1),D([E(`slidesPerMove`)],rs.prototype,`updateSlidesSnap`,1),D([E(`autoplay`)],rs.prototype,`handleAutoplayChange`,1),rs=D([O(`wa-carousel`)],rs);var is=y`
  :host {
...
`,nc=Math.min,rc=Math.max,ic=Math.round,ac=Math.floor,oc=e=>({x:e,y:e}),sc={left:`right`,right:`left`,bottom:`top`,top:`bottom`};function cc(e,t,n){return rc(e,nc(t,n))}function lc(e,t){return typeof e==`function`?e(t):e}function uc(e){return e.split(`-`)[0]}function dc(e){return e.split(`-`)[1]}function fc(e){return e===`x`?`y`:`x`}function pc(e){return e===`y`?`height`:`width`}function mc(e){let t=e[0];return t===`t`||t===`b`?`y`:`x`}function hc(e){return fc(mc(e))}function gc(e,t,n){n===void 0&&(n=!1);let r=dc(e),i=hc(e),a=pc(i),o=i===`x`?r===(n?`end`:`start`)?`right`:`left`:r===`start`?`bottom`:`top`;return t.reference[a]>t.floating[a]&&(o=Tc(o)),[o,Tc(o)]}function _c(e){let t=Tc(e);return[vc(e),t,vc(t)]}function vc(e){return e.includes(`start`)?e.replace(`start`,`end`):e.replace(`end`,`start`)}var yc=[`left`,`right`],bc=[`right`,`left`],xc=[`top`,`bottom`],Sc=[`bottom`,`top`];function Cc(e,t,n){switch(e){case`top`:case`bottom`:return n?t?bc:yc:t?yc:bc;case`left`:case`right`:return t?xc:Sc;default:return[]}}function wc(e,t,n,r){let i=dc(e),a=Cc(uc(e),n===`start`,r);return i&&(a=a.map(e=>e+`-`+i),t&&(a=a.concat(a.map(vc)))),a}function Tc(e){let t=uc(e);return sc[t]+e.slice(t.length)}function Ec(e){return{top:0,right:0,bottom:0,left:0,...e}}function Dc(e){return typeof e==`number`?{top:e,right:e,bottom:e,left:e}:Ec(e)}function Oc(e){let{x:t,y:n,width:r,height:i}=e;return{width:r,height:i,top:n,left:t,right:t+r,bottom:n+i,x:t,y:n}}function kc(e,t,n){let{reference:r,floating:i}=e,a=mc(t),o=hc(t),s=pc(o),c=uc(t),l=a===`y`,u=r.x+r.width/2-i.width/2,d=r.y+r.height/2-i.height/2,f=r[s]/2-i[s]/2,p;switch(c){case`top`:p={x:u,y:r.y-i.height};break;case`bottom`:p={x:u,y:r.y+r.height};break;case`right`:p={x:r.x+r.width,y:d};break;case`left`:p={x:r.x-i.width,y:d};break;default:p={x:r.x,y:r.y}}switch(dc(t)){case`start`:p[o]-=f*(n&&l?-1:1);break;case`end`:p[o]+=f*(n&&l?-1:1);break}return p}async function Ac(e,t){t===void 0&&(t={});let{x:n,y:r,platform:i,rects:a,elements:o,strategy:s}=e,{boundary:c=`clippingAncestors`,rootBoundary:l=`viewport`,elementContext:u=`floating`,altBoundary:d=!1,padding:f=0}=lc(t,e),p=Dc(f),m=o[d?u===`floating`?`reference`:`floating`:u],h=Oc(await i.getClippingRect({element:await(i.isElement==null?void 0:i.isElement(m))??!0?m:m.contextElement||await(i.getDocumentElement==null?void 0:i.getDocumentElement(o.floating)),boundary:c,rootBoundary:l,strategy:s})),ee=u===`floating`?{x:n,y:r,width:a.floating.width,height:a.floating.height}:a.reference,g=await(i.getOffsetParent==null?void 0:i.getOffsetParent(o.floating)),_=await(i.isElement==null?void 0:i.isElement(g))&&await(i.getScale==null?void 0:i.getScale(g))||{x:1,y:1},te=Oc(i.convertOffsetParentRelativeRectToViewportRelativeRect?await i.convertOffsetParentRelativeRectToViewportRelativeRect({elements:o,rect:ee,offsetParent:g,strategy:s}):ee);return{top:(h.top-te.top+p.top)/_.y,bottom:(te.bottom-h.bottom+p.bottom)/_.y,left:(h.left-te.left+p.left)/_.x,right:(te.right-h.right+p.right)/_.x}}var jc=50,Mc=async(e,t,n)=>{let{placement:r=`bottom`,strategy:i=`absolute`,middleware:a=[],platform:o}=n,s=o.detectOverflow?o:{...o,detectOverflow:Ac},c=await(o.isRTL==null?void 0:o.isRTL(t)),l=await o.getElementRects({reference:e,floating:t,strategy:i}),{x:u,y:d}=kc(l,r,c),f=r,p=0,m={};for(let n=0;n<a.length;n++){let h=a[n];if(!h)continue;let{name:ee,fn:g}=h,{x:_,y:te,data:v,reset:ne}=await g({x:u,y:d,initialPlacement:r,placement:f,strategy:i,middlewareData:m,rects:l,platform:s,elements:{reference:e,floating:t}});u=_??u,d=te??d,m[ee]={...m[ee],...v},ne&&p<jc&&(p++,typeof ne==`object`&&(ne.placement&&(f=ne.placement),ne.rects&&(l=ne.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:i}):ne.rects),{x:u,y:d}=kc(l,f,c)),n=-1)}return{x:u,y:d,placement:f,strategy:i,middlewareData:m}},Nc=e=>({name:`arrow`,options:e,async fn(t){let{x:n,y:r,placement:i,rects:a,platform:o,elements:s,middlewareData:c}=t,{element:l,padding:u=0}=lc(e,t)||{};if(l==null)return{};let d=Dc(u),f={x:n,y:r},p=hc(i),m=pc(p),h=await o.getDimensions(l),ee=p===`y`,g=ee?`top`:`left`,_=ee?`bottom`:`right`,te=ee?`clientHeight`:`clientWidth`,v=a.reference[m]+a.reference[p]-f[p]-a.floating[m],ne=f[p]-a.reference[p],re=await(o.getOffsetParent==null?void 0:o.getOffsetParent(l)),ie=re?re[te]:0;(!ie||!await(o.isElement==null?void 0:o.isElement(re)))&&(ie=s.floating[te]||a.floating[m]);let ae=v/2-ne/2,oe=ie/2-h[m]/2-1,se=nc(d[g],oe),y=nc(d[_],oe),ce=se,le=ie-h[m]-y,ue=ie/2-h[m]/2+ae,de=cc(ce,ue,le),fe=!c.arrow&&dc(i)!=null&&ue!==de&&a.reference[m]/2-(ue<ce?se:y)-h[m]/2<0,pe=fe?ue<ce?ue-ce:ue-le:0;return{[p]:f[p]+pe,data:{[p]:de,centerOffset:ue-de-pe,...fe&&{alignmentOffset:pe}},reset:fe}}}),Pc=function(e){return e===void 0&&(e={}),{name:`flip`,options:e,async fn(t){var n;let{placement:r,middlewareData:i,rects:a,initialPlacement:o,platform:s,elements:c}=t,{mainAxis:l=!0,crossAxis:u=!0,fallbackPlacements:d,fallbackStrategy:f=`bestFit`,fallbackAxisSideDirection:p=`none`,flipAlignment:m=!0,...h}=lc(e,t);if((n=i.arrow)!=null&&n.alignmentOffset)return{};let ee=uc(r),g=mc(o),_=uc(o)===o,te=await(s.isRTL==null?void 0:s.isRTL(c.floating)),v=d||(_||!m?[Tc(o)]:_c(o)),ne=p!==`none`;!d&&ne&&v.push(...wc(o,m,p,te));let re=[o,...v],ie=await s.detectOverflow(t,h),ae=[],oe=i.flip?.overflows||[];if(l&&ae.push(ie[ee]),u){let e=gc(r,a,te);ae.push(ie[e[0]],ie[e[1]])}if(oe=[...oe,{placement:r,overflows:ae}],!ae.every(e=>e<=0)){let e=(i.flip?.index||0)+1,t=re[e];if(t&&(!(u===`alignment`&&g!==mc(t))||oe.every(e=>mc(e.placement)===g?e.overflows[0]>0:!0)))return{data:{index:e,overflows:oe},reset:{placement:t}};let n=oe.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0]?.placement;if(!n)switch(f){case`bestFit`:{let e=oe.filter(e=>{if(ne){let t=mc(e.placement);return t===g||t===`y`}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0]?.[0];e&&(n=e);break}case`initialPlacement`:n=o;break}if(r!==n)return{reset:{placement:n}}}return{}}}},Fc=new Set([`left`,`top`]);async function Ic(e,t){let{placement:n,platform:r,elements:i}=e,a=await(r.isRTL==null?void 0:r.isRTL(i.floating)),o=uc(n),s=dc(n),c=mc(n)===`y`,l=Fc.has(o)?-1:1,u=a&&c?-1:1,d=lc(t,e),{mainAxis:f,crossAxis:p,alignmentAxis:m}=typeof d==`number`?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return s&&typeof m==`number`&&(p=s===`end`?m*-1:m),c?{x:p*u,y:f*l}:{x:f*l,y:p*u}}var Lc=function(e){return e===void 0&&(e=0),{name:`offset`,options:e,async fn(t){var n;let{x:r,y:i,placement:a,middlewareData:o}=t,s=await Ic(t,e);return a===o.offset?.placement&&(n=o.arrow)!=null&&n.alignmentOffset?{}:{x:r+s.x,y:i+s.y,data:{...s,placement:a}}}}},Rc=function(e){return e===void 0&&(e={}),{name:`shift`,options:e,async fn(t){let{x:n,y:r,placement:i,platform:a}=t,{mainAxis:o=!0,crossAxis:s=!1,limiter:c={fn:e=>{let{x:t,y:n}=e;return{x:t,y:n}}},...l}=lc(e,t),u={x:n,y:r},d=await a.detectOverflow(t,l),f=mc(uc(i)),p=fc(f),m=u[p],h=u[f];if(o){let e=p===`y`?`top`:`left`,t=p===`y`?`bottom`:`right`,n=m+d[e],r=m-d[t];m=cc(n,m,r)}if(s){let e=f===`y`?`top`:`left`,t=f===`y`?`bottom`:`right`,n=h+d[e],r=h-d[t];h=cc(n,h,r)}let ee=c.fn({...t,[p]:m,[f]:h});return{...ee,data:{x:ee.x-n,y:ee.y-r,enabled:{[p]:o,[f]:s}}}}}},zc=function(e){return e===void 0&&(e={}),{name:`size`,options:e,async fn(t){var n,r;let{placement:i,rects:a,platform:o,elements:s}=t,{apply:c=()=>{},...l}=lc(e,t),u=await o.detectOverflow(t,l),d=uc(i),f=dc(i),p=mc(i)===`y`,{width:m,height:h}=a.floating,ee,g;d===`top`||d===`bottom`?(ee=d,g=f===(await(o.isRTL==null?void 0:o.isRTL(s.floating))?`start`:`end`)?`left`:`right`):(g=d,ee=f===`end`?`top`:`bottom`);let _=h-u.top-u.bottom,te=m-u.left-u.right,v=nc(h-u[ee],_),ne=nc(m-u[g],te),re=!t.middlewareData.shift,ie=v,ae=ne;if((n=t.middlewareData.shift)!=null&&n.enabled.x&&(ae=te),(r=t.middlewareData.shift)!=null&&r.enabled.y&&(ie=_),re&&!f){let e=rc(u.left,0),t=rc(u.right,0),n=rc(u.top,0),r=rc(u.bottom,0);p?ae=m-2*(e!==0||t!==0?e+t:rc(u.left,u.right)):ie=h-2*(n!==0||r!==0?n+r:rc(u.top,u.bottom))}await c({...t,availableWidth:ae,availableHeight:ie});let oe=await o.getDimensions(s.floating);return m!==oe.width||h!==oe.height?{reset:{rects:!0}}:{}}}};function Bc(){return typeof window<`u`}function Vc(e){return Wc(e)?(e.nodeName||``).toLowerCase():`#document`}function Hc(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function Uc(e){return((Wc(e)?e.ownerDocument:e.document)||window.document)?.documentElement}function Wc(e){return Bc()?e instanceof Node||e instanceof Hc(e).Node:!1}function Gc(e){return Bc()?e instanceof Element||e instanceof Hc(e).Element:!1}function Kc(e){return Bc()?e instanceof HTMLElement||e instanceof Hc(e).HTMLElement:!1}function qc(e){return!Bc()||typeof ShadowRoot>`u`?!1:e instanceof ShadowRoot||e instanceof Hc(e).ShadowRoot}function Jc(e){let{overflow:t,overflowX:n,overflowY:r,display:i}=al(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+n)&&i!==`inline`&&i!==`contents`}function Yc(e){return/^(table|td|th)$/.test(Vc(e))}function Xc(e){try{if(e.matches(`:popover-open`))return!0}catch{}try{return e.matches(`:modal`)}catch{return!1}}var Zc=/transform|translate|scale|rotate|perspective|filter/,Qc=/paint|layout|strict|content/,$c=e=>!!e&&e!==`none`,el;function tl(e){let t=Gc(e)?al(e):e;return $c(t.transform)||$c(t.translate)||$c(t.scale)||$c(t.rotate)||$c(t.perspective)||!rl()&&($c(t.backdropFilter)||$c(t.filter))||Zc.test(t.willChange||``)||Qc.test(t.contain||``)}function nl(e){let t=sl(e);for(;Kc(t)&&!il(t);){if(tl(t))return t;if(Xc(t))return null;t=sl(t)}return null}function rl(){return el??=typeof CSS<`u`&&CSS.supports&&CSS.supports(`-webkit-backdrop-filter`,`none`),el}function il(e){return/^(html|body|#document)$/.test(Vc(e))}function al(e){return Hc(e).getComputedStyle(e)}function ol(e){return Gc(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function sl(e){if(Vc(e)===`html`)return e;let t=e.assignedSlot||e.parentNode||qc(e)&&e.host||Uc(e);return qc(t)?t.host:t}function cl(e){let t=sl(e);return il(t)?e.ownerDocument?e.ownerDocument.body:e.body:Kc(t)&&Jc(t)?t:cl(t)}function ll(e,t,n){t===void 0&&(t=[]),n===void 0&&(n=!0);let r=cl(e),i=r===e.ownerDocument?.body,a=Hc(r);if(i){let e=ul(a);return t.concat(a,a.visualViewport||[],Jc(r)?r:[],e&&n?ll(e):[])}else return t.concat(r,ll(r,[],n))}function ul(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function dl(e){let t=al(e),n=parseFloat(t.width)||0,r=parseFloat(t.height)||0,i=Kc(e),a=i?e.offsetWidth:n,o=i?e.offsetHeight:r,s=ic(n)!==a||ic(r)!==o;return s&&(n=a,r=o),{width:n,height:r,$:s}}function fl(e){return Gc(e)?e:e.contextElement}function pl(e){let t=fl(e);if(!Kc(t))return oc(1);let n=t.getBoundingClientRect(),{width:r,height:i,$:a}=dl(t),o=(a?ic(n.width):n.width)/r,s=(a?ic(n.height):n.height)/i;return(!o||!Number.isFinite(o))&&(o=1),(!s||!Number.isFinite(s))&&(s=1),{x:o,y:s}}var ml=oc(0);function hl(e){let t=Hc(e);return!rl()||!t.visualViewport?ml:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function gl(e,t,n){return t===void 0&&(t=!1),!n||t&&n!==Hc(e)?!1:t}function _l(e,t,n,r){t===void 0&&(t=!1),n===void 0&&(n=!1);let i=e.getBoundingClientRect(),a=fl(e),o=oc(1);t&&(r?Gc(r)&&(o=pl(r)):o=pl(e));let s=gl(a,n,r)?hl(a):oc(0),c=(i.left+s.x)/o.x,l=(i.top+s.y)/o.y,u=i.width/o.x,d=i.height/o.y;if(a){let e=Hc(a),t=r&&Gc(r)?Hc(r):r,n=e,i=ul(n);for(;i&&r&&t!==n;){let e=pl(i),t=i.getBoundingClientRect(),r=al(i),a=t.left+(i.clientLeft+parseFloat(r.paddingLeft))*e.x,o=t.top+(i.clientTop+parseFloat(r.paddingTop))*e.y;c*=e.x,l*=e.y,u*=e.x,d*=e.y,c+=a,l+=o,n=Hc(i),i=ul(n)}}return Oc({width:u,height:d,x:c,y:l})}function vl(e,t){let n=ol(e).scrollLeft;return t?t.left+n:_l(Uc(e)).left+n}function yl(e,t){let n=e.getBoundingClientRect();return{x:n.left+t.scrollLeft-vl(e,n),y:n.top+t.scrollTop}}function bl(e){let{elements:t,rect:n,offsetParent:r,strategy:i}=e,a=i===`fixed`,o=Uc(r),s=t?Xc(t.floating):!1;if(r===o||s&&a)return n;let c={scrollLeft:0,scrollTop:0},l=oc(1),u=oc(0),d=Kc(r);if((d||!d&&!a)&&((Vc(r)!==`body`||Jc(o))&&(c=ol(r)),d)){let e=_l(r);l=pl(r),u.x=e.x+r.clientLeft,u.y=e.y+r.clientTop}let f=o&&!d&&!a?yl(o,c):oc(0);return{width:n.width*l.x,height:n.height*l.y,x:n.x*l.x-c.scrollLeft*l.x+u.x+f.x,y:n.y*l.y-c.scrollTop*l.y+u.y+f.y}}function xl(e){return Array.from(e.getClientRects())}function Sl(e){let t=Uc(e),n=ol(e),r=e.ownerDocument.body,i=rc(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),a=rc(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight),o=-n.scrollLeft+vl(e),s=-n.scrollTop;return al(r).direction===`rtl`&&(o+=rc(t.clientWidth,r.clientWidth)-i),{width:i,height:a,x:o,y:s}}var Cl=25;function wl(e,t){let n=Hc(e),r=Uc(e),i=n.visualViewport,a=r.clientWidth,o=r.clientHeight,s=0,c=0;if(i){a=i.width,o=i.height;let e=rl();(!e||e&&t===`fixed`)&&(s=i.offsetLeft,c=i.offsetTop)}let l=vl(r);if(l<=0){let e=r.ownerDocument,t=e.body,n=getComputedStyle(t),i=e.compatMode===`CSS1Compat`&&parseFloat(n.marginLeft)+parseFloat(n.marginRight)||0,o=Math.abs(r.clientWidth-t.clientWidth-i);o<=Cl&&(a-=o)}else l<=Cl&&(a+=l);return{width:a,height:o,x:s,y:c}}function Tl(e,t){let n=_l(e,!0,t===`fixed`),r=n.top+e.clientTop,i=n.left+e.clientLeft,a=Kc(e)?pl(e):oc(1);return{width:e.clientWidth*a.x,height:e.clientHeight*a.y,x:i*a.x,y:r*a.y}}function El(e,t,n){let r;if(t===`viewport`)r=wl(e,n);else if(t===`document`)r=Sl(Uc(e));else if(Gc(t))r=Tl(t,n);else{let n=hl(e);r={x:t.x-n.x,y:t.y-n.y,width:t.width,height:t.height}}return Oc(r)}function Dl(e,t){let n=sl(e);return n===t||!Gc(n)||il(n)?!1:al(n).position===`fixed`||Dl(n,t)}function Ol(e,t){let n=t.get(e);if(n)return n;let r=ll(e,[],!1).filter(e=>Gc(e)&&Vc(e)!==`body`),i=null,a=al(e).position===`fixed`,o=a?sl(e):e;for(;Gc(o)&&!il(o);){let t=al(o),n=tl(o);!n&&t.position===`fixed`&&(i=null),(a?!n&&!i:!n&&t.position===`static`&&i&&(i.position===`absolute`||i.position===`fixed`)||Jc(o)&&!n&&Dl(e,o))?r=r.filter(e=>e!==o):i=t,o=sl(o)}return t.set(e,r),r}function kl(e){let{element:t,boundary:n,rootBoundary:r,strategy:i}=e,a=[...n===`clippingAncestors`?Xc(t)?[]:Ol(t,this._c):[].concat(n),r],o=El(t,a[0],i),s=o.top,c=o.right,l=o.bottom,u=o.left;for(let e=1;e<a.length;e++){let n=El(t,a[e],i);s=rc(n.top,s),c=nc(n.right,c),l=nc(n.bottom,l),u=rc(n.left,u)}return{width:c-u,height:l-s,x:u,y:s}}function Al(e){let{width:t,height:n}=dl(e);return{width:t,height:n}}function jl(e,t,n){let r=Kc(t),i=Uc(t),a=n===`fixed`,o=_l(e,!0,a,t),s={scrollLeft:0,scrollTop:0},c=oc(0);function l(){c.x=vl(i)}if(r||!r&&!a)if((Vc(t)!==`body`||Jc(i))&&(s=ol(t)),r){let e=_l(t,!0,a,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else i&&l();a&&!r&&i&&l();let u=i&&!r&&!a?yl(i,s):oc(0);return{x:o.left+s.scrollLeft-c.x-u.x,y:o.top+s.scrollTop-c.y-u.y,width:o.width,height:o.height}}function Ml(e){return al(e).position===`static`}function Nl(e,t){if(!Kc(e)||al(e).position===`fixed`)return null;if(t)return t(e);let n=e.offsetParent;return Uc(e)===n&&(n=n.ownerDocument.body),n}function Pl(e,t){let n=Hc(e);if(Xc(e))return n;if(!Kc(e)){let t=sl(e);for(;t&&!il(t);){if(Gc(t)&&!Ml(t))return t;t=sl(t)}return n}let r=Nl(e,t);for(;r&&Yc(r)&&Ml(r);)r=Nl(r,t);return r&&il(r)&&Ml(r)&&!tl(r)?n:r||nl(e)||n}var Fl=async function(e){let t=this.getOffsetParent||Pl,n=this.getDimensions,r=await n(e.floating);return{reference:jl(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}};function Il(e){return al(e).direction===`rtl`}var Ll={convertOffsetParentRelativeRectToViewportRelativeRect:bl,getDocumentElement:Uc,getClippingRect:kl,getOffsetParent:Pl,getElementRects:Fl,getClientRects:xl,getDimensions:Al,getScale:pl,isElement:Gc,isRTL:Il};function Rl(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function zl(e,t){let n=null,r,i=Uc(e);function a(){var e;clearTimeout(r),(e=n)==null||e.disconnect(),n=null}function o(s,c){s===void 0&&(s=!1),c===void 0&&(c=1),a();let l=e.getBoundingClientRect(),{left:u,top:d,width:f,height:p}=l;if(s||t(),!f||!p)return;let m=ac(d),h=ac(i.clientWidth-(u+f)),ee=ac(i.clientHeight-(d+p)),g=ac(u),_={rootMargin:-m+`px `+-h+`px `+-ee+`px `+-g+`px`,threshold:rc(0,nc(1,c))||1},te=!0;function v(t){let n=t[0].intersectionRatio;if(n!==c){if(!te)return o();n?o(!1,n):r=setTimeout(()=>{o(!1,1e-7)},1e3)}n===1&&!Rl(l,e.getBoundingClientRect())&&o(),te=!1}try{n=new IntersectionObserver(v,{..._,root:i.ownerDocument})}catch{n=new IntersectionObserver(v,_)}n.observe(e)}return o(!0),a}function Bl(e,t,n,r){r===void 0&&(r={});let{ancestorScroll:i=!0,ancestorResize:a=!0,elementResize:o=typeof ResizeObserver==`function`,layoutShift:s=typeof IntersectionObserver==`function`,animationFrame:c=!1}=r,l=fl(e),u=i||a?[...l?ll(l):[],...t?ll(t):[]]:[];u.forEach(e=>{i&&e.addEventListener(`scroll`,n,{passive:!0}),a&&e.addEventListener(`resize`,n)});let d=l&&s?zl(l,n):null,f=-1,p=null;o&&(p=new ResizeObserver(e=>{let[r]=e;r&&r.target===l&&p&&t&&(p.unobserve(t),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var e;(e=p)==null||e.observe(t)})),n()}),l&&!c&&p.observe(l),t&&p.observe(t));let m,h=c?_l(e):null;c&&ee();function ee(){let t=_l(e);h&&!Rl(h,t)&&n(),h=t,m=requestAnimationFrame(ee)}return n(),()=>{var e;u.forEach(e=>{i&&e.removeEventListener(`scroll`,n),a&&e.removeEventListener(`resize`,n)}),d?.(),(e=p)==null||e.disconnect(),p=null,c&&cancelAnimationFrame(m)}}var Vl=Lc,Hl=Rc,Ul=Pc,Wl=zc,Gl=Nc,Kl=(e,t,n)=>{let r=new Map,i={platform:Ll,...n},a={...i.platform,_c:r};return Mc(e,t,{...i,platform:a})};function ql(e){return Yl(e)}function Jl(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function Yl(e){for(let t=e;t;t=Jl(t))if(t instanceof Element&&getComputedStyle(t).display===`none`)return null;for(let t=Jl(e);t;t=Jl(t)){if(!(t instanceof Element))continue;let e=getComputedStyle(t);if(e.display!==`contents`&&(e.position!==`static`||tl(e)||t.tagName===`BODY`))return t}return null}function Xl(e){return typeof e==`object`&&!!e&&`getBoundingClientRect`in e&&(`contextElement`in e?e instanceof Element:!0)}var Zl=globalThis?.HTMLElement?.prototype.hasOwnProperty(`popover`),H=class extends M{constructor(){super(...arguments),this.localize=new T(this),this.active=!1,this.placement=`top`,this.boundary=`viewport`,this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement=`anchor`,this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements=``,this.flipFallbackStrategy=`best-fit`,this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl&&this.popup){let e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=this.placement.includes(`top`)||this.placement.includes(`bottom`),r=0,i=0,a=0,o=0,s=0,c=0,l=0,u=0;n?e.top<t.top?(r=e.left,i=e.bottom,a=e.right,o=e.bottom,s=t.left,c=t.top,l=t.right,u=t.top):(r=t.left,i=t.bottom,a=t.right,o=t.bottom,s=e.left,c=e.top,l=e.right,u=e.top):e.left<t.left?(r=e.right,i=e.top,a=t.left,o=t.top,s=e.right,c=e.bottom,l=t.left,u=t.bottom):(r=t.right,i=t.top,a=e.left,o=e.top,s=t.right,c=t.bottom,l=e.left,u=e.bottom),this.style.setProperty(`--hover-bridge-top-left-x`,`${r}px`),this.style.setProperty(`--hover-bridge-top-left-y`,`${i}px`),this.style.setProperty(`--hover-bridge-top-right-x`,`${a}px`),this.style.setProperty(`--hover-bridge-top-right-y`,`${o}px`),this.style.setProperty(`--hover-bridge-bottom-left-x`,`${s}px`),this.style.setProperty(`--hover-bridge-bottom-left-y`,`${c}px`),this.style.setProperty(`--hover-bridge-bottom-right-x`,`${l}px`),this.style.setProperty(`--hover-bridge-bottom-right-y`,`${u}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has(`active`)&&(this.active?this.start():this.stop()),e.has(`anchor`)&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){await this.stop(),this.anchor&&typeof this.anchor==`string`?this.anchorEl=this.getRootNode().getElementById(this.anchor):this.anchor instanceof Element||Xl(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector(`[slot="anchor"]`),this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.start()}start(){!this.anchorEl||!this.active||!this.isConnected||(this.popup?.showPopover?.(),this.cleanup=Bl(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.popup?.hidePopover?.(),this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute(`data-current-placement`),this.style.removeProperty(`--auto-size-available-width`),this.style.removeProperty(`--auto-size-available-height`),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl||!this.popup)return;let e=[Vl({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Wl({apply:({rects:e})=>{let t=this.sync===`width`||this.sync===`both`,n=this.sync===`height`||this.sync===`both`;this.popup.style.width=t?`${e.reference.width}px`:``,this.popup.style.height=n?`${e.reference.height}px`:``}})):(this.popup.style.width=``,this.popup.style.height=``);let t;Zl&&!Xl(this.anchor)&&this.boundary===`scroll`&&(t=ll(this.anchorEl).filter(e=>e instanceof Element)),this.flip&&e.push(Ul({boundary:this.flipBoundary||t,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy===`best-fit`?`bestFit`:`initialPlacement`,padding:this.flipPadding})),this.shift&&e.push(Hl({boundary:this.shiftBoundary||t,padding:this.shiftPadding})),this.autoSize?e.push(Wl({boundary:this.autoSizeBoundary||t,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{this.autoSize===`vertical`||this.autoSize===`both`?this.style.setProperty(`--auto-size-available-height`,`${t}px`):this.style.removeProperty(`--auto-size-available-height`),this.autoSize===`horizontal`||this.autoSize===`both`?this.style.setProperty(`--auto-size-available-width`,`${e}px`):this.style.removeProperty(`--auto-size-available-width`)}})):(this.style.removeProperty(`--auto-size-available-width`),this.style.removeProperty(`--auto-size-available-height`)),this.arrow&&e.push(Gl({element:this.arrowEl,padding:this.arrowPadding}));let n=Zl?e=>Ll.getOffsetParent(e,ql):Ll.getOffsetParent;Kl(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:Zl?`absolute`:`fixed`,platform:{...Ll,getOffsetParent:n}}).then(({x:e,y:t,middlewareData:n,placement:r})=>{let i=this.localize.dir()===`rtl`,a={top:`bottom`,right:`left`,bottom:`top`,left:`right`}[r.split(`-`)[0]];if(this.setAttribute(`data-current-placement`,r),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){let e=n.arrow.x,t=n.arrow.y,r=``,o=``,s=``,c=``;if(this.arrowPlacement===`start`){let n=typeof e==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``;r=typeof t==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``,o=i?n:``,c=i?``:n}else if(this.arrowPlacement===`end`){let n=typeof e==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``;o=i?``:n,c=i?n:``,s=typeof t==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``}else this.arrowPlacement===`center`?(c=typeof e==`number`?`calc(50% - var(--arrow-size-diagonal))`:``,r=typeof t==`number`?`calc(50% - var(--arrow-size-diagonal))`:``):(c=typeof e==`number`?`${e}px`:``,r=typeof t==`number`?`${t}px`:``);Object.assign(this.arrowEl.style,{top:r,right:o,bottom:s,left:c,[a]:`calc(var(--arrow-base-offset) - var(--arrow-size-diagonal))`})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.dispatchEvent(new ec)}render(){return b`
      ...
      <div
        popover="manual"
        part="popup"
        class=${I({popup:!0,"popup-active":this.active,"popup-fixed":!Zl,"popup-has-arrow":this.arrow})}
      >
        <slot></slot>
...
`;function*Du(e=document.activeElement){e!=null&&(yield e,`shadowRoot`in e&&e.shadowRoot&&e.shadowRoot.mode!==`closed`&&(yield*Du(e.shadowRoot.activeElement)))}var Ou=new Set,ku=class extends M{constructor(){super(...arguments),this.submenuCleanups=new Map,this.localize=new T(this),this.userTypedQuery=``,this.openSubmenuStack=[],this.open=!1,this.size=`m`,this.placement=`bottom-start`,this.distance=0,this.skidding=0,this.handleDocumentKeyDown=async e=>{let t=this.localize.dir()===`rtl`;if(e.key===`Escape`&&this.open&&ys(this)){let t=this.getTrigger();e.preventDefault(),e.stopPropagation(),this.open=!1,t?.focus({preventScroll:!0});return}let n=[...Du()].find(e=>e.localName===`wa-dropdown-item`),r=n?.localName===`wa-dropdown-item`,i=this.getCurrentSubmenuItem(),a=!!i,o,s,c;a?(o=this.getSubmenuItems(i),s=o.find(e=>e.active||e===n),c=s?o.indexOf(s):-1):(o=this.getItems(),s=o.find(e=>e.active||e===n),c=s?o.indexOf(s):-1);let l;if(e.key===`ArrowUp`&&(e.preventDefault(),e.stopPropagation(),l=c>0?o[c-1]:o[o.length-1]),e.key===`ArrowDown`&&(e.preventDefault(),e.stopPropagation(),l=c!==-1&&c<o.length-1?o[c+1]:o[0]),e.key===(t?`ArrowLeft`:`ArrowRight`)&&r&&s&&s.hasSubmenu){e.preventDefault(),e.stopPropagation(),s.submenuOpen=!0,this.addToSubmenuStack(s),setTimeout(()=>{let e=this.getSubmenuItems(s);e.length>0&&(e.forEach((e,t)=>e.active=t===0),e[0].focus({preventScroll:!0}))},0);return}if(e.key===(t?`ArrowRight`:`ArrowLeft`)&&a){e.preventDefault(),e.stopPropagation();let t=this.removeFromSubmenuStack();t&&(t.submenuOpen=!1,setTimeout(()=>{t.focus({preventScroll:!0}),t.active=!0,(t.slot===`submenu`?this.getSubmenuItems(t.parentElement):this.getItems()).forEach(e=>{e!==t&&(e.active=!1)})},0));return}if((e.key===`Home`||e.key===`End`)&&(e.preventDefault(),e.stopPropagation(),l=e.key===`Home`?o[0]:o[o.length-1]),e.key===`Tab`&&await this.hideMenu(),e.key.length===1&&!(e.metaKey||e.ctrlKey||e.altKey)&&!(e.key===` `&&this.userTypedQuery===``)&&(clearTimeout(this.userTypedTimeout),this.userTypedTimeout=setTimeout(()=>{this.userTypedQuery=``},1e3),this.userTypedQuery+=e.key,o.some(e=>{let t=(e.textContent||``).trim().toLowerCase(),n=this.userTypedQuery.trim().toLowerCase();return t.startsWith(n)?(l=e,!0):!1})),l){e.preventDefault(),e.stopPropagation(),o.forEach(e=>e.active=e===l),l.focus({preventScroll:!0});return}(e.key===`Enter`||e.key===` `&&this.userTypedQuery===``)&&r&&s&&(e.preventDefault(),e.stopPropagation(),s.hasSubmenu?(s.submenuOpen=!0,this.addToSubmenuStack(s),setTimeout(()=>{let e=this.getSubmenuItems(s);e.length>0&&(e.forEach((e,t)=>e.active=t===0),e[0].focus({preventScroll:!0}))},0)):this.makeSelection(s))},this.handleDocumentPointerDown=e=>{e.composedPath().some(e=>e instanceof HTMLElement?e===this||e.closest(`wa-dropdown, [part="submenu"]`):!1)||(this.open=!1)},this.handleGlobalMouseMove=e=>{let t=this.getCurrentSubmenuItem();if(!t?.submenuOpen||!t.submenuElement)return;let n=t.submenuElement.getBoundingClientRect(),r=this.localize.dir()===`rtl`,i=r?n.right:n.left,a=r?Math.max(e.clientX,i):Math.min(e.clientX,i),o=Math.max(n.top,Math.min(e.clientY,n.bottom));t.submenuElement.style.setProperty(`--safe-triangle-cursor-x`,`${a}px`),t.submenuElement.style.setProperty(`--safe-triangle-cursor-y`,`${o}px`);let s=e.composedPath(),c=t.matches(`:hover`),l=!!t.submenuElement?.matches(`:hover`),u=c||!!s.find(e=>e===t),d=l||!!s.find(e=>e instanceof HTMLElement&&e.closest(`[part="submenu"]`)===t.submenuElement);!u&&!d&&setTimeout(()=>{!c&&!l&&(t.submenuOpen=!1)},100)}}handleSizeChange(){Do(this.localName,this.size)}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this.userTypedTimeout),this.closeAllSubmenus(),this.submenuCleanups.forEach(e=>e()),this.submenuCleanups.clear(),document.removeEventListener(`mousemove`,this.handleGlobalMouseMove),document.removeEventListener(`keydown`,this.handleDocumentKeyDown),document.removeEventListener(`pointerdown`,this.handleDocumentPointerDown),vs(this)}firstUpdated(){this.syncAriaAttributes()}async updated(e){if(e.has(`open`)){let t=e.get(`open`);if(t===this.open||t===void 0&&this.open===!1)return;this.customStates.set(`open`,this.open),this.open?await this.showMenu():(this.closeAllSubmenus(),await this.hideMenu())}e.has(`size`)&&this.syncItemSizes()}getItems(e=!1){let t=(this.defaultSlot?.assignedElements({flatten:!0})??[]).filter(e=>e.localName===`wa-dropdown-item`);return e?t:t.filter(e=>!e.disabled)}getSubmenuItems(e,t=!1){let n=e.shadowRoot?.querySelector(`slot[name="submenu"]`)||e.querySelector(`slot[name="submenu"]`);if(!n)return[];let r=n.assignedElements({flatten:!0}).filter(e=>e.localName===`wa-dropdown-item`);return t?r:r.filter(e=>!e.disabled)}syncItemSizes(){(this.defaultSlot?.assignedElements({flatten:!0})??[]).filter(e=>e.localName===`wa-dropdown-item`).forEach(e=>e.size=this.size)}addToSubmenuStack(e){let t=this.openSubmenuStack.indexOf(e);t===-1?this.openSubmenuStack.push(e):this.openSubmenuStack=this.openSubmenuStack.slice(0,t+1)}removeFromSubmenuStack(){return this.openSubmenuStack.pop()}getCurrentSubmenuItem(){return this.openSubmenuStack.length>0?this.openSubmenuStack[this.openSubmenuStack.length-1]:void 0}closeAllSubmenus(){this.getItems(!0).forEach(e=>{e.submenuOpen=!1}),this.openSubmenuStack=[]}closeSiblingSubmenus(e){let t=e.closest(`wa-dropdown-item:not([slot="submenu"])`),n;n=t?this.getSubmenuItems(t,!0):this.getItems(!0),n.forEach(t=>{t!==e&&t.submenuOpen&&(t.submenuOpen=!1)}),this.openSubmenuStack.includes(e)||this.openSubmenuStack.push(e)}getTrigger(){return this.querySelector(`[slot="trigger"]`)}async showMenu(){if(!this.getTrigger()||!this.popup||!this.menu)return;let e=new iu;if(this.dispatchEvent(e),e.defaultPrevented){this.open=!1;return}if(this.popup.active)return;Ou.forEach(e=>e.open=!1),this.popup.active=!0,this.open=!0,Ou.add(this),_s(this),this.syncAriaAttributes(),document.addEventListener(`keydown`,this.handleDocumentKeyDown),document.addEventListener(`pointerdown`,this.handleDocumentPointerDown),document.addEventListener(`mousemove`,this.handleGlobalMouseMove),this.menu.classList.remove(`hide`),await z(this.menu,`show`);let t=this.getItems();t.length>0&&(t.forEach((e,t)=>e.active=t===0),t[0].focus({preventScroll:!0})),this.dispatchEvent(new su)}async hideMenu(){if(!this.popup||!this.menu)return;let e=new au({source:this});if(this.dispatchEvent(e),e.defaultPrevented){this.open=!0;return}this.open=!1,Ou.delete(this),vs(this),this.syncAriaAttributes(),document.removeEventListener(`keydown`,this.handleDocumentKeyDown),document.removeEventListener(`pointerdown`,this.handleDocumentPointerDown),document.removeEventListener(`mousemove`,this.handleGlobalMouseMove),this.menu.classList.remove(`show`),await z(this.menu,`hide`),this.popup.active=this.open,this.dispatchEvent(new ou)}handleMenuClick(e){let t=e.target.closest(`wa-dropdown-item`);if(!(!t||t.disabled)){if(t.hasSubmenu){t.submenuOpen||=(this.closeSiblingSubmenus(t),this.addToSubmenuStack(t),!0),e.stopPropagation();return}this.makeSelection(t)}}async handleMenuSlotChange(){let e=this.getItems(!0);await Promise.all(e.map(e=>e.updateComplete)),this.syncItemSizes();let t=e.some(e=>e.type===`checkbox`),n=e.some(e=>e.hasSubmenu);e.forEach((e,r)=>{e.active=r===0,e.checkboxAdjacent=t,e.submenuAdjacent=n})}handleTriggerClick(){this.open=!this.open}handleSubmenuOpening(e){let t=e.detail.item;this.closeSiblingSubmenus(t),this.addToSubmenuStack(t),this.setupSubmenuPosition(t),this.processSubmenuItems(t)}setupSubmenuPosition(e){if(!e.submenuElement)return;this.cleanupSubmenuPosition(e);let t=Bl(e,e.submenuElement,()=>{this.positionSubmenu(e),this.updateSafeTriangleCoordinates(e)});this.submenuCleanups.set(e,t);let n=e.submenuElement.querySelector(`slot[name="submenu"]`);n&&(n.removeEventListener(`slotchange`,ku.handleSubmenuSlotChange),n.addEventListener(`slotchange`,ku.handleSubmenuSlotChange),ku.handleSubmenuSlotChange({target:n}))}static handleSubmenuSlotChange(e){let t=e.target;if(!t)return;let n=t.assignedElements().filter(e=>e.localName===`wa-dropdown-item`);if(n.length===0)return;let r=n.some(e=>e.hasSubmenu),i=n.some(e=>e.type===`checkbox`);n.forEach(e=>{e.submenuAdjacent=r,e.checkboxAdjacent=i})}processSubmenuItems(e){if(!e.submenuElement)return;let t=this.getSubmenuItems(e,!0),n=t.some(e=>e.hasSubmenu);t.forEach(e=>{e.submenuAdjacent=n})}cleanupSubmenuPosition(e){let t=this.submenuCleanups.get(e);t&&(t(),this.submenuCleanups.delete(e))}positionSubmenu(e){if(!e.submenuElement)return;let t=this.localize.dir()===`rtl`?`left-start`:`right-start`;Kl(e,e.submenuElement,{placement:t,middleware:[Vl({mainAxis:0,crossAxis:-5}),Ul({fallbackStrategy:`bestFit`}),Hl({padding:8})]}).then(({x:t,y:n,placement:r})=>{e.submenuElement.setAttribute(`data-placement`,r),Object.assign(e.submenuElement.style,{left:`${t}px`,top:`${n}px`})})}updateSafeTriangleCoordinates(e){if(!e.submenuElement||!e.submenuOpen)return;if(document.activeElement?.matches(`:focus-visible`)){e.submenuElement.style.setProperty(`--safe-triangle-visible`,`none`);return}e.submenuElement.style.setProperty(`--safe-triangle-visible`,`block`);let t=e.submenuElement.getBoundingClientRect(),n=this.localize.dir()===`rtl`;e.submenuElement.style.setProperty(`--safe-triangle-submenu-start-x`,`${n?t.right:t.left}px`),e.submenuElement.style.setProperty(`--safe-triangle-submenu-start-y`,`${t.top}px`),e.submenuElement.style.setProperty(`--safe-triangle-submenu-end-x`,`${n?t.right:t.left}px`),e.submenuElement.style.setProperty(`--safe-triangle-submenu-end-y`,`${t.bottom}px`)}makeSelection(e){let t=this.getTrigger();if(e.disabled)return;e.type===`checkbox`&&(e.checked=!e.checked);let n=new Tu({item:e});this.dispatchEvent(n),n.defaultPrevented||(this.open=!1,t?.focus({preventScroll:!0}))}async syncAriaAttributes(){let e=this.getTrigger(),t;e&&(e.localName===`wa-button`?(await customElements.whenDefined(`wa-button`),await e.updateComplete,t=e.shadowRoot.querySelector(`[part="base"]`)):t=e,t.hasAttribute(`id`)||t.setAttribute(`id`,Jo(`wa-dropdown-trigger-`)),t.setAttribute(`aria-haspopup`,`menu`),t.setAttribute(`aria-expanded`,this.open?`true`:`false`),this.menu?.setAttribute(`aria-expanded`,`false`))}render(){let e=this.hasUpdated?this.popup?.active:this.open;return b`
    ...
    `}};ku.css=[ko,Eu],D([j(`slot:not([name])`)],ku.prototype,`defaultSlot`,2),D([j(`#menu`)],ku.prototype,`menu`,2),D([j(`wa-popup`)],ku.prototype,`popup`,2),D([k({type:Boolean,reflect:!0})],ku.prototype,`open`,2),D([k({reflect:!0})],ku.prototype,`size`,2),D([E(`size`)],ku.prototype,`handleSizeChange`,1),D([k({reflect:!0})],ku.prototype,`placement`,2),D([k({type:Number})],ku.prototype,`distance`,2),D([k({type:Number})],ku.prototype,`skidding`,2),ku=D([O(`wa-dropdown`)],ku);var Au=y`
  :host {
    display: flex;
    position: relative;
    align-items: center;
...
`,Af=class extends M{constructor(){super(...arguments),this.localize=new T(this),this.value=0,this.indeterminate=!1,this.label=``}updated(e){e.has(`value`)&&requestAnimationFrame(()=>{this.style.setProperty(`--percentage`,`${R(this.value,0,100)}%`)})}render(){return b`
      <div
        part="base"
        class="progress-bar"
        role="progressbar"
...
`,Lf=class extends F{constructor(){super(),this.checked=!1,this.forceDisabled=!1,this.appearance=`default`,this.disabled=!1,this.handleClick=()=>{!this.disabled&&!this.forceDisabled&&(this.checked=!0)},this.addEventListener(`click`,this.handleClick)}handleSizeChange(){Do(this.localName,this.size)}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute(`role`,`radio`),this.tabIndex=0,this.setAttribute(`aria-disabled`,this.disabled||this.forceDisabled?`true`:`false`)}updated(e){if(super.updated(e),e.has(`checked`)&&(this.customStates.set(`checked`,this.checked),this.setAttribute(`aria-checked`,this.checked?`true`:`false`),!this.disabled&&!this.forceDisabled&&(this.tabIndex=this.checked?0:-1)),e.has(`disabled`)||e.has(`forceDisabled`)){let e=this.disabled||this.forceDisabled;this.customStates.set(`disabled`,e),this.setAttribute(`aria-disabled`,e?`true`:`false`),e?this.tabIndex=-1:this.tabIndex=this.checked?0:-1}}setValue(){}render(){return b`
    ...
    `}};Lf.css=[ss,ko,If],D([A()],Lf.prototype,`checked`,2),D([A()],Lf.prototype,`forceDisabled`,2),D([k({reflect:!0})],Lf.prototype,`value`,2),D([k({reflect:!0})],Lf.prototype,`appearance`,2),D([k({reflect:!0})],Lf.prototype,`size`,2),D([E(`size`)],Lf.prototype,`handleSizeChange`,1),D([k({type:Boolean})],Lf.prototype,`disabled`,2),Lf=D([O(`wa-radio`)],Lf),Lf.disableWarning?.(`change-in-update`);var Rf=y`
  :host {
    display: block;
  }
...
`,ep=class extends M{constructor(){super(...arguments),this.localize=new T(this),this.variant=`neutral`,this.appearance=`filled-outlined`,this.size=`m`,this.pill=!1,this.withRemove=!1}handleSizeChange(){Do(this.localName,this.size)}handleRemoveClick(){this.dispatchEvent(new Qf)}render(){return b`
      ...
      ${this.withRemove?b`
          ...
          `:``}
    `}};ep.css=[$f,go,ko],D([k({reflect:!0})],ep.prototype,`variant`,2),D([k({reflect:!0})],ep.prototype,`appearance`,2),D([k({reflect:!0})],ep.prototype,`size`,2),D([E(`size`)],ep.prototype,`handleSizeChange`,1),D([k({type:Boolean,reflect:!0})],ep.prototype,`pill`,2),D([k({attribute:`with-remove`,type:Boolean})],ep.prototype,`withRemove`,2),ep=D([O(`wa-tag`)],ep);var tp=y`
  :host {
...
`,cp=class extends F{constructor(){super(...arguments),this.hasSlotController=new Oo(this,`hint`),this.title=``,this.name=null,this._value=this.getAttribute(`value`)??null,this.size=`m`,this.disabled=!1,this._checked=null,this.defaultChecked=this.hasAttribute(`checked`),this.required=!1,this.hint=``,this.withHint=!1}static get validators(){return[...super.validators,So()]}get value(){return this._value??`on`}set value(e){this._value=e}handleSizeChange(){Do(this.localName,this.size)}get checked(){return this.valueHasChanged?!!this._checked:this._checked??this.defaultChecked}set checked(e){this._checked=!!e,this.valueHasChanged=!0}handleClick(){this.hasInteracted=!0,this.checked=!this.checked,this.updateComplete.then(()=>{this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))})}handleKeyDown(e){e.key===`ArrowLeft`&&(e.preventDefault(),this.checked=!1,this.updateComplete.then(()=>{this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0}))})),e.key===`ArrowRight`&&(e.preventDefault(),this.checked=!0,this.updateComplete.then(()=>{this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0}))}))}willUpdate(e){super.willUpdate(e),(e.has(`value`)||e.has(`checked`)||e.has(`defaultChecked`))&&this.handleValueOrCheckedChange()}handleValueOrCheckedChange(){this.setValue(this.checked?this.value:null,this._value),this.updateValidity()}handleStateChange(){this.hasUpdated&&(this.input.checked=this.checked),this.customStates.set(`checked`,this.checked),this.updateValidity()}handleDisabledChange(){this.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}setValue(e,t){if(!this.checked){this.internals.setFormValue(null,null);return}this.internals.setFormValue(e??`on`,t)}formResetCallback(){this._checked=null,super.formResetCallback(),this.handleValueOrCheckedChange()}render(){let e=this.hasUpdated?this.hasSlotController.test(`hint`):this.withHint,t=this.hint?!0:!!e;return b`
      ...
      <slot
        ...
        >${this.hint}</slot
      >
    `}};cp.shadowRootOptions={...F.shadowRootOptions,delegatesFocus:!0},cp.css=[ss,ko,sp],D([j(`input[type="checkbox"]`)],cp.prototype,`input`,2),D([k()],cp.prototype,`title`,2),D([k({reflect:!0})],cp.prototype,`name`,2),D([k({reflect:!0})],cp.prototype,`value`,1),D([k({reflect:!0})],cp.prototype,`size`,2),D([E(`size`)],cp.prototype,`handleSizeChange`,1),D([k({type:Boolean})],cp.prototype,`disabled`,2),D([k({type:Boolean,attribute:!1})],cp.prototype,`checked`,1),D([k({type:Boolean,attribute:`checked`,reflect:!0})],cp.prototype,`defaultChecked`,2),D([k({type:Boolean,reflect:!0})],cp.prototype,`required`,2),D([k({attribute:`hint`})],cp.prototype,`hint`,2),D([k({attribute:`with-hint`,type:Boolean})],cp.prototype,`withHint`,2),D([E([`checked`,`defaultChecked`])],cp.prototype,`handleStateChange`,1),D([E(`disabled`,{waitUntilFirstUpdate:!0})],cp.prototype,`handleDisabledChange`,1),cp=D([O(`wa-switch`)],cp),cp.disableWarning?.(`change-in-update`);var lp=y`
  :host {
    display: inline-block;
    color: var(--wa-color-neutral-on-quiet);
    font-weight: var(--wa-font-weight-action);
...
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+sh(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function Z(e,t){return Sh.parse(e,t)}Z.options=Z.setOptions=function(e){return Sh.setOptions(e),Z.defaults=Sh.defaults,Xp(Z.defaults),Z},Z.getDefaults=Jp,Z.defaults=Yp,Z.use=function(...e){return Sh.use(...e),Z.defaults=Sh.defaults,Xp(Z.defaults),Z},Z.walkTokens=function(e,t){return Sh.walkTokens(e,t)},Z.parseInline=Sh.parseInline,Z.Parser=bh,Z.parser=bh.parse,Z.Renderer=vh,Z.TextRenderer=yh,Z.Lexer=_h,Z.lexer=_h.lex,Z.Tokenizer=gh,Z.Hooks=xh,Z.parse=Z,Z.options,Z.setOptions,Z.use,Z.walkTokens,Z.parseInline,bh.parse,_h.lex;function Q(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var Ch=()=>new wh,wh=class{},Th=new WeakMap,Eh=pn(class extends Fn{render(e){return x}update(e,[t]){let n=t!==this.G;return n&&this.G!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),x}rt(e){if(this.isConnected||(e=void 0),typeof this.G==`function`){let t=this.ht??globalThis,n=Th.get(t);n===void 0&&(n=new WeakMap,Th.set(t,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return typeof this.G==`function`?Th.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Dh=(e,t,n)=>{let r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},Oh=pn(class extends mn{constructor(e){if(super(e),e.type!==fn.CHILD)throw Error(`repeat() can only be used in text expressions`)}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);let i=[],a=[],o=0;for(let t of e)i[o]=r?r(t,o):o,a[o]=n(t,o),o++;return{values:a,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,r]){let i=En(e),{values:a,keys:o}=this.dt(t,n,r);if(!Array.isArray(i))return this.ut=o,a;let s=this.ut??=[],c=[],l,u,d=0,f=i.length-1,p=0,m=a.length-1;for(;d<=f&&p<=m;)if(i[d]===null)d++;else if(i[f]===null)f--;else if(s[d]===o[p])c[p]=Cn(i[d],a[p]),d++,p++;else if(s[f]===o[m])c[m]=Cn(i[f],a[m]),f--,m--;else if(s[d]===o[m])c[m]=Cn(i[d],a[m]),Sn(e,c[m+1],i[d]),d++,m--;else if(s[f]===o[p])c[p]=Cn(i[f],a[p]),Sn(e,i[d],i[f]),f--,p++;else if(l===void 0&&(l=Dh(o,p,m),u=Dh(s,d,f)),l.has(s[d]))if(l.has(s[f])){let t=u.get(o[p]),n=t===void 0?null:i[t];if(n===null){let t=Sn(e,i[d]);Cn(t,a[p]),c[p]=t}else c[p]=Cn(n,a[p]),Sn(e,i[d],n),i[t]=null;p++}else Dn(i[f]),f--;else Dn(i[d]),d++;for(;p<=m;){let t=Sn(e,c[m+1]);Cn(t,a[p]),c[p++]=t}for(;d<=f;){let e=i[d++];e!==null&&Dn(e)}return this.ut=o,Tn(e,c),Ke}}),kh=Object.defineProperty,Ah=((e,t)=>{let n={};for(var r in e)kh(n,r,{get:e[r],enumerable:!0});return t||kh(n,Symbol.toStringTag,{value:`Module`}),n})({COMMAND_SAVE:()=>Gh,EDITOR_AREA_MAIN:()=>Bh,HIDE_DOT_RESOURCE:()=>!1,MouseButton:()=>Kh,PANEL_BOTTOM:()=>Wh,SIDEBAR_AUXILIARY:()=>Uh,SIDEBAR_MAIN:()=>Vh,SIDEBAR_MAIN_BOTTOM:()=>Hh,SIDEBAR_MAIN_TOOLBAR:()=>Lh,SYSTEM_LAYOUTS:()=>zh,SYSTEM_VIEWS:()=>Rh,TOOLBAR_BOTTOM:()=>Ph,TOOLBAR_BOTTOM_CENTER:()=>Fh,TOOLBAR_BOTTOM_END:()=>Ih,TOOLBAR_MAIN:()=>jh,TOOLBAR_MAIN_CENTER:()=>Nh,TOOLBAR_MAIN_RIGHT:()=>Mh}),jh=`app-toolbars-main`,Mh=`app-toolbars-main-right`,Nh=`app-toolbars-main-center`,Ph=`app-toolbars-bottom`,Fh=`app-toolbars-bottom-center`,Ih=`app-toolbars-bottom-end`,Lh=`sidebar-main-toolbar`,Rh=`system-views`,zh=`system.layouts`,Bh=`editor-area-main`,Vh=`sidebar-main`,Hh=`sidebar-main-bottom`,Uh=`sidebar-auxiliary`,Wh=`panel-bottom`,Gh=`command-save`,Kh=function(e){return e[e.LEFT=0]=`LEFT`,e[e.MIDDLE=1]=`MIDDLE`,e[e.RIGHT=2]=`RIGHT`,e[e.BACK=3]=`BACK`,e[e.FORWARD=4]=`FORWARD`,e}({}),qh=`.eclipse-docks/settings.json`,Jh=`dialogSettings`,Yh=`events/settings/changed`;function Xh(e,t){if(t){for(let[n,r]of Object.entries(t))if(r&&typeof r==`object`){let t=e[n];t?.properties&&r.properties?Xh(t.properties,r.properties):e[n]={...r,properties:r.properties?{...r.properties}:void 0}}}}var Zh=new class{constructor(){this.mergedSchema={type:`object`,properties:{}}}async checkSettings(){this.appSettings||(this.appSettings=await a.getObject(qh),this.appSettings||(this.appSettings={},await a.persistObject(qh,this.appSettings)),_(Yh,this.appSettings))}registerSchema(e){let t=e.properties??(e.type===`object`?{}:void 0);t&&(this.mergedSchema.properties||(this.mergedSchema.properties={}),Xh(this.mergedSchema.properties,t))}getCategories(){let e=this.mergedSchema.properties;return e?Object.entries(e).filter(([,e])=>e&&typeof e==`object`).map(([e,t])=>({id:e,label:t.title??e,order:typeof t.order==`number`?t.order:0,schema:t})).sort((e,t)=>e.order-t.order):[]}getSchemaForCategory(e){return this.mergedSchema.properties?.[e]}getSchemaForSettingKey(e){let t=e.split(`.`).filter(Boolean);if(t.length===0)return this.mergedSchema;let n=this.mergedSchema;for(let e of t)if(n=n?.properties?.[e],!n)return;return n}traversePath(e,t,n){if(t.length===0)return null;let r=e,i=t.length-1;for(let e=0;e<i;e++){let i=t[e];if(r[i]===void 0){if(!n)return null;r[i]={}}if(r[i]===null||typeof r[i]!=`object`)return null;r=r[i]}return{parent:r,key:t[i]}}async getAt(e){await this.checkSettings();let t=e.split(`.`).filter(Boolean);if(t.length===0)return this.appSettings;let n=this.traversePath(this.appSettings,t,!1);if(n)return n.parent[n.key]}async setAt(e,t){await this.checkSettings();let n=e.split(`.`).filter(Boolean);if(n.length===0)return;let r=this.traversePath(this.appSettings,n,!0);r&&(r.parent[r.key]=t,await a.persistObject(qh,this.appSettings),_(Yh,this.appSettings))}async get(e){return await this.checkSettings(),this.appSettings[e]}async set(e,t){await this.checkSettings(),this.appSettings[e]=t,await a.persistObject(qh,this.appSettings),_(Yh,this.appSettings)}async getAll(){return await this.checkSettings(),this.appSettings}async setAll(e){this.appSettings=e,await a.persistObject(qh,this.appSettings),_(Yh,this.appSettings)}async getDialogSetting(e){return await this.checkSettings(),(this.appSettings.dialogSettings||{})[e]}async setDialogSetting(e,t){await this.checkSettings();let n=this.appSettings.dialogSettings||{};n[e]=t,this.appSettings[Jh]=n,await a.persistObject(qh,this.appSettings),_(Yh,this.appSettings)}};c.put(`appSettings`,Zh);var Qh=new class{constructor(){this.tasks=[],this.updateCounter=0}notifyUpdate(){this.updateCounter++,Qn.set(this.updateCounter)}run(e,t){let n=this.createProgressMonitor(e);try{this.tasks.push(n),this.notifyUpdate(),t(n)}finally{this.tasks.splice(this.tasks.indexOf(n),1),this.notifyUpdate()}}async runAsync(e,t){let n=this.createProgressMonitor(e);return this.tasks.push(n),this.notifyUpdate(),t(n).finally(()=>{this.tasks.splice(this.tasks.indexOf(n),1),this.notifyUpdate()})}createProgressMonitor(e){return new Proxy({name:e,message:``,currentStep:0,totalSteps:-1,progress:-1},{set:(e,t,n)=>(e[t]=n,this.notifyUpdate(),!0)})}getActiveTasks(){return this.tasks}};c.put(`taskService`,Qh);var $h=m(`EsmShService`),eg=new class e{static{this.ESM_SH_BASE=`https://esm.sh`}static{this.GITHUB_PREFIX=`gh/`}static{this.JSR_PREFIX=`jsr/`}static{this.PR_PREFIX=`pr/`}isEsmShUrl(e){try{let t=new URL(e);return t.hostname===`esm.sh`||t.hostname===`raw.esm.sh`}catch{return!1}}isSourceIdentifier(e){return this.isEsmShUrl(e)||this.isHttpUrl(e)?!1:this.parseSource(e)!==null}isHttpUrl(e){try{let t=new URL(e);return t.protocol===`http:`||t.protocol===`https:`}catch{return!1}}parseSource(t){return!t||typeof t!=`string`||(t=t.trim(),this.isHttpUrl(t))?null:t.startsWith(e.GITHUB_PREFIX)?this.parseGitHubSource(t):t.startsWith(e.JSR_PREFIX)?this.parseJsrSource(t):t.startsWith(e.PR_PREFIX)?this.parsePrSource(t):this.parseNpmSource(t)}parseGitHubSource(t){let n=t.substring(e.GITHUB_PREFIX.length).split(`/`);if(n.length<2)return null;let r=n[0],i=n[1],a,o,s,c=i.match(/^(.+?)(@(.+))?$/);return c?(a=c[1],o=c[3],n.length>2&&(s=n.slice(2).join(`/`)),{type:`github`,owner:r,repo:a,version:o,path:s}):null}parseJsrSource(t){let n=t.substring(e.JSR_PREFIX.length);if(!n.startsWith(`@`))return null;let r=n.split(`/`);if(r.length<2)return null;let i=r[0],a=r[1],o,s,c,l=a.match(/^(.+?)(@(.+))?$/);return l?(o=`${i}/${l[1]}`,s=l[3],r.length>2&&(c=r.slice(2).join(`/`)),{type:`jsr`,package:o,version:s,path:c}):null}parsePrSource(t){let n=t.substring(e.PR_PREFIX.length).split(`/`);if(n.length<2)return null;let r=n[0],i=n[1],a,o,s=i.match(/^(.+?)@(.+)$/);return s?(a=s[1],o=s[2]):a=i,{type:`pr`,owner:r,repo:a,commit:o}}parseNpmSource(e){let t=e.split(`/`),n=t[0],r,i,a,o=n.match(/^(.+?)(@(.+))?$/);return o?(r=o[1],i=o[3],t.length>1&&(a=t.slice(1).join(`/`)),{type:`npm`,package:r,version:i,path:a}):null}buildEsmShUrl(t,n){let r=e.ESM_SH_BASE;switch(t.type){case`npm`:r+=`/${t.package}`,t.version&&(r+=`@${t.version}`),t.path&&(r+=`/${t.path}`);break;case`github`:r+=`/${e.GITHUB_PREFIX}${t.owner}/${t.repo}`,t.version&&(r+=`@${t.version}`),t.path&&(r+=`/${t.path}`);break;case`jsr`:r+=`/${e.JSR_PREFIX}${t.package}`,t.version&&(r+=`@${t.version}`),t.path&&(r+=`/${t.path}`);break;case`pr`:r+=`/${e.PR_PREFIX}${t.owner}/${t.repo}`,t.commit&&(r+=`@${t.commit}`);break}let i=[];if(n?.deps){let e=Object.entries(n.deps).map(([e,t])=>`${e}@${t}`).join(`,`);i.push(`deps=${encodeURIComponent(e)}`)}return n?.target&&i.push(`target=${encodeURIComponent(n.target)}`),n?.dev&&i.push(`dev`),n?.bundle===!1?i.push(`bundle=false`):n?.bundle===!0&&i.push(`bundle`),i.length>0&&(r+=`?${i.join(`&`)}`),r}normalizeToEsmSh(e,t){if(this.isEsmShUrl(e)||this.isHttpUrl(e))return e;let n=this.parseSource(e);return n?this.buildEsmShUrl(n,t):($h.warn(`Could not parse source identifier: ${e}`),e)}extractPackageName(e){let t=this.parseSource(e);if(!t)return null;switch(t.type){case`npm`:return t.package||null;case`github`:return`${t.owner}/${t.repo}`;case`jsr`:return t.package||null;case`pr`:return`${t.owner}/${t.repo}`}}isGitHubUrl(e){try{let t=new URL(e);return t.hostname===`github.com`||t.hostname===`www.github.com`}catch{return e.startsWith(`https://github.com/`)||e.startsWith(`http://github.com/`)}}convertGitHubUrlToSource(t){try{let n=new URL(t).pathname.split(`/`).filter(e=>e);if(n.length<2)throw Error(`Invalid GitHub URL format`);let r=n[0],i=n[1].replace(/\.git$/,``),a,o;n.length>2&&(n[2]===`blob`||n[2]===`tree`?(a=n[3]||`main`,n[2]===`blob`&&n.length>4&&(o=n.slice(4).join(`/`))):n[2]===`commit`?a=n[3]:o=n.slice(2).join(`/`));let s=`${e.GITHUB_PREFIX}${r}/${i}`;return a&&(s+=`@${a}`),o&&(s+=`/${o}`),s}catch{let n=t.match(/github\.com\/([^\/]+)\/([^\/]+)/);return n?`${e.GITHUB_PREFIX}${n[1]}/${n[2].replace(/\.git$/,``)}`:t}}async fetchGitHubPackageJson(e){if(e.type!==`github`)throw Error(`Source must be a GitHub source`);let t=`https://raw.githubusercontent.com/${e.owner}/${e.repo}/${e.version||`main`}/package.json`,n=await fetch(t);if(!n.ok)throw Error(`Failed to fetch package.json: ${n.statusText}`);return await n.json()}};c.put(`esmShService`,eg);var tg=`events/extensionsregistry/extensionsConfigChanged`,ng=`extensions`,rg=`extensions.external`,ig=new class{constructor(){this.extensions={},this.loadedExtensions=new Set,this.loadingPromises=new Map,o(Yh,()=>{this.extensionsSettings=void 0,this.checkExtensionsConfig().then()}),this.loadPersistedExternalExtensions().then(()=>{this.checkExtensionsConfig().then()})}async loadPersistedExternalExtensions(){try{let e=await Zh.get(rg);e&&Array.isArray(e)&&e.forEach(e=>{this.extensions[e.id]=e})}catch(e){d.error(`Failed to load persisted external extensions: ${e}`)}}async savePersistedExternalExtensions(){try{let e=Object.values(this.extensions).filter(e=>e.external);await Zh.set(rg,e)}catch(e){d.error(`Failed to save persisted external extensions: ${e}`)}}async checkExtensionsConfig(){this.extensionsSettings||(this.extensionsSettings=await Zh.get(ng),this.extensionsSettings||=(await Zh.set(ng,[]),await Zh.get(ng)),_(tg,this.extensionsSettings))}registerExtension(e){this.extensions[e.id]=e,d.debug(`Registered extension: ${e.id}`),e.external&&this.savePersistedExternalExtensions().catch(e=>{d.error(`Failed to persist external extension: ${e}`)}),_(tg,this.extensionsSettings)}async loadExtensionFromUrl(e,t){d.info(`Loading extension from URL: ${e}...`);try{let n=e,r=`Extension from ${e}`;if(eg.isSourceIdentifier(e)){let t=eg.extractPackageName(e);t&&(r=`Extension: ${t}`),n=eg.normalizeToEsmSh(e),d.debug(`Converted source identifier to esm.sh URL: ${e} -> ${n}`)}let i=t||`url:${n}`;if(this.isEnabled(i))return d.info(`Extension from URL ${n} is already enabled`),i;if(!this.extensions[i]){let t={id:i,name:r,description:`Extension loaded from: ${e}`,url:n};this.registerExtension(t),d.info(`Registered extension from URL: ${i}`)}return await this.enableAsync(i,!1),d.info(`Successfully enabled extension from URL: ${n}`),i}catch(t){throw d.error(`Failed to load extension from URL ${e}: ${t}`),t}}getExtensions(){return Object.values(this.extensions)}async loadEnabledExtensions(){await this.checkExtensionsConfig();let e=(this.extensionsSettings??[]).filter(e=>this.isEnabled(e.id)&&this.extensions[e.id]).map(e=>this.load(e.id).catch(e=>{S(`Extension could not be loaded: `+e.message)}));await Promise.all(e)}isEnabled(e){return this.checkExtensionsConfig(),!!this.extensionsSettings?.find(t=>t.id===e&&t.enabled)}isLoaded(e){return this.loadedExtensions.has(e)}enable(e,t=!1){this.isEnabled(e)||(d.debug(`Loading extension: ${e}`),this.load(e).then(()=>this.updateEnablementAsync(e,!0,t)).catch(t=>{d.error(`Could not load extension: ${e}: ${t}`)}))}async enableAsync(e,t=!1){if(this.isEnabled(e)){if(!this.isLoaded(e)){d.debug(`Extension ${e} is enabled in settings but not loaded; loading now`);try{await this.load(e)}catch(t){throw d.error(`Could not load extension: ${e}: ${t}`),t}}return}d.debug(`Loading extension: ${e}`);try{await this.load(e),await this.updateEnablementAsync(e,!0,t)}catch(t){throw d.error(`Could not load extension: ${e}: ${t}`),t}}async ensureExtensionRegistered(e){if(!this.extensions[e]){try{await v(()=>import(e),[])}catch(t){d.debug(`Could not side-effect import extension package ${e}: ${t}`)}if(!this.extensions[e])throw Error(`Extension not found: `+e)}}async load(e,t=[]){if(this.loadedExtensions.has(e))return;let n=this.loadingPromises.get(e);if(n)return n;if(t.includes(e)){let n=[...t,e].join(` → `);throw Error(`Circular dependency detected: ${n}`)}this.extensions[e]||await this.ensureExtensionRegistered(e);let i=this.extensions[e];if(!i)throw Error(`Extension not found: `+e);let a=(async()=>{try{if(d.debug(`Loading extension: ${e}`),i.dependencies&&i.dependencies.length>0){let n=[...t,e];for(let e of i.dependencies)await this.load(e,n),this.isEnabled(e)||(await this.updateEnablementAsync(e,!0,!1),d.debug(`Auto-enabled dependency: ${e}`))}let n=await Qh.runAsync(`Loading extension: `+i.name,async()=>{if(i.loader)return i.loader();if(i.url){let e=i.url;return eg.isSourceIdentifier(i.url)&&(e=eg.normalizeToEsmSh(i.url),d.debug(`Normalized extension URL: ${i.url} -> ${e}`)),v(()=>import(e),[])}});if(n?.default instanceof Function)try{let e=n.default(r.getProxy());await Promise.resolve(e)}catch(t){throw d.error(`Error executing extension function for ${e}: ${t}`),t}this.loadedExtensions.add(e)}catch(t){throw this.loadedExtensions.delete(e),t}finally{this.loadingPromises.delete(e)}})();return this.loadingPromises.set(e,a),a}disable(e,t=!1){this.isEnabled(e)&&this.updateEnablementAsync(e,!1,t).catch(t=>{d.error(`Could not persist disable for extension ${e}: ${t}`)})}async updateEnablementAsync(e,t,n){await this.checkExtensionsConfig();let r=this.extensionsSettings?.find(t=>t.id==e);if(r?r.enabled=t:this.extensionsSettings?.push({id:e,enabled:t}),await Zh.set(ng,this.extensionsSettings),n){let n=this.extensions[e];Hn(t?n.name+` enabled.`:n.name+` disabled  - Please restart to take effect`)}_(tg,this.extensionsSettings)}};c.put(`extensionRegistry`,ig);var ag=[`alt`,`ctrl`,`meta`,`shift`],og={CTRL:`ctrl`,CONTROL:`ctrl`,ALT:`alt`,OPTION:`alt`,SHIFT:`shift`,META:`meta`,CMD:`meta`,COMMAND:`meta`,WIN:`meta`,WINDOWS:`meta`},sg={ctrl:`Ctrl`,alt:`Alt`,shift:`Shift`,meta:`Cmd`},cg={SPACE:` `,ESC:`ESCAPE`,RETURN:`ENTER`,LEFT:`ARROWLEFT`,RIGHT:`ARROWRIGHT`,UP:`ARROWUP`,DOWN:`ARROWDOWN`,DEL:`DELETE`,INS:`INSERT`,PAGEUP:`PAGEUP`,PAGEDOWN:`PAGEDOWN`},lg=new Set(Object.keys(og));function ug(e){return cg[e]??e}var dg=new class{constructor(){this.bindings=new Map,this.enabled=!0,document.addEventListener(`keydown`,this.handleKeyDown.bind(this),!0),this.registerExistingCommandBindings(),o(er,e=>{e.keyBinding&&this.registerKeyBinding(e.id,e.keyBinding)})}registerExistingCommandBindings(){let e=rr.listCommands();Object.values(e).forEach(e=>{e.keyBinding&&this.registerKeyBinding(e.id,e.keyBinding)})}parseKeyBinding(e){if(!e||e.trim()===``)return null;let t=e.toUpperCase().split(`+`).map(e=>e.trim());if(t.length===0)return null;let n=t[t.length-1],r=t.slice(0,-1);if(t.length===1&&lg.has(n))return null;let i={ctrl:!1,alt:!1,shift:!1,meta:!1};for(let e of r){let t=og[e];if(t===void 0)return null;i[t]=!0}return i.key=ug(n),i}getBindingKey(e){return[...ag.filter(t=>e[t]),e.key.toUpperCase()].join(`+`)}registerKeyBinding(e,t){let n=this.parseKeyBinding(t);if(!n)return d.error(`Invalid key binding: ${t}`),!1;n.commandId=e;let r=this.getBindingKey(n);this.bindings.has(r)||this.bindings.set(r,[]);let i=this.bindings.get(r);if(i.find(t=>t.commandId===e))return d.error(`Key binding ${t} already registered for command ${e}`),!1;let a=i.find(t=>t.commandId!==e);return a?(d.warn(`Key binding ${t} already used by command ${a.commandId}; refusing for ${e}`),!1):(i.push(n),!0)}unregisterKeyBinding(e,t){if(t){let n=this.parseKeyBinding(t);if(n){let t=this.getBindingKey(n),r=this.bindings.get(t);if(r){let n=r.filter(t=>t.commandId!==e);n.length===0?this.bindings.delete(t):this.bindings.set(t,n)}}}else for(let[t,n]of this.bindings.entries()){let r=n.filter(t=>t.commandId!==e);r.length===0?this.bindings.delete(t):this.bindings.set(t,r)}}getKeyBindingsForCommand(e){let t=[];for(let n of this.bindings.values())for(let r of n)r.commandId===e&&t.push(this.formatKeyBinding(r));return t.sort()}formatKeyBinding(e){let t=ag.filter(t=>e[t]).map(e=>sg[e]),n=e.key.length===1?e.key.toUpperCase():e.key.charAt(0).toUpperCase()+e.key.slice(1).toLowerCase();return t.push(n),t.join(`+`)}handleKeyDown(e){if(!this.enabled)return;let t={commandId:``,key:ug(e.key.toUpperCase()),ctrl:e.ctrlKey,alt:e.altKey,shift:e.shiftKey,meta:e.metaKey},n=this.getBindingKey(t),r=this.bindings.get(n);if(r&&r.length>0){let t=r[0];e.preventDefault(),e.stopPropagation();let n=rr.createExecutionContext({});rr.execute(t.commandId,n).then(()=>{d.debug(`Executed command via key binding: ${t.commandId}`)},e=>{let n=e instanceof Error?e.message:String(e);d.error(`Failed to execute command ${t.commandId}: ${n}`)})}}setEnabled(e){this.enabled=e}isEnabled(){return this.enabled}getAllBindings(){let e=new Map;for(let[t,n]of this.bindings)e.set(t,[...n]);return e}clearAll(){this.bindings.clear()}};c.put(`keyBindingManager`,dg);var fg=class extends sr{constructor(...e){super(...e),this.settingsKey=null}buildDOMTreePath(){let e=[],t=this;for(;t&&t!==document.body&&t!==document.documentElement;){let n=t.getAttribute(`id`);if(n){e.unshift(`#${n}`);break}let r=t.tagName.toLowerCase(),i=t.parentElement;if(!i)break;let a=Array.from(i.children).filter(e=>e.tagName.toLowerCase()===r).indexOf(t);a>=0?e.unshift(`${r}:${a}`):e.unshift(r),t=i}return e.length>0?e.join(` > `):null}initializeSettingsKey(){if(!this.settingsKey){let e=this.tagName.toLowerCase(),t=this.getAttribute(`id`);if(t){this.settingsKey=`${e}:${t}`;return}let n=this.buildDOMTreePath();n&&(this.settingsKey=`${e}:${n}`)}}async getDialogSetting(){if(this.initializeSettingsKey(),this.settingsKey)return await Zh.getDialogSetting(this.settingsKey)}async setDialogSetting(e){this.initializeSettingsKey(),this.settingsKey&&await Zh.setDialogSetting(this.settingsKey,e)}},pg=class extends fg{static{this.styles=[y`
        ...
        `}};Q([k({type:String})],n_.prototype,`message`,void 0),Q([k({type:String,attribute:`default-value`})],n_.prototype,`defaultValue`,void 0),Q([k({type:Boolean})],n_.prototype,`markdown`,void 0),Q([A()],n_.prototype,`inputValue`,void 0),n_=Q([O(`docks-prompt-dialog-content`)],n_),C.registerContribution(hg,{id:`prompt`,label:`Input`,buttons:[gg,_g],component:e=>e?b`
            <docks-prompt-dialog-content 
                ...
                .markdown="${e.markdown}"
            ></docks-prompt-dialog-content>
        `:b`<div>Error: No prompt dialog state</div>`,onButton:async(e,t,n)=>(n&&(e===`ok`?n.resolve(t||``):n.resolve(null)),!0)});async function r_(e,t=``,n=!1){return new Promise(r=>{xg.open(`prompt`,{message:e,defaultValue:t,markdown:n,resolve:r})})}var i_=class extends pg{constructor(...e){super(...e),this.fields=[],this.message=``,this.markdown=!1,this.values={},this.validationError=``}static{this.styles=[...pg.styles,y`
            .form-fields {
                display: flex;
                flex-direction: column;
                gap: 0.75rem;
        ...
        `}};Q([k({attribute:!1})],i_.prototype,`fields`,void 0),Q([k({type:String})],i_.prototype,`message`,void 0),Q([k({type:Boolean})],i_.prototype,`markdown`,void 0),Q([A()],i_.prototype,`values`,void 0),Q([A()],i_.prototype,`validationError`,void 0),i_=Q([O(`docks-form-dialog-content`)],i_);function a_(e){return Object.fromEntries(Object.entries(e).map(([e,t])=>[e,t.trim()]))}function o_(){return document.querySelector(`docks-form-dialog-content`)}function s_(e,t){for(let n of e)if(n.required!==!1&&!t[n.name]?.trim())return`${n.label} is required.`;return null}C.registerContribution(hg,{id:`form`,label:`Form`,buttons:[gg,_g],component:e=>e?b`
            <docks-form-dialog-content
                .message=${e.message??``}
                .markdown=${e.markdown??!1}
                .fields=${e.fields}
            ></docks-form-dialog-content>
        `:b`<div>Error: No form dialog state</div>`,onButton:async(e,t,n)=>{if(!n)return!0;if(e===`ok`){let e=a_(t??{}),r=s_(n.fields,e);if(r)return o_()?.setValidationError(r),!1;n.resolve(e)}else n.resolve(null);return!0}});var c_=class extends pg{constructor(...e){super(...e),this.message=``,this.markdown=!1}render(){return b`
            ${this.renderMessage(this.message,this.markdown)}
        `}};Q([k({type:String})],c_.prototype,`message`,void 0),Q([k({type:Boolean})],c_.prototype,`markdown`,void 0),c_=Q([O(`docks-info-dialog-content`)],c_),C.registerContribution(hg,{id:`info`,label:`Information`,buttons:[gg],component:e=>e?b`
            <docks-info-dialog-content 
                .message="${e.message}"
                .markdown="${e.markdown}"
            ></docks-info-dialog-content>
        `:b`<div>Error: No info dialog state</div>`,onButton:async(e,t,n)=>(n&&n.resolve&&n.resolve(),!0)});async function l_(e,t,n=!1){return new Promise(r=>{xg.open(`info`,{title:e,message:t,markdown:n,resolve:r})})}var u_=class extends pg{constructor(...e){super(...e),this.message=``,this.markdown=!1}getResult(){return!1}render(){return b`
            ${this.renderMessage(this.message,this.markdown)}
        `}};Q([k({type:String})],u_.prototype,`message`,void 0),Q([k({type:Boolean})],u_.prototype,`markdown`,void 0),u_=Q([O(`docks-confirm-dialog-content`)],u_),C.registerContribution(hg,{id:`confirm`,label:`Confirm`,buttons:[gg,_g],component:e=>e?b`
            <docks-confirm-dialog-content 
                .message="${e.message}"
                .markdown="${e.markdown}"
            ></docks-confirm-dialog-content>
        `:b`<div>Error: No confirm dialog state</div>`,onButton:async(e,t,n)=>(n&&(e===`ok`?n.resolve(!0):n.resolve(!1)),!0)});async function d_(e,t=!1){return new Promise(n=>{xg.open(`confirm`,{message:e,markdown:t,resolve:n})})}var f_=class extends pg{constructor(...e){super(...e),this.title=``,this.message=``,this.markdown=!1,this.actions=[],this.currentTitle=``,this.currentMessage=``,this.dialogElement=null}async firstUpdated(e){super.firstUpdated(e),this.currentTitle=this.title,this.currentMessage=this.message,await this.updateComplete;let t=this.closest(`wa-dialog`);t&&(this.dialogElement=t,this.updateDialogLabel());let n=this.closest(`.dialog-service-content`);if(n){let e=n.parentElement?.querySelector(`.dialog-service-footer`);e&&(e.style.display=`none`)}}updated(e){super.updated(e),e.has(`title`)&&(this.currentTitle=this.title,this.updateDialogLabel()),e.has(`message`)&&(this.currentMessage=this.message)}updateDialogLabel(){this.dialogElement&&this.dialogElement.setAttribute(`label`,this.currentTitle)}updateDialog(e,t,n){this.currentTitle=e,this.currentMessage=t,this.actions=[...n],this.updateDialogLabel(),this.requestUpdate()}handleActionClick(e){e.callback()}handleClose(){this.closest(`wa-dialog`)&&this.resolveCallback&&this.resolveCallback()}static{this.styles=[...pg.styles,y`
            :host {
                display: block;
            }
        ...
        `}};Q([k({type:String})],f_.prototype,`title`,void 0),Q([k({type:String})],f_.prototype,`message`,void 0),Q([k({type:Boolean})],f_.prototype,`markdown`,void 0),Q([A()],f_.prototype,`actions`,void 0),Q([A()],f_.prototype,`currentTitle`,void 0),Q([A()],f_.prototype,`currentMessage`,void 0),f_=Q([O(`docks-navigable-info-dialog-content`)],f_),C.registerContribution(hg,{id:`navigable-info`,label:`Information`,buttons:[vg],component:e=>{if(!e)return b`<div>Error: No navigable info dialog state</div>`;let t=b`
            <docks-navigable-info-dialog-content 
                .title="${e.title}"
                .message="${e.message}"
                .markdown="${e.markdown}"
            ></docks-navigable-info-dialog-content>
        `;return(async()=>{let t=document.querySelector(`docks-navigable-info-dialog-content`);t&&(await t.updateComplete,t.actions=e.actions||[],t.resolveCallback=e.resolve,e.updateDialogRef&&(e.updateDialogRef.current=(e,n,r)=>{t.updateDialog(e,n,r)}))})(),t},onButton:async(e,t,n)=>n&&e===`close`&&n.resolve?(n.resolve(),!0):!1});var p_=class extends pg{constructor(...e){super(...e),this.mode=`either`,this.selectedPath=null,this.rootNodes=[],this.loading=!1,this.loadError=null}static{this.styles=[...pg.styles,y`
      :host {
        min-width: 0;
        overflow-x: hidden;
        display: block;
    ...
    `}var y_=class extends fg{constructor(...e){super(...e),this.position=`start`,this.orientation=`horizontal`,this.align=`start`,this.size=`small`,this.scopeTokens=[],this.partToolbarContent=void 0,this.partToolbarRenderer=void 0,this.contributions=[],this.compact=!1,this.resizeObserver=null,this.resizeDebounceTimer=null,this.overflowCheckScheduled=!1,this.onResize=()=>{this.resizeDebounceTimer!==null&&clearTimeout(this.resizeDebounceTimer),this.resizeDebounceTimer=setTimeout(()=>{this.resizeDebounceTimer=null,this.updateCompactFromSpace()},__)}}updateCompactFromSpace(){let e=this.shadowRoot?.querySelector(`.toolbar-items`);if(!e)return;let t=e.scrollWidth>e.clientWidth;this.compact!==t&&(this.compact=t,this.requestUpdate())}scheduleOverflowCheck(){this.overflowCheckScheduled||(this.overflowCheckScheduled=!0,requestAnimationFrame(()=>{this.overflowCheckScheduled=!1,this.updateCompactFromSpace()}))}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(this.onResize),this.resizeObserver.observe(this)}disconnectedCallback(){this.resizeObserver?.disconnect(),this.resizeObserver=null,this.resizeDebounceTimer!==null&&(clearTimeout(this.resizeDebounceTimer),this.resizeDebounceTimer=null),super.disconnectedCallback()}updated(e){super.updated?.(e),this.compact||this.scheduleOverflowCheck(),e.has(`scopeTokens`)&&this.refreshContributions()}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===`id`&&t!==n&&this.refreshContributions()}doBeforeUI(){this.refreshContributions(),o(Gn,e=>{let t=this.getAttribute(`id`);t&&this.matchesTarget(t,e.target)&&(this.refreshContributions(),this.requestUpdate())})}refreshContributions(){let e=this.getAttribute(`id`);if(!e){this.contributions=[];return}this.loadContributions(e)}matchesTarget(e,t){if(t===e)return!0;if(!e.includes(`:`))return!1;let[n]=e.split(`:`);if(t===`${n}:*`)return!0;let r=t.split(`:`);if(r.length===2){let t=r[1];if(this.scopeTokens.includes(t))return e.startsWith(`${n}:`)}return!1}loadContributions(e){let t=C.getContributions(e);if(!e.includes(`:`)){this.contributions=t;return}let[n]=e.split(`:`),r=`${n}:*`,i=C.getContributions(r),a=[];for(let e of this.scopeTokens){let t=`${n}:${e}`,r=C.getContributions(t);a.push(...r)}this.contributions=[...i,...a,...t]}isToolbarItem(e){return`command`in e||`component`in e}contributionCreator(e){if(`command`in e){let t=e,n=!this.compact&&!!t.showLabel;return b`
            ...
            <div class="toolbar-items" style=${N({"flex-direction":t,"align-items":n[this.align],"justify-content":this.position})}>
                ${v_(`start`,this.orientation,this.contributions,i,r)}
                ${e}
                ${v_(void 0,this.orientation,this.contributions,i,r)}
                ${v_(`end`,this.orientation,this.contributions,i,r)}
            </div>
    ...
    `}};Q([k()],y_.prototype,`position`,void 0),Q([k({reflect:!0})],y_.prototype,`orientation`,void 0),Q([k({reflect:!0})],y_.prototype,`align`,void 0),Q([k({reflect:!0})],y_.prototype,`size`,void 0),Q([k({attribute:!1})],y_.prototype,`scopeTokens`,void 0),Q([k({attribute:!1})],y_.prototype,`partToolbarContent`,void 0),Q([k({attribute:!1})],y_.prototype,`partToolbarRenderer`,void 0),Q([A()],y_.prototype,`contributions`,void 0),Q([A()],y_.prototype,`compact`,void 0),y_=Q([O(`docks-toolbar`)],y_);var b_=class extends sr{constructor(...e){super(...e),this.cmd=``,this.title=``,this.label=!1,this.disabled=!1,this.appearance=`plain`,this.variant=`neutral`,this.size=`small`,this.params={},this.withCaret=!0,this.placement=`bottom-start`,this.dropdownContributions=[]}closeDropdown(e){e&&e.open!==void 0&&(e.open=!1)}closeParentDropdown(){this.closeDropdown(this.closest(`wa-dropdown`))}handleClick(e){if(!this.disabled){if(e&&e.stopPropagation(),this.closeParentDropdown(),this.action){this.action(e);return}this.cmd&&this.executeCommand(this.cmd,this.params)}}handleSelect(e){this.closeDropdown(e.target)}isInDropdown(){return!!this.closest(`wa-dropdown, wa-dropdown-menu`)}getKeybinding(){if(!this.cmd||this.action)return null;let e=dg.getKeyBindingsForCommand(this.cmd);return e.length>0?e[0]:null}doBeforeUI(){this.dropdown&&(this.loadDropdownContributions(),o(Gn,e=>{this.dropdown&&e.target===this.dropdown&&(this.dropdownContributions=e.contributions,this.requestUpdate())}))}loadDropdownContributions(){this.dropdown&&(this.dropdownContributions=C.getContributions(this.dropdown),this.requestUpdate())}renderContribution(e){if(`command`in e){let t=e;if(!Kn(t))return x;let n=qn(t);return b`
            ...
            `}if(`component`in e){let t=e.component;return t instanceof Function?t():Sf(t)}return x}render(){let e=this.getKeybinding();return this.isInDropdown()?b`
                <wa-dropdown-item 
                    ...
                    ${g_(this.icon,{label:this.title,slot:`icon`})}
                    <slot></slot>
            ...
            `:this.dropdown?b`
                <wa-dropdown 
                    ...
                    <wa-button 
                        ...
                        ${g_(this.icon,{label:this.title,slot:`start`})}
                        <slot></slot>
    ...
    `}static finalizeStyles(t){let n=super.finalizeStyles(t);return[e.baseStyles,...n]}};Q([k()],C_.prototype,`dirty`,void 0),Q([k({attribute:!1})],C_.prototype,`tabContribution`,void 0),Q([k({type:Boolean,attribute:!1})],C_.prototype,`isEditor`,void 0);var w_,T_=class extends S_{static{w_=this}constructor(...e){super(...e),this.placement=`top`,this.iconOnly=!1,this.withToolbar=!1,this.hideTabs=!1,this.itemSize=`medium`,this.contributions=[],this.tabGroup=Ch(),this.containerId=null,this.tabGroupListenersAttached=!1}doBeforeUI(){if(this.containerId=this.getAttribute(`id`),!this.containerId)throw Error(`docks-tabs requires an 'id' attribute to function`);this.loadAndResolveContributions()}doInitUI(){this.updateComplete.then(()=>this.ensureTabGroupListenersAndActivate()),o(Gn,e=>{if(!this.containerId)return;let t=`${this.containerId}-toolbar`;e.target!==t&&e.target===this.containerId&&(this.loadAndResolveContributions(),this.requestUpdate(),this.updateComplete.then(()=>{this.activateNextAvailableTab()}))})}updated(e){super.updated(e),this.contributions.length>0&&this.tabGroup.value&&this.updateComplete.then(()=>this.ensureTabGroupListenersAndActivate()),e.has(`contributions`)&&(this.contributions.length===0&&(this.tabGroupListenersAttached=!1),this.contributions.forEach(e=>{let t=this.getTabPanel(e.name);if(!t)return;let n=this.getPartFromPanel(t);n&&(n.tabContribution=e)}))}has(e){return this.tabGroup.value?!!this.getTabPanel(e):!1}activate(e){if(!this.tabGroup.value)return;this.tabGroup.value.setAttribute(`active`,e);let t=this.getTabPanel(e);t&&this.syncActiveSignalsFromPanel(t)}getActiveEditor(){return this.tabGroup.value?this.tabGroup.value.getAttribute(`active`):null}open(e){if(this.contributions.find(t=>t.name===e.name)){this.activate(e.name);return}this.contributions.push(e),this.requestUpdate(),this.updateComplete.then(()=>{requestAnimationFrame(()=>{let t=this.getTabPanel(e.name);if(!t)return;let n=this.getPartFromPanel(t);n&&(n.tabContribution=e),this.activate(e.name)})})}handleTabAuxClick(e,t){e.button===Kh.MIDDLE&&t.closable&&this.closeTab(e,t.name)}async closeTab(e,t){e.stopPropagation(),await this.tryCloseTab(t,!0)}updateTabLabel(e,t){let n=this.contributions.find(t=>t.name===e);n&&(n.label=t,this.contributions=[...this.contributions],this.requestUpdate())}async closeAllTabs(){let e=[...this.contributions.map(e=>e.name)];for(let t of e)if(!await this.tryCloseTab(t,!0))return!1;return!0}async tryCloseTab(e,t){if(t&&this.isDirty(e)&&!await d_(`Unsaved changes will be lost: Do you really want to close?`))return!1;let n=this.getTabPanel(e);if(!n)return!0;let r=this.contributions.find(t=>t.name===e);if(!r)return!0;if(r.beforeClose&&!await r.beforeClose())return!1;this.cleanupTabInstance(n),this.clearActiveSignalsIfPartInPanel(n);let i=this.contributions.indexOf(r);return i>-1&&this.contributions.splice(i,1),this.requestUpdate(),this.updateComplete.then(()=>{this.activateNextAvailableTab()}),!0}markDirty(e,t){let n=this.getTab(e);n&&n.classList.toggle(`part-dirty`,t)}isDirty(e){let t=this.getTab(e);return!!t&&t.classList.contains(`part-dirty`)}loadAndResolveContributions(){this.containerId&&(this.contributions=C.getContributions(this.containerId),this.requestUpdate())}cleanupTabInstance(e){let t=this.getPartFromPanel(e);t&&`close`in t&&typeof t.close==`function`&&t.close()}ensureTabGroupListenersAndActivate(){if(!this.tabGroup.value||this.tabGroupListenersAttached)return;this.tabGroupListenersAttached=!0;let e=this.tabGroup.value;e.addEventListener(`wa-tab-show`,e=>{let t=this.getTabPanel(e.detail.name);t&&this.syncActiveSignalsFromPanel(t)}),e.addEventListener(`click`,e=>{let t=e.target,n=t.closest(`wa-tab`);if(n){let e=n.getAttribute(`panel`);if(e){let t=this.getTabPanel(e);t&&this.syncActiveSignalsFromPanel(t)}return}let r=t.closest(`wa-tab-panel`);r&&this.syncActiveSignalsFromPanel(r)}),this.dirtySignalCleanup?.(),this.dirtySignalCleanup=ar(Zn,e=>{if(!e)return;let t=e.closest(`wa-tab-panel`);if(!t)return;let n=t.getAttribute(`name`);n&&this.markDirty(n,e.isDirty())}),this.activateNextAvailableTab()}disconnectedCallback(){this.dirtySignalCleanup?.(),this.dirtySignalCleanup=void 0,super.disconnectedCallback()}activateNextAvailableTab(){if(!this.tabGroup.value)return;let e=this.tabGroup.value.querySelectorAll(`wa-tab`);if(e.length>0){let t=e.item(0).getAttribute(`panel`);t&&this.tabGroup.value.setAttribute(`active`,t)}else this.tabGroup.value.removeAttribute(`active`)}getTabPanel(e){return this.tabGroup.value?this.tabGroup.value.querySelector(`wa-tab-panel[name='${e}']`):null}getTab(e){return this.tabGroup.value?this.tabGroup.value.querySelector(`wa-tab[panel='${e}']`):null}syncActiveSignalsFromPanel(e){let t=this.getPartFromPanel(e);t instanceof C_&&(Yn.set(null),Yn.set(t),this.containerId===`editor-area-main`&&t.isEditor&&(Xn.set(null),Xn.set(t)))}clearActiveSignalsIfPartInPanel(e){let t=Array.from(e.querySelectorAll(`*`)).filter(e=>e instanceof C_);for(let e of t)Yn.get()===e&&Yn.set(null),Xn.get()===e&&Xn.set(null)}getPartFromPanel(e){let t=e.firstElementChild;return t instanceof C_?t:null}static{this.MAX_TAB_LABEL=16}truncateTabLabel(e){if(!e||e.length<=w_.MAX_TAB_LABEL)return e;let t=w_.MAX_TAB_LABEL-1,n=Math.floor(t/2);return e.slice(0,n)+`…`+e.slice(-(t-n))}withToolbarOrientation(){return this.placement===`start`||this.placement===`end`?`vertical`:`horizontal`}renderNavToolbar(e){return!this.withToolbar||!e?x:b`
            ...
            <docks-toolbar
                ...
                size=${this.itemSize}
            ></docks-toolbar>
        `}renderEmptyState(){let e=t_.getCurrentApp();return b`
    ...
    `}};Q([k({reflect:!0})],T_.prototype,`placement`,void 0),Q([k({type:Boolean,reflect:!0,attribute:`icon-only`})],T_.prototype,`iconOnly`,void 0),Q([k({type:Boolean,reflect:!0,attribute:`with-toolbar`})],T_.prototype,`withToolbar`,void 0),Q([k({type:Boolean,reflect:!0,attribute:`hide-tabs`})],T_.prototype,`hideTabs`,void 0),Q([k({reflect:!0,attribute:`item-size`})],T_.prototype,`itemSize`,void 0),Q([A()],T_.prototype,`contributions`,void 0),T_=w_=Q([O(`docks-tabs`)],T_);var E_,D_=class extends fg{static{E_=this}constructor(...e){super(...e),this.orientation=`horizontal`,this.gridSizes=[],this.gridChildren=[],this.resizing=null,this.resizeOverlay=null,this.childrenLoaded=!1,this.childStylesApplied=!1,this.settingsLoaded=!1,this.handleResize=e=>{if(!this.resizing)return;let t=(this.orientation===`horizontal`?e.clientX:e.clientY)-this.resizing.startPos,n=[...this.resizing.startSizes];n[this.resizing.handleIndex]+=t,n[this.resizing.handleIndex+1]-=t;let r=this.orientation===`horizontal`?this.offsetWidth:this.offsetHeight,i=r*.05;if(n[this.resizing.handleIndex]>=i&&n[this.resizing.handleIndex+1]>=i){this.resizing.currentSizes=n;let e=n.map((e,t)=>{let i=`${(e/r*100).toFixed(2)}%`;return t===n.length-1?i:`${i} ${E_.HANDLE_VISUAL_SIZE_PX}px`}).join(` `);this.orientation===`horizontal`?this.style.gridTemplateColumns=e:this.style.gridTemplateRows=e}},this.stopResize=async()=>{if(this.resizing?.currentSizes){let e=this.orientation===`horizontal`?this.offsetWidth:this.offsetHeight;this.gridSizes=this.resizing.currentSizes.map(t=>`${(t/e*100).toFixed(2)}%`),await this.saveSizes(),this.requestUpdate()}this.resizeOverlay&&=(document.body.removeChild(this.resizeOverlay),null),this.resizing=null,document.removeEventListener(`mousemove`,this.handleResize),document.removeEventListener(`mouseup`,this.stopResize),document.body.style.cursor=``,document.body.style.userSelect=``}}static{this.HANDLE_VISUAL_SIZE_PX=1}static{this.HANDLE_HITBOX_PADDING_PX=4}createRenderRoot(){return this}doBeforeUI(){this.childrenLoaded||(this.mutationObserver=new MutationObserver(()=>{this.childrenLoaded||this.loadChildren()}),this.mutationObserver.observe(this,{childList:!0,subtree:!1}),this.loadChildren())}async loadChildren(){let e=Array.from(this.children).filter(e=>e.tagName!==`STYLE`&&e.tagName!==`SCRIPT`&&!e.classList.contains(`resize-handle`));if(e.length!==0){if(this.childrenLoaded=!0,this.mutationObserver&&=(this.mutationObserver.disconnect(),void 0),this.gridChildren=e,!this.settingsLoaded){this.settingsLoaded=!0;let e=await this.getDialogSetting();if(e&&Array.isArray(e.sizes)&&e.sizes.length===this.gridChildren.length){this.gridSizes=e.sizes,this.requestUpdate();return}}if(this.sizes)this.gridSizes=this.sizes.split(`,`).map(e=>e.trim());else{let e=`${100/this.gridChildren.length}%`;this.gridSizes=this.gridChildren.map(()=>e)}this.requestUpdate()}}async saveSizes(){this.gridSizes.length!==0&&await this.setDialogSetting({sizes:this.gridSizes,orientation:this.orientation})}updated(e){super.updated(e),e.has(`gridChildren`)&&!this.childStylesApplied&&this.gridChildren.length>0&&(this.childStylesApplied=!0,this.gridChildren.forEach((e,t)=>{e.style.overflow=`hidden`,e.style.height=`100%`,e.style.width=`100%`,e.style.gridColumn=this.orientation===`horizontal`?`${t*2+1}`:`1`,e.style.gridRow=this.orientation===`vertical`?`${t*2+1}`:`1`,e.style.display=`flex`,e.style.flexDirection=`column`}))}startResize(e,t){if(e.preventDefault(),t>=this.gridChildren.length-1)return;let n=this.orientation===`horizontal`?e.clientX:e.clientY,r=this.orientation===`horizontal`?this.offsetWidth:this.offsetHeight;this.resizing={handleIndex:t,startPos:n,startSizes:this.gridSizes.map(e=>e.endsWith(`%`)?parseFloat(e)/100*r:(e.endsWith(`px`),parseFloat(e)))},this.resizeOverlay=document.createElement(`div`),this.resizeOverlay.style.position=`fixed`,this.resizeOverlay.style.top=`0`,this.resizeOverlay.style.left=`0`,this.resizeOverlay.style.width=`100%`,this.resizeOverlay.style.height=`100%`,this.resizeOverlay.style.zIndex=`9999`,this.resizeOverlay.style.cursor=this.orientation===`horizontal`?`col-resize`:`row-resize`,document.body.appendChild(this.resizeOverlay),document.addEventListener(`mousemove`,this.handleResize),document.addEventListener(`mouseup`,this.stopResize),document.body.style.cursor=this.orientation===`horizontal`?`col-resize`:`row-resize`,document.body.style.userSelect=`none`}render(){if(this.gridChildren.length===0||this.gridSizes.length===0)return x;let e=this.gridSizes.flatMap((e,t)=>t===this.gridSizes.length-1?[e]:[e,`${E_.HANDLE_VISUAL_SIZE_PX}px`]).join(` `);return this.style.display=`grid`,this.orientation===`horizontal`?(this.style.gridTemplateColumns=e,this.style.gridTemplateRows=`100%`):(this.style.gridTemplateColumns=`100%`,this.style.gridTemplateRows=e),this.style.overflow=`hidden`,b`
            <style>
                ...
                .resize-handle.horizontal::before {
                    right: -${E_.HANDLE_HITBOX_PADDING_PX}px;
                    left: -${E_.HANDLE_HITBOX_PADDING_PX}px;
                }

                .resize-handle.vertical::before {
                    top: -${E_.HANDLE_HITBOX_PADDING_PX}px;
                    bottom: -${E_.HANDLE_HITBOX_PADDING_PX}px;
                }
            ...
            ${this.gridChildren.map((e,t)=>{if(t<this.gridChildren.length-1){let e=this.orientation===`horizontal`?`${t*2+2}`:`1`,n=this.orientation===`vertical`?`${t*2+2}`:`1`;return b`
                        ...
                        ></div>
                    `}return x})}
        `}disconnectedCallback(){super.disconnectedCallback(),this.resizing&&this.stopResize(),this.mutationObserver&&=(this.mutationObserver.disconnect(),void 0)}connectedCallback(){super.connectedCallback(),this.style.height=`100%`,this.style.width=`100%`}};Q([k()],D_.prototype,`orientation`,void 0),Q([k()],D_.prototype,`sizes`,void 0),Q([A()],D_.prototype,`gridSizes`,void 0),Q([A()],D_.prototype,`gridChildren`,void 0),D_=E_=Q([O(`docks-resizable-grid`)],D_);var O_=class extends sr{constructor(...e){super(...e),this.message=`No content.`,this.icon=`info-circle`}render(){return b`
                ...
                <div class="tree-item-rows">
                    <div class="tree-item-label-row">
                        <span class="tree-label">
                            ${g_(o,{label:e.leaf?U_.FILE:U_.FOLDER})}
...
`);if(e.dataTransfer.setData(`text/plain`,s),e.dataTransfer.setData(`application/x-workspace-file`,s),e.dataTransfer.setData(`text/uri-list`,s),e.dataTransfer.setDragImage){let t=document.createElement(`div`);t.textContent=o,t.style.position=`absolute`,t.style.top=`-1000px`,t.style.padding=`4px 8px`,t.style.background=`var(--wa-color-neutral-10)`,t.style.border=`1px solid var(--wa-color-neutral-30)`,t.style.borderRadius=`4px`,document.body.appendChild(t),e.dataTransfer.setDragImage(t,0,0),setTimeout(()=>document.body.removeChild(t),0)}}async onLazyLoad(e,t){let n=t.data;n instanceof g&&t.children.length===0&&await this.loadNodeChildren(t,n)}async loadNodeChildren(e,t){if(this.loadingNodes.has(e))return;let n=this.treeBuildGeneration;this.loadingNodes.add(e);try{let r=await t.listChildren(!1);if(n!==this.treeBuildGeneration)return;for(let t of r){let r=await this.resourceToTreeNode(t,!1);if(n!==this.treeBuildGeneration)return;e.children.push(r)}e.children.sort(B_),e.loaded=!0,this.requestUpdate()}catch(r){if(n!==this.treeBuildGeneration)return;if(!await u.isResourceInCurrentWorkspace(t)){e.loaded=!0,this.requestUpdate();return}e.loadError=r instanceof Error?r.message:String(r),H_.error(`Failed to load directory children:`,r),this.requestUpdate()}finally{this.loadingNodes.delete(e)}}async onFileDoubleClicked(e){let t=e.currentTarget,n=t.model;if(!n)return;let r=n.data;if(r instanceof f){$n.set(r),this.executeCommand(`open_editor`,{});return}!n.leaf&&`expanded`in t&&(t.expanded=!t.expanded)}onSelectionChanged(e){let t=e.detail.selection;if(t&&t.length>0){let e=t[0].model.data;$n.set(e);let n=e?.getWorkspacePath?.();typeof n==`string`?this.persistSelectedPath(n):this.persistSelectedPath(null),e instanceof f?this.fileEditorOptions=z_.getEditorOptionsForInput(e):this.fileEditorOptions=[]}else $n.set(void 0),this.persistSelectedPath(null),this.fileEditorOptions=[]}getDirectoryDropTargetFromEvent(e){if(!this.workspaceDir)return;let t=e.target.closest(`wa-tree-item`);if(!t){let e=this.root?.children??[];if(e.length!==1)return;let t=e[0]?.data;return t instanceof g?t:void 0}let n=t.model?.data;if(n instanceof g)return n}setupDragAndDrop(){let e=this.treeRef.value;if(!e)return;let t=t=>{let n=t.dataTransfer?.types;if(!n)return;let r=n.includes(`Files`),i=n.includes(`application/x-workspace-file`);if(!r&&!i)return;if(!this.getDirectoryDropTargetFromEvent(t)){this.currentDropTarget?.classList.remove(`drop-target`),this.currentDropTarget=void 0,e.classList.remove(`drag-over`);return}t.preventDefault(),t.dataTransfer&&(i?t.dataTransfer.dropEffect=t.ctrlKey||t.metaKey?`copy`:`move`:t.dataTransfer.dropEffect=`copy`),e.classList.add(`drag-over`);let a=t.target.closest(`wa-tree-item`);if(!a){this.currentDropTarget?.classList.remove(`drop-target`),this.currentDropTarget=void 0;return}a!==this.currentDropTarget&&(this.currentDropTarget?.classList.remove(`drop-target`),this.currentDropTarget=a,a.classList.add(`drop-target`))},n=t=>{let n=t.dataTransfer?.types;if(!n)return;let r=n.includes(`Files`),i=n.includes(`application/x-workspace-file`);!r&&!i||this.getDirectoryDropTargetFromEvent(t)&&(t.preventDefault(),e.classList.add(`drag-over`))},r=t=>{let n=e.getBoundingClientRect(),r=t.clientX,i=t.clientY;(r<=n.left||r>=n.right||i<=n.top||i>=n.bottom)&&(e.classList.remove(`drag-over`),this.currentDropTarget?.classList.remove(`drop-target`),this.currentDropTarget=void 0)},i=async t=>{if(t.preventDefault(),e.classList.remove(`drag-over`),this.currentDropTarget?.classList.remove(`drop-target`),this.currentDropTarget=void 0,!t.dataTransfer||!this.workspaceDir)return;let n=this.getDirectoryDropTargetFromEvent(t);if(!n)return;let r=t.dataTransfer.types;if(r.includes(`Files`)){let e=Array.from(t.dataTransfer.files);if(e.length===0)return;await this.handleFilesDrop(e,n);return}if(r.includes(`application/x-workspace-file`)){await this.handleWorkspaceDrop(t,n);return}};e.removeEventListener(`dragover`,t),e.removeEventListener(`dragenter`,n),e.removeEventListener(`dragleave`,r),e.removeEventListener(`drop`,i),e.addEventListener(`dragover`,t),e.addEventListener(`dragenter`,n),e.addEventListener(`dragleave`,r),e.addEventListener(`drop`,i)}async handleWorkspaceDrop(e,t){if(!e.dataTransfer)return;let n=e.dataTransfer.getData(`application/x-workspace-file`);if(!n)return;let r=n.split(/\r?\n/).map(e=>e.trim()).filter(e=>!!e);if(r.length===0)return;let i=await u.getWorkspace();if(!i){H_.warn(`Workspace drop ignored because no workspace is connected`);return}let a=async n=>{let r=n.getWorkspace(),i=t.getWorkspace();return!r||!i?!1:r===i&&!(e.ctrlKey||e.metaKey)},o=new Set,s=t.getWorkspace(),c=0,l=0,d=[];for(let e of r)try{let t=await i.getResource(e);if(!t){H_.warn(`Workspace drop: source not found for path "${e}"`),l++;continue}d.push({path:e,resource:t});let n=t.getWorkspace();n&&o.add(n)}catch(t){H_.error(`Failed to handle workspace drop for "${e}":`,t),l++}if(d.length===0){l>0&&H_.info(`Workspace drop failed for ${l} item(s)`);return}let f=!1;if(s){for(let e of o)if(e!==s){f=!0;break}}if(f&&s)try{let e=Array.from(o),t=await u.getFolderInfoForDirectory(e[0]),n=await u.getFolderInfoForDirectory(s),r=t?.backendName??U_.UNKNOWN_BACKEND,i=n?.backendName??U_.UNKNOWN_BACKEND;if(!await d_(U_.DND_CROSS_CONNECTION_CONFIRM({count:String(d.length),srcBackend:r,destBackend:i})))return}catch(e){H_.debug(`Failed to resolve cross-connection info for DnD`,e)}for(let{path:e,resource:n}of d)try{let e=await a(n);await u.copyResource(n,t,{move:e}),c++}catch(t){H_.error(`Failed to handle workspace drop for "${e}":`,t),l++}H_.info(`Workspace drop completed: ${c}/${d.length} items ${l>0?`, ${l} failed`:``}`),await this.loadWorkspace(this.workspaceDir,!0)}async handleFilesDrop(e,t){let n=e.length,r=0,i=0,a=0;for(let n of e)try{let e=this.buildTargetPath(t,n.name);if(await this.workspaceDir.getResource(e)&&!await d_(U_.FILE_EXISTS_OVERWRITE({fileName:n.name}))){a++;continue}await(await this.workspaceDir.getResource(e,{create:!0})).saveContents(n),r++}catch(e){H_.error(`Failed to upload ${n.name}:`,e),i++}H_.info(`Uploaded ${r}/${n} files${a>0?`, ${a} skipped`:``}${i>0?`, ${i} failed`:``}`),await this.loadWorkspace(this.workspaceDir)}buildTargetPath(e,t){let n=e.getWorkspacePath();return n?`${n}/${t}`:t}renderContent(){return b`
    ...
    `}};Q([A()],G_.prototype,`root`,void 0),Q([A()],G_.prototype,`fileEditorOptions`,void 0),G_=V_=Q([O(`docks-filebrowser`)],G_);var K_=`view.filebrowser`,q_=`view.logTerminal`,J_=`toolbar.info`,Y_=`toolbar.fastViews`,X_=`toolbar.languageSelector`,Z_=`toolbar.layoutSwitcher`,Q_=`toolbar.themeSwitcher`,$_=`toolbar.fullscreen`,ev=`toolbar.activePartName`,tv=`toolbar.tasks`,nv=`sidebar.toolbar.extensions`,rv=await R_(Object.assign({"./tasks.de.json":()=>v(()=>import(`./tasks.de-y2xPmQ1k-yWSBoRN-.js`),[]),"./tasks.en.json":()=>v(()=>import(`./tasks.en-BTbFrxJj-DYpTBWIM.js`),[])}));C.registerContribution(Fh,{name:tv,label:`Active Tasks`,component:`<docks-tasks></docks-tasks>`});var iv=null;function av(){return iv||(iv=document.createElement(`div`),iv.id=`progress-dialog-container`,document.body.appendChild(iv)),iv}function ov(){return av().querySelector(`wa-dialog`)}function sv(){cv(!0)}function cv(e=!1){let t=av(),n=Qh.getActiveTasks();if(n.length===0){ct(b``,t);return}let r=ov();(e||r?.open===!0)&&ct(b`
        <wa-dialog 
            label="${rv.ACTIVE_TASKS}" 
            open
            light-dismiss
            style="--width: 600px;"
            @wa-request-close=${()=>{let e=ov();e&&(e.open=!1)}}
    ...
    `,t)}var lv=class extends fg{static{this.styles=y`
        :host {
            display: flex;
            align-items: center;
        }
    ...
    `}doBeforeUI(){this.watch(Qn,()=>{cv(),this.requestUpdate()})}handleIndicatorClick(){sv()}render(){Qn.get();let e=Qh.getActiveTasks().length;return e===0?b``:b`
            <div class="tasindicator" @click=${this.handleIndicatorClick} title="${rv.ACTIVE_TASKS_TITLE({taskCount:e.toString()})}">
                <wa-spinner
            ...
            <wa-split-panel position="30" class="extensions-split-panel">
                        ...
                        <wa-tree 
                                    ...
                                    <wa-tree-item expanded>
                                        ...
                                        ${e.enabled.map(e=>{let t=this.isExternalExtension(e);return b`
                                                <wa-tree-item @dblclick=${this.nobubble(this.onExtensionDblClick)} .model=${e}>
                                                    <span>${g_(e.icon)}</span> ${e.name}${t?b` <span style="opacity: 0.6; font-size: 0.9em; margin-left: 0.5rem;">(External)</span>`:``}
                                                </wa-tree-item>
                                            `})}
                                    </wa-tree-item>
                                `:``}
                                ${e.available.length>0?b`
                                    <wa-tree-item expanded>
                                        <span>
                                            ...
                                            ${yv.AVAILABLE} (${e.available.length})
                                        </span>
                            ...
                            ${t?``:b`
                                <div style="padding: 1em; text-align: center; opacity: 0.7;">
                                    ${yv.NO_MATCHES({filterText:this.filterText})}
                                </div>
                            `}
                        </wa-tree>
                    </wa-scroller>
                ...
                <div class="extensions-detail-content">
                    ${kp(this.selectedExtension,e=>{let t=this.isExternalExtension(e),n=ig.isEnabled(e.id);return b`
                                <h1>${g_(e.icon)} ${e.name}${t?` (External)`:``}</h1>
                                ${kp(t,()=>b`
                                    <div class="marketplace-badge">
                                        <wa-icon name="store"></wa-icon>
                                        <span>${yv.EXTERNAL_EXTENSION}</span>
                                    </div>
                                `)}
                                <hr>
                                <div>
                                    ${kp(n,()=>b`
                                        <wa-button 
                                            title="${this.isExtensionRequired(e.id)?yv.REQUIRED_HINT:yv.DISABLE_TITLE}" 
                                            @click="${()=>this.disable(e)}"
                                            variant="danger" 
                                            appearance="plain"
                                            ?disabled=${this.isExtensionRequired(e.id)}>
                                            <wa-icon name="xmark" label="Uninstall"></wa-icon>&nbsp;${yv.UNINSTALL}
                                        </wa-button>
                                        ${kp(this.isExtensionRequired(e.id),()=>b`
                                            <div class="required-hint">
                                                <wa-icon name="info-circle" style="color: var(--wa-color-primary-50);"></wa-icon>
                                                <span>${yv.REQUIRED_HINT}</span>
                                            </div>
                                        `)}
                                    `,()=>b`
                                        <wa-button 
                                            title="${yv.ENABLE_TITLE}" 
                                            @click="${()=>this.enable(e)}"
                                            variant="brand" 
                                            appearance="plain">
                                            <wa-icon name="download" label="Install"></wa-icon>&nbsp;${yv.INSTALL}
                                        </wa-button>
                                    `)}
                                </div>
                                ...
                                ${kp(e.experimental,()=>b`
                                    <div style="margin-top: 1em;">
                                        ...
                                        <small><i>${yv.EXPERIMENTAL}</i></small>
                                    </div>
                                `)}
                                    ...
                                    <div style="margin-top: 1em; display: flex; flex-direction: column; gap: 0.5rem;">
                                        ${kp(e.version,()=>b`
                                            <div style="display: flex; align-items: center; gap: 0.5rem;">
                                                ...
                                                <span style="font-size: 0.9em; opacity: 0.8;">${yv.VERSION} <strong>${e.version}</strong></span>
                                            </div>
                                        `)}
                                        ${kp(e.author,()=>b`
                                            <div style="display: flex; align-items: center; gap: 0.5rem;">
                                                <wa-icon name="user" style="font-size: 0.9em; opacity: 0.7;"></wa-icon>
                                                <span style="font-size: 0.9em; opacity: 0.8;">${yv.AUTHOR} <strong>${e.author}</strong></span>
                                            </div>
                                        `)}
                                    </div>
                                `)}
                                        ...
                                        <div class="dependencies-list">
                                            ${e.dependencies.map(e=>{let t=ig.getExtensions().find(t=>t.id===e),n=ig.isEnabled(e);return b`
                                                    <div class="dependency-item">
                                                        ...
                                                        ${g_(t?.icon??`puzzle-piece`)}
                                                        <span>${t?.name||e}</span>
                                                        ${n?``:b`
                                                            <span class="dependency-badge">${yv.NOT_INSTALLED}</span>
                                                        `}
                                                    </div>
                                                `})}
                                        </div>
    ...
    `}};Q([A()],bv.prototype,`selectedExtension`,void 0),Q([A()],bv.prototype,`filterText`,void 0),Q([A()],bv.prototype,`showRegisterDialog`,void 0),Q([A()],bv.prototype,`registerExtensionData`,void 0),bv=Q([O(`docks-extensions`)],bv);var xv=await R_(Object.assign({"./logterminal.de.json":()=>v(()=>import(`./logterminal.de-DKp940Ox-D7O6oLMQ.js`),[]),"./logterminal.en.json":()=>v(()=>import(`./logterminal.en-Ci2nm0b2-BGakKSmc.js`),[])})),Sv=class extends C_{constructor(...e){super(...e),this.messages=[],this.autoScroll=!0,this.filter=`all`,this.containerRef=Ch()}connectedCallback(){super.connectedCallback(),this.loadSettings(),l(this.log.bind(this))}disconnectedCallback(){super.disconnectedCallback(),te()}log(e,t,n=`info`){let r={timestamp:new Date,level:n,source:e,message:t};this.messages=[...this.messages,r],this.autoScroll&&this.updateComplete.then(()=>{let e=this.containerRef.value;e&&(e.scrollTop=e.scrollHeight)})}clear(){this.messages=[]}getFilteredMessages(){return this.filter===`all`?this.messages:this.messages.filter(e=>e.level===this.filter)}formatTimestamp(e){return e.toLocaleTimeString(`en-US`,{hour12:!1,hour:`2-digit`,minute:`2-digit`,second:`2-digit`})}getLevelIcon(e){switch(e){case`info`:return`circle-info`;case`warning`:return`triangle-exclamation`;case`error`:return`circle-xmark`;case`debug`:return`bug`}}getLevelColor(e){switch(e){case`info`:return`var(--wa-color-primary-text, #0066cc)`;case`warning`:return`var(--wa-color-warning-text, #ff9800)`;case`error`:return`var(--wa-color-danger-text, #dc3545)`;case`debug`:return`var(--wa-color-neutral-text-subtle, #6c757d)`}}renderToolbar(){let e=this.messages.filter(e=>e.level===`info`).length,t=this.messages.filter(e=>e.level===`warning`).length,n=this.messages.filter(e=>e.level===`error`).length,r=this.messages.filter(e=>e.level===`debug`).length;return b`
            ...
            <docks-command 
                icon="arrow-down" 
                title="${this.autoScroll?xv.AUTO_SCROLL_ENABLED:xv.AUTO_SCROLL_DISABLED}"
                ...
                ${this.autoScroll?xv.AUTO_SCROLL:xv.MANUAL}
            </docks-command>
        ...
        `}renderContent(){let e=this.getFilteredMessages();return b`
            <div class="log-terminal">
                <div class="messages" ${Eh(this.containerRef)}>
                    ${e.length===0?b`<div class="empty-state">${xv.NO_LOG_MESSAGES}</div>`:e.map(e=>b`
    ...
    `}async loadSettings(){let e=await this.getDialogSetting();e&&(typeof e.filter==`string`&&(e.filter===`all`||[`info`,`warning`,`error`,`debug`].includes(e.filter))&&(this.filter=e.filter),typeof e.autoScroll==`boolean`&&(this.autoScroll=e.autoScroll))}async saveSettings(){await this.setDialogSetting({filter:this.filter,autoScroll:this.autoScroll})}};Q([A()],Sv.prototype,`messages`,void 0),Q([A()],Sv.prototype,`autoScroll`,void 0),Q([A()],Sv.prototype,`filter`,void 0),Sv=Q([O(`docks-log-terminal`)],Sv);var Cv=await R_(Object.assign({"./fastviews.de.json":()=>v(()=>import(`./fastviews.de-BFxFslBz-D93r-wVf.js`),[]),"./fastviews.en.json":()=>v(()=>import(`./fastviews.en-Cb4J_JXL-BB7AqsOS.js`),[])})),wv=class extends sr{constructor(...e){super(...e),this.target=``,this.title=``,this.disabled=!1,this.appearance=`plain`,this.size=`small`,this.placement=`bottom-start`,this.tabContributions=[],this.drawerOpen=!1,this.drawerSize=`50vw`,this.drawerRef=Ch(),this.tabsRef=Ch(),this.resizeHandleRef=Ch(),this.resizing=null}getDrawerTabsId(){return`fastviews-drawer-tabs-${this.target}`}handleTabClick(e){if(!this.disabled)if(this.containerId){let t=document.querySelector(`docks-tabs#${this.containerId}`);if(!t){console.error(`fastviews: Tab container with id "${this.containerId}" not found`);return}t.open(e)}else this.drawerOpen=!0,this.updateComplete.then(()=>{let t=this.tabsRef.value;t&&t.open(e)})}handleDrawerHide(){this.drawerOpen=!1}startResize(e){e.preventDefault(),e.stopPropagation();let t=this.drawerRef.value;if(!t)return;let n=(()=>{let e=t.shadowRoot?.querySelector(`[part="panel"]`);if(e&&e.offsetWidth>0)return e.offsetWidth;let n=(window.getComputedStyle(t).getPropertyValue(`--size`)||this.drawerSize).match(/^(\d+(?:\.\d+)?)(px|vw|vh|%)$/);if(n){let e=parseFloat(n[1]),t=n[2];if(t===`px`)return e;if(t===`vw`)return e/100*window.innerWidth;if(t===`vh`)return e/100*window.innerHeight;if(t===`%`)return e/100*window.innerWidth}return 0})();n===0&&(n=window.innerWidth*.5);let r=e=>{this.resizing&&(e.preventDefault(),e.stopPropagation(),this.resizing.rafId!==null&&cancelAnimationFrame(this.resizing.rafId),this.resizing.rafId=requestAnimationFrame(()=>{if(!this.resizing)return;let t=this.resizing.startX-e.clientX,n=Math.round(this.resizing.startSize+t),r=Math.round(window.innerWidth*.9);if(n>=200&&n<=r){this.drawerSize=`${n}px`;let e=this.drawerRef.value;e&&(e.style.setProperty(`--size`,this.drawerSize),e.style.setProperty(`transition`,`none`))}this.resizing.rafId=null}))},i=()=>{if(this.resizing){this.resizing.rafId!==null&&(cancelAnimationFrame(this.resizing.rafId),this.resizing.rafId=null),document.removeEventListener(`mousemove`,this.resizing.handleMouseMove),document.removeEventListener(`mouseup`,this.resizing.handleMouseUp),document.body.style.cursor=``,document.body.style.userSelect=``;let e=this.drawerRef.value;e&&e.style.removeProperty(`transition`),this.resizing=null}};this.resizing={startX:e.clientX,startSize:n,handleMouseMove:r,handleMouseUp:i,rafId:null},document.addEventListener(`mousemove`,r,{passive:!1}),document.addEventListener(`mouseup`,i,{passive:!1}),document.body.style.cursor=`col-resize`,document.body.style.userSelect=`none`}doBeforeUI(){this.target&&(this.loadTabContributions(),o(Gn,e=>{this.target&&e.target===this.target&&this.loadTabContributions()}))}loadTabContributions(){this.target&&(this.tabContributions=C.getContributions(this.target).filter(e=>`name`in e),this.requestUpdate())}renderTabContribution(e){return b`
        ...
        `}render(){return!this.target||this.tabContributions.length===0?x:b`
            ...
            ${this.containerId?x:b`
                <wa-drawer 
                    ${Eh(this.drawerRef)}
                    label="${this.title||Cv.FAST_VIEWS}"
                    placement="end"
    ...
    `}};Q([k()],wv.prototype,`target`,void 0),Q([k()],wv.prototype,`title`,void 0),Q([k()],wv.prototype,`icon`,void 0),Q([k({type:Boolean})],wv.prototype,`disabled`,void 0),Q([k()],wv.prototype,`appearance`,void 0),Q([k()],wv.prototype,`size`,void 0),Q([k()],wv.prototype,`placement`,void 0),Q([k()],wv.prototype,`containerId`,void 0),Q([A()],wv.prototype,`tabContributions`,void 0),Q([A()],wv.prototype,`drawerOpen`,void 0),Q([A()],wv.prototype,`drawerSize`,void 0),wv=Q([O(`docks-fastviews`)],wv);function Tv(){let e=document.getElementById(`global-dialog-container`);return e||(e=document.createElement(`div`),e.id=`global-dialog-container`,document.body.appendChild(e)),e}var Ev=e=>{try{return new Intl.DisplayNames([e],{type:`language`}).of(e)||e.toUpperCase()}catch{return e.toUpperCase()}},Dv=()=>[...M_.get()].sort(),Ov=async()=>{let e=Dv(),t=I_.get();return new Promise(n=>{let r=Tv(),i=!1,a=()=>{let e=r.querySelector(`wa-dialog`);e&&!i&&(e.open=!1)},o=()=>{i||(i=!0,ct(b``,r),n())},s=async e=>{await Zh.set(k_,e),a()};ct(b`
            <wa-dialog 
                ...
                <div class="language-list">
                    ${e.map(e=>b`
                        <div 
                            ...
                            <span class="language-name">${Ev(e)}</span>
                        </div>
                    `)}
                </div>
            </wa-dialog>
        `,r)})},kv=class extends fg{static{this.styles=y`
        :host {
            display: inline-block;
        }
    `}render(){let e=I_.get(),t=Ev(e),n=`${t} ${e.toUpperCase()}`;return b`
            <wa-button 
                appearance="plain" 
                size="small"
            ...
            <wa-dropdown
                ...
                ${e.map(e=>b`
                        <wa-dropdown-item
                            ...
                            ${g_(e.icon,{label:e.name,slot:`icon`})}
                            ${e.name}
                        </wa-dropdown-item>
                    `)}
            </wa-dropdown>
    ...
    `}};Q([A()],Av.prototype,`currentLayoutId`,void 0),Av=Q([O(`docks-layout-switcher`)],Av),C.registerContribution(Vh,{name:K_,label:`Workspace`,icon:`folder`,component:e=>b`<docks-filebrowser id="${e}"></docks-filebrowser>`}),C.registerContribution(Wh,{name:q_,label:`Log Messages`,icon:`list`,component:e=>b`<docks-log-terminal id="${e}"></docks-log-terminal>`}),C.registerContribution(Ih,{name:J_,label:`Info`,icon:`circle-info`,command:`show_version_info`,showLabel:!0}),C.registerContribution(Ih,{name:Y_,label:`Fast Views`,component:`<docks-fastviews target="system.fastviews-bottomend" icon="bolt" title="Fast Views"></docks-fastviews>`}),C.registerContribution(Ih,{name:X_,label:`Language`,component:()=>b`<docks-language-selector></docks-language-selector>`}),C.registerContribution(Mh,{name:Z_,label:`Layout Switcher`,component:()=>b`<docks-layout-switcher></docks-layout-switcher>`}),C.registerContribution(Lh,{name:nv,command:`open_extensions`,icon:`docks extensions`,label:`Extensions`});var jv=class extends S_{constructor(...e){super(...e),this.showBottomSidebar=!1,this.showBottomPanel=!1,this.showLeftSidebar=!0,this.showAuxSidebar=!0}createRenderRoot(){return this}getGridSizes(){return this.showLeftSidebar&&this.showAuxSidebar?`20%, 60%, 20%`:this.showLeftSidebar?`20%, 80%`:this.showAuxSidebar?`80%, 20%`:`100%`}render(){return b`
            <style>
                *, *::before, *::after {
                    box-sizing: border-box;
                }
                ...
                ${this.showLeftSidebar?b`
                        ${this.showBottomSidebar?b`
                                <docks-resizable-grid 
                                    ...
                                    sizes="50%, 50%">
                                    <docks-tabs id="${Vh}" placement="start" icon-only with-toolbar item-size="large"></docks-tabs>
                                    <docks-tabs id="${Hh}"  placement="start" icon-only></docks-tabs>
                                </docks-resizable-grid>
                            `:b`<docks-tabs id="${Vh}" placement="start" icon-only with-toolbar item-size="large"></docks-tabs>`}
                    `:x}
        ...
        `}};Q([k({type:Boolean,attribute:`show-bottom-sidebar`})],jv.prototype,`showBottomSidebar`,void 0),Q([k({type:Boolean,attribute:`show-bottom-panel`})],jv.prototype,`showBottomPanel`,void 0),Q([k({type:Boolean,attribute:`show-left-sidebar`})],jv.prototype,`showLeftSidebar`,void 0),Q([k({type:Boolean,attribute:`show-aux-sidebar`})],jv.prototype,`showAuxSidebar`,void 0),jv=Q([O(`docks-standard-layout`)],jv);for(let e of[{id:`standard`,name:`Standard`,label:`Standard`,icon:`docks layout-standard`,component:`docks-standard-layout`},{id:`standard-bottom-panel`,name:`Standard (bottom panel)`,label:`Standard (bottom panel)`,icon:`docks layout-standard-bottom-panel`,component:{tag:`docks-standard-layout`,attributes:{"show-bottom-panel":`true`}}},{id:`standard-bottom-sidebar`,name:`Standard (bottom sidebar)`,label:`Standard (bottom sidebar)`,icon:`docks layout-standard-bottom-sidebar`,component:{tag:`docks-standard-layout`,attributes:{"show-bottom-sidebar":`true`}}},{id:`standard-full`,name:`Standard (panel + sidebar)`,label:`Standard (panel + sidebar)`,icon:`docks layout-standard-full`,component:{tag:`docks-standard-layout`,attributes:{"show-bottom-panel":`true`,"show-bottom-sidebar":`true`}}}])C.registerContribution(zh,e);async function Mv(e,t=!0){let n=await u.getWorkspace();if(!n)return null;let r=e?.path;return t&&!r?null:{workspace:n,path:r||``}}function Nv(e){return e&&typeof e.getContent==`function`&&typeof e.getSelection==`function`&&typeof e.getSnippet==`function`&&typeof e.getLanguage==`function`&&typeof e.getFilePath==`function`}function Pv(e=!1){let t={filePath:null,language:null};return e?{...t,snippet:null,cursorLine:null}:t}async function Fv(e,t=!0){let n=await Mv(e,t);if(!n)return null;let{workspace:r,path:i}=n;if(!i)return null;try{let e=await r.getResource(i);return!e||!(e instanceof f)?null:{workspace:r,path:i,file:e}}catch{return null}}w({command:{id:`disconnect_folder`,name:`Disconnect folder`,description:`Disconnects a folder from the workspace`},handler:{execute:async()=>{let e=$n.get();if(!(e instanceof g&&e.getParent()===void 0)){S(`Select a folder root to disconnect.`);return}try{let t=await u.getFolderInfoForDirectory(e);if(t?.type===`indexeddb`){if(!await d_(`Also delete "${t.name}" from browser storage?\n\nIf not deleted, the folder data and blobs remain in IndexedDB.`))return;await Kg(e),Hn(`Deleted IndexedDB data for ${t.name}.`)}await u.disconnectFolder(e)}catch(e){S(e.message)}}},contribution:{target:`contextmenu:view.filebrowser`,label:`Disconnect folder`,icon:`folder-minus`,disabled:()=>{let e=$n.get();return!(e instanceof g&&e.getParent()===void 0)}}}),w({command:{id:`load_workspace`,name:`Local Folder`,description:`Connect to a local folder using File System Access API`,parameters:[]},handler:{execute:async e=>{await window.showDirectoryPicker({mode:`readwrite`}).then(e=>u.connectWorkspace(e)).catch(e=>{S(e.message)})}},contribution:{target:`filebrowser.connections`,label:`Local Folder`,icon:`folder-open`}}),w({command:{id:`connect_opfs`,name:`OPFS`,description:`Connect to Origin Private File System (browser storage)`,parameters:[]},handler:{execute:async()=>{try{await u.connectFolder({opfs:!0})}catch(e){S(e.message)}}},contribution:{target:`filebrowser.connections`,label:`OPFS (Browser Storage)`,icon:`database`}}),w({command:{id:`connect_indexeddb`,name:`IndexedDB`,description:`Connect to IndexedDB-backed workspace (browser storage)`,parameters:[{name:`name`,description:`Optional display name for this IndexedDB workspace root`,required:!1}]},handler:{execute:async e=>{let t=e.params?.name;try{await u.connectFolder({indexeddb:!0,name:t})}catch(e){S(e.message)}}},contribution:{target:`filebrowser.connections`,label:`IndexedDB (Browser Storage)`,icon:`database`}}),w({command:{id:`refresh_resource`,name:`Refresh resource`,description:`Refreshes the connected folder of the selected resource, or the whole workspace if nothing is selected`,parameters:[]},handler:{execute:async()=>{let e=$n.get();if(e){e.getWorkspace().touch();return}let t=await u.getWorkspace();if(!t){S(`No workspace selected.`);return}t.touch()}}}),w({command:{id:`open_editor`,name:`Open editor`,description:`Opens a file in an editor`,parameters:[{name:`path`,description:`The path of the file to open within the workspace; if omitted, the active selection is opened`,required:!1},{name:`editorId`,description:`Open with this editor id; if omitted, use default editor`,required:!1}]},handler:{execute:async e=>{let t=e.params?.path,n=e.params?.editorId,r=null;if(t)r=(await Fv({path:t}))?.file??null;else{let e=$n.get();r=e instanceof f?e:null}r&&await z_.loadEditor(r,n)}}}),w({command:{id:`get_active_editor_content`,name:`Get active editor content`,description:`Gets the complete contents of the currently active editor. Returns null if no editor is active or if the editor is not a code editor.`,parameters:[],output:[{name:`content`,description:`the complete contents of the active editor, or null if no editor is active`},{name:`filePath`,description:`the workspace path of the file in the active editor, or null if no editor is active`},{name:`language`,description:`the programming language of the active editor, or null if no editor is active`}]},handler:{execute:async e=>{let t=e.activeEditor;if(!Nv(t))return{...Pv(),content:null};try{return{content:t.getContent(),filePath:t.getFilePath(),language:t.getLanguage()}}catch{return{...Pv(),content:null}}}}}),w({command:{id:`get_active_editor_selection`,name:`Get active editor selection`,description:`Gets the currently selected text in the active editor. Returns null if no editor is active, no selection exists, or if the editor is not a code editor.`,parameters:[],output:[{name:`selection`,description:`the selected text in the active editor, or null if no selection exists or no editor is active`},{name:`filePath`,description:`the workspace path of the file in the active editor, or null if no editor is active`},{name:`language`,description:`the programming language of the active editor, or null if no editor is active`}]},handler:{execute:async e=>{let t=e.activeEditor;if(!Nv(t))return{...Pv(),selection:null};try{return{selection:t.getSelection(),filePath:t.getFilePath(),language:t.getLanguage()}}catch{return{...Pv(),selection:null}}}}}),w({command:{id:`get_active_editor_snippet`,name:`Get active editor snippet around cursor`,description:`Gets a code snippet from the active editor with n lines before and n lines after the cursor position. Useful for getting context around the cursor without loading the entire file.`,parameters:[{name:`lines`,description:`number of lines to include before and after the cursor position (default: 5)`,type:`number`,required:!1}],output:[{name:`snippet`,description:`the code snippet with n lines before and after the cursor, or null if no editor is active`},{name:`filePath`,description:`the workspace path of the file in the active editor, or null if no editor is active`},{name:`language`,description:`the programming language of the active editor, or null if no editor is active`},{name:`cursorLine`,description:`the line number where the cursor is positioned (1-based), or null if no editor is active`}]},handler:{execute:async e=>{let t=e.activeEditor;if(!Nv(t))return Pv(!0);try{let n=e.params?.lines?parseInt(e.params.lines,10):5;if(isNaN(n)||n<0)return Pv(!0);let r=t.getSnippet(n);return r?{snippet:r.snippet,filePath:t.getFilePath(),language:t.getLanguage(),cursorLine:r.cursorLine}:Pv(!0)}catch{return Pv(!0)}}}});function Iv(e,t){return e.replace(/^v/i,``)===t.replace(/^v/i,``)}w({command:{id:`show_version_info`,name:`Show Version Info`,description:`Shows application version information`,parameters:[]},handler:{execute:async e=>{let t=t_.getCurrentApp();if(!t){S(`No app loaded`);return}let n=t.dependencies??{},r=Object.keys(n).length>0,i=r?b`
...
`)}return t.body&&(r+=`---\n\n${t.body}`),r},h=()=>{s()},ee=()=>{s()},g=e=>{let n=m(e),a=l.length>0;ct(b`
                ...
                `,o())};return g(f),new Promise(e=>{let t=()=>{a?.querySelector(`wa-dialog[open]`)?setTimeout(t,100):e()};t()})}}}),w({command:{id:`save`,name:`Save editor`,description:`Saves the active/focused editor`,keyBinding:`CTRL+S`,parameters:[]},handler:{execute:async e=>{let t=Yn.get();t&&t.isDirty()&&t.save()}},contribution:{target:`toolbar:.system.editors`,icon:`floppy-disk`,label:`Save active editor`,slot:`start`,disabled:()=>{let e=Yn.get();return!e||!e.isDirty()}}});var Lv=`theme`;async function Rv(e){let t=document.documentElement;t.classList.remove(`wa-dark`,`wa-light`),t.classList.add(e)}async function zv(){await Rv(await Zh.get(Lv)||`wa-dark`)}async function Bv(e){await Zh.set(Lv,e)}w({command:{id:`switch_theme`,name:`Switch theme`,description:`Switches between dark and light theme`,parameters:[]},handler:{execute:async e=>{let t=document.documentElement.classList.contains(`wa-dark`)?`wa-light`:`wa-dark`;await Rv(t),await Bv(t)}},contribution:{target:Mh,name:Q_,icon:`circle-half-stroke`,label:`Theme Switcher`}}),zv().catch(e=>{console.error(`Failed to load theme preference:`,e)}),w({command:{id:`fullscreen`,name:`Toggle fullscreen`,description:`Toggles fullscreen mode`,parameters:[]},handler:{execute:async e=>{let t=document.documentElement;document.fullscreenElement===t?await document.exitFullscreen():await t.requestFullscreen()}},contribution:{target:Mh,name:$_,icon:`expand`,label:`Fullscreen`}}),w({command:{id:`open_extensions`,name:`Open Extensions`,description:`Opens the extensions registry`,parameters:[]},handler:{execute:e=>{z_.loadEditor({title:`Extensions`,data:{},key:`system.extensions`,icon:`docks extensions`,state:{},component:e=>b`<docks-extensions id="${e}"></docks-extensions>`},`extensions-editor`).then()}}}),w({command:{id:`list_extensions`,name:`List extensions`,description:`Lists all available extensions with their status (enabled/disabled)`,parameters:[],output:[{name:`extensions`,description:`array of extension objects with id, name, description, experimental flag, and enabled status`}]},handler:{execute:async e=>ig.getExtensions().map(e=>({id:e.id,name:e.name,description:e.description,experimental:e.experimental,enabled:ig.isEnabled(e.id)}))}}),w({command:{id:`toast_message`,name:`Toast message to user`,description:`Shows a toast message`,parameters:[{name:`message`,description:`the message to toast`,required:!0},{name:`type`,description:`the toast type: info (default), or error`,required:!1}]},handler:{execute:({params:{message:e,type:t}})=>{e&&(t===`error`?S(e):Hn(e))}}});var Vv=`//#region src/core/js-runtime-worker.js
/**
