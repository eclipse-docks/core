...
This is your first file. You can edit it and save your changes.`}:{}}},{id:`open-text-file`,title:`Open welcome.txt`,description:`Open the "welcome.txt" file in the editor.`,preCondition:async()=>await F(),postCondition:()=>I(),command:`open_editor`,commandParams:async()=>{let e=await M();return e?{path:e}:{}}},{id:`edit-and-save`,title:`Type something and save`,description:`Type some text in the editor to modify the file, then save it using Ctrl+S or the save button.`,preCondition:()=>I(),postCondition:()=>L()},{id:`close-text-file`,title:`Close the file`,description:`Close the editor tab by clicking the X button on the tab.`,preCondition:()=>I(),postCondition:()=>R()}]});var B=`.system.ai-config`;function V(e){return e&&typeof e.getFilePath==`function`}function H(){let e=c.get();return!e||!V(e)?!1:e.getFilePath()===B}async function U(){try{let e=await E.get(te);if(!e||!e.defaultProvider)return!1;let t=e.providers?.find(t=>t.name===e.defaultProvider);return t?!!t.apiKey&&t.apiKey.trim()!==``:!1}catch{return!1}}function W(){let e=c.get();return!e||!V(e)||e.getFilePath()!==B?!1:e.isDirty()===!0}function G(){return H()?!W():!1}function re(){return!H()}async function ie(){try{let e=await E.get(`aiChatSessions`);if(!e||typeof e!=`object`)return!1;for(let t in e){let n=e[t];if(n?.history&&Array.isArray(n.history)&&n.history.some(e=>e.role===`user`&&e.content&&e.content.trim()!==``))return!0}return!1}catch{return!1}}function K(){return y.getCurrentApp()?.name||`AppSpace`}g.registerContribution(k,{id:`docks.ai-setup`,title:()=>`Set up AI in ${K()}`,description:()=>`Configure an LLM provider to enable AI chat features in ${K()}`,icon:`robot`,label:``,category:`Getting Started`,initialize:e=>{let t=[];return t.push(_(c,()=>{e.requestUpdate()})),t.push(_(l,()=>{e.requestUpdate()})),n(ne,()=>{e.requestUpdate()}),()=>{t.forEach(e=>e())}},steps:[{id:`open-ai-settings`,title:`Open AI Settings`,description:`Open the AI settings editor by clicking the robot icon in the toolbar or using the command palette.`,preCondition:()=>!0,postCondition:()=>H(),command:`open_ai_config`},{id:`configure-llm-provider`,title:`Configure LLM Provider`,description:`Select a provider as default and enter an API key. Make sure to save your changes using Ctrl+S or the save button.`,preCondition:()=>H(),postCondition:async()=>{let e=await U(),t=G();return e&&t}},{id:`save-and-close`,title:`Save and Close`,description:`Save your changes (if not already saved) and close the AI settings editor tab.`,preCondition:()=>H(),postCondition:()=>re()},{id:`type-in-chat`,title:`Type in Chat`,description:`Open the AI chat view (if not already open) and type a message to test your AI configuration.`,preCondition:async()=>await U(),postCondition:async()=>await ie()}]});var q=`howto/show-panel`,J=`howto/toggle-panel`,Y=`howto-panel`,X={x:100,y:100},Z={width:400,height:300},Q=class extends d{constructor(...e){super(...e),this.contributions=[],this.activeContributionId=null,this.stepStates=new Map,this.isMinimized=!1,this.isVisible=!1,this.positionX=X.x,this.positionY=X.y,this.isDragging=!1,this.dragPreviewPosition=null,this.dragStartPosition={x:0,y:0},this.panelRef=f(),this.handleDragStart=e=>{let t=e.target;if(this.isDragTarget(t)||!this.panelRef.value)return;let n=this.panelRef.value.getBoundingClientRect();this.dragStartPosition={x:e.clientX-n.left,y:e.clientY-n.top},this.isDragging=!0,this.dragPreviewPosition={x:this.positionX,y:this.positionY},this.requestUpdate(),e.preventDefault(),e.stopPropagation()},this.handleDragMove=e=>{if(!this.isDragging||!this.dragPreviewPosition)return;let t=this.getViewportBounds(),n=Math.max(0,Math.min(e.clientX-this.dragStartPosition.x,t.maxX)),r=Math.max(0,Math.min(e.clientY-this.dragStartPosition.y,t.maxY));(this.dragPreviewPosition.x!==n||this.dragPreviewPosition.y!==r)&&(this.dragPreviewPosition={x:n,y:r},this.requestUpdate())},this.handleDragEnd=async()=>{if(!this.isDragging||!this.dragPreviewPosition)return;this.isDragging=!1;let e=this.dragPreviewPosition;this.dragPreviewPosition=null,this.positionX=e.x,this.positionY=e.y,await this.saveSettings(),this.requestUpdate()}}async doBeforeUI(){if(this.loadContributions(),n(D,e=>{e.target===`system.howtos`&&(this.loadContributions(),this.requestUpdate())}),n(q,()=>this.showPanel()),n(J,()=>this.toggleVisibility()),await this.loadSettings(),!s.isConnected()&&this.isVisible===!1){let e=await E.getDialogSetting(Y);(!e||e.visible===void 0)&&(this.isVisible=!0,await this.saveSettings())}n(o,()=>{(async()=>{let e=await E.getDialogSetting(Y);!e||e.visible})()})}doInitUI(){this.boundHandleDragMove=this.handleDragMove.bind(this),this.boundHandleDragEnd=this.handleDragEnd.bind(this),document.addEventListener(`mousemove`,this.boundHandleDragMove),document.addEventListener(`mouseup`,this.boundHandleDragEnd)}firstUpdated(e){super.firstUpdated(e)}loadContributions(){this.contributions=A.getAllContributions()}async loadSettings(){let e=await E.getDialogSetting(Y);e&&(e.position&&(this.positionX=e.position.x||X.x,this.positionY=e.position.y||X.y),e.visible!==void 0&&(this.isVisible=e.visible))}async saveSettings(){await E.setDialogSetting(Y,{position:{x:this.positionX,y:this.positionY},visible:this.isVisible})}isDragTarget(e){return!!(e.closest(`.header-actions`)||e.closest(`wa-button`))}getViewportBounds(){let e=this.panelRef.value?.offsetWidth||Z.width,t=this.panelRef.value?.offsetHeight||Z.height;return{maxX:window.innerWidth-e,maxY:window.innerHeight-t}}async startHowTo(e){let t=A.getContribution(e);if(!t){C(`HowTo "${e}" not found`);return}this.cleanupHowTo(),this.activeContributionId=e,this.isMinimized=!1;let n=t.steps.map(e=>({step:e,status:`pending`}));if(this.stepStates.set(e,n),t.initialize){let n={requestUpdate:()=>this.recheckActiveStepConditions(),contributionId:e};this.howtoCleanup=t.initialize(n)||void 0}this.requestUpdate(),await this.checkPreConditions(e,0)}cleanupHowTo(){this.howtoCleanup&&=(this.howtoCleanup(),void 0)}getStepState(e,t){let n=this.stepStates.get(e);return n&&t<n.length?n[t]:null}async checkPreConditions(e,t){let n=this.getStepState(e,t);if(n){if(!n.step.preCondition){n.preConditionMet=!0,this.requestUpdate();return}try{n.preConditionMet=await n.step.preCondition(),this.requestUpdate()}catch(e){console.error(`Pre-condition check failed for step ${n.step.id}:`,e),n.preConditionMet=!1,this.requestUpdate()}}}async checkPostConditions(e,t){let n=this.getStepState(e,t);if(n){if(!n.step.postCondition){this.completeStep(e,t);return}try{let r=await n.step.postCondition();n.postConditionMet=r,n.status=r?`completed`:`failed`,r&&this.activateNextStep(e,t),this.requestUpdate()}catch(e){console.error(`Post-condition check failed for step ${n.step.id}:`,e),n.postConditionMet=!1,n.status=`failed`,this.requestUpdate()}}}completeStep(e,t){let n=this.getStepState(e,t);n&&(n.status=`completed`,this.activateNextStep(e,t),this.requestUpdate())}async activateNextStep(e,t){let n=this.stepStates.get(e);if(!n||t+1>=n.length)return;let r=n[t+1];r.status=`active`,await this.checkPreConditions(e,t+1)}async recheckActiveStepConditions(){if(!this.activeContributionId)return;let e=this.stepStates.get(this.activeContributionId);if(!e)return;let t=e.findIndex(e=>e.status===`active`);if(t!==-1){let n=e[t],r=n.step;if(r.postCondition)try{if(await r.postCondition()&&n.status===`active`){await this.checkPostConditions(this.activeContributionId,t);return}}catch{}}for(let t=0;t<e.length;t++){let n=e[t];n.status===`pending`&&n.step.preCondition&&await this.checkPreConditions(this.activeContributionId,t)}this.requestUpdate()}async executeStep(e,t){let n=this.getStepState(e,t);n&&await this.validatePreConditions(n,e,t)&&(n.status=`active`,this.requestUpdate(),!(n.step.command&&!await this.executeStepCommand(n))&&await this.checkPostConditions(e,t))}async validatePreConditions(e,t,n){return e.step.preCondition?((e.preConditionMet===void 0||e.preConditionMet===!1)&&await this.checkPreConditions(t,n),e.preConditionMet===!0?!0:(C(`Pre-conditions not met for step: ${e.step.title}`),!1)):!0}async executeStepCommand(e){if(!e.step.command)return!0;try{let t=e.step.commandParams,n=typeof t==`function`?await t():t||{},r=h.createExecutionContext(n);return await h.execute(e.step.command,r),!0}catch(t){return console.error(`Failed to execute command for step ${e.step.id}:`,t),C(`Failed to execute step: ${e.step.title}`),e.status=`failed`,this.requestUpdate(),!1}}async runStepCommand(e,t){let n=this.getStepState(e,t);if(!(!n||!n.step.command)){if(n.step.preCondition&&!await n.step.preCondition()){C(`Pre-conditions not met for step: ${n.step.title}`);return}await this.executeStepCommand(n)&&await this.checkPostConditions(e,t)}}skipStep(e,t){let n=this.getStepState(e,t);!n||!n.step.optional||(n.status=`skipped`,this.activateNextStep(e,t),this.requestUpdate())}closeHowTo(){this.cleanupHowTo(),this.activeContributionId=null,this.stepStates.clear(),this.requestUpdate()}toggleMinimize(){this.isMinimized=!this.isMinimized,this.requestUpdate()}async showPanel(){this.isVisible=!0,this.isMinimized=!1,await this.saveSettings(),this.requestUpdate()}async hidePanel(){this.isVisible=!1,await this.saveSettings(),this.requestUpdate()}async toggleVisibility(){this.isVisible?await this.hidePanel():await this.showPanel()}renderStep(e,t,n){let{step:r,status:i,preConditionMet:a,postConditionMet:o}=e,s=i===`active`,c=i===`completed`,l=i===`failed`,u=i===`pending`,d=i===`skipped`;return v`
            <div class="step ${i}" ?data-active=${s}>
                <div class="step-header">
                    ...
                    <div class="step-status">
                        ...
                        `:x}
                        ${c?v`<wa-icon name="check-circle" class="status-icon completed"></wa-icon>`:x}
                        ${l?v`<wa-icon name="xmark-circle" class="status-icon failed"></wa-icon>`:x}
                        ${d?v`<wa-icon name="minus-circle" class="status-icon skipped"></wa-icon>`:x}
                        ${u?v`<wa-icon name="circle" class="status-icon pending"></wa-icon>`:x}
                        ${s?v`<wa-icon name="play-circle" class="status-icon active"></wa-icon>`:x}
                    </div>
                </div>
                <div class="step-description">${r.description}</div>
                ${r.preCondition&&a!==void 0?v`
                    <div class="condition pre-condition ${a?`met`:`not-met`}">
                        <wa-icon name="${a?`check`:`xmark`}"></wa-icon>
                        <span>Pre-condition: ${a?`Met`:`Not met`}</span>
                    </div>
                `:x}
                ${r.postCondition&&o!==void 0?v`
        ...
        `}render(){if(!this.isVisible)return x;let e=this.activeContributionId?A.getContribution(this.activeContributionId):null,t=this.activeContributionId&&this.stepStates.get(this.activeContributionId)||[];return v`
            ${this.dragPreviewPosition?v`
                <div 
                    class="howto-panel-drag-preview"
                style=${S({left:`${this.dragPreviewPosition.x}px`,top:`${this.dragPreviewPosition.y}px`,width:`${this.panelRef.value?.offsetWidth||Z.width}px`,height:`${this.panelRef.value?.offsetHeight||Z.height}px`,display:`block`,visibility:`visible`})}
                ></div>
            `:x}
            <div 
                class="howto-panel ${this.isMinimized?`minimized`:``} ${this.dragPreviewPosition?`dragging`:``}"
                style=${S({left:`${this.positionX}px`,top:`${this.positionY}px`,transform:`translateZ(0)`})}
                ${p(this.panelRef)}
            >
                    ...
                    <div class="panel-content">
                        ...
                        `:v`
                            <div class="workflows-list">
                                ...
                                `:this.contributions.map(e=>{let t=typeof e.title==`function`?e.title():e.title,n=e.description?typeof e.description==`function`?e.description():e.description:null;return v`
    ...
    `}};m([w()],Q.prototype,`contributions`,void 0),m([w()],Q.prototype,`activeContributionId`,void 0),m([w()],Q.prototype,`stepStates`,void 0),m([w()],Q.prototype,`isMinimized`,void 0),m([w()],Q.prototype,`isVisible`,void 0),m([w()],Q.prototype,`positionX`,void 0),m([w()],Q.prototype,`positionY`,void 0),m([w()],Q.prototype,`dragPreviewPosition`,void 0),Q=m([ee(`docks-howto-panel`)],Q);var $=r(`HowToExtension`);function ae(n){$.info(`HowTo system extension loaded`),e.put(`howToService`,A);let r=()=>{if(document.querySelector(`docks-howto-panel`))return;let e=document.createElement(`docks-howto-panel`);document.body.appendChild(e),$.info(`HowTo panel added to DOM`)};if(document.body)requestAnimationFrame(()=>{r()});else{let e=()=>{document.body?r():requestAnimationFrame(e)};requestAnimationFrame(e)}u({command:{id:`howto.show-panel`,name:`Show HowTo Panel`,description:`Shows the HowTo workflows panel`,icon:`list-check`,parameters:[]},handler:{execute:()=>{t(q,null)}}}),u({command:{id:`howto.toggle-panel`,name:`Toggle HowTo Panel`,description:`Toggles the visibility of the HowTo workflows panel`,icon:`list-check`,keyBinding:`CTRL+SHIFT+H`,parameters:[]},handler:{execute:()=>{t(J,null)}},contribution:{target:b,icon:`list-check`,label:`HowTo`}}),$.info(`HowTo system extension initialized`)}export{k as HOWTO_CONTRIBUTION_TARGET,ae as default,A as howToService};