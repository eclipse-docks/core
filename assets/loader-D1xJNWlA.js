import{d as e,u as t}from"./fs-access-BzDvih72-I3HNOLAJ.js";import{A as n,I as r,K as i,R as a,T as o,U as s,V as c,W as l,ht as u,j as d,k as f,mt as p,s as m,u as h}from"./dist-DG4qwUvd.js";import"./lit-Dr0iA5ch.js";var g,_=`catalog.root`,v=class extends m{static{g=this}constructor(...e){super(...e),this.treeRef=f()}doBeforeUI(){this.rebuildTree(),this.contributionsSubscriptionToken=t(c,e=>{(e.target===`catalog.root`||e.target?.startsWith(`catalog.`))&&this.rebuildTree()})}doClose(){this.contributionsSubscriptionToken&&=(e(this.contributionsSubscriptionToken),void 0),super.doClose()}rebuildTree(){let e=i.getContributions(_);this.rootNodes=this.toTreeNodes(e),this.requestUpdate()}renderToolbar(){return p`
            <lyra-command
