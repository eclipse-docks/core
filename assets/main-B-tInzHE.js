...
<li><a href="https://www.eclipse.org/legal/" target="_blank" rel="noopener noreferrer">Legal</a></li>
</ul>`;function fe(){e(`Eclipse legal`,de,!0)}r.registerContribution(s,{label:`Eclipse legal`,slot:`end`,component:()=>i`
      <wa-button
        appearance="plain"
        variant="brand"
        size="s"
    ...
    `});var pe=3,me=5,J=[{title:`Standup`,time:`Today 9:00`,location:`Room A`},{title:`Sprint planning`,time:`Tomorrow 14:00`,location:`Room B`},{title:`Design review`,time:`Wed 10:00`,location:`Call`}],Y=class extends u{static{this.styles=p`
        :host {
            display: block;
    ...
    `}render(){return i`
        ...
        `}};Y=t([o(`docks-dashboard-welcome`)],Y);var he=[{id:`1`,title:`Review pull request #142`,done:!1,due:`Today`},{id:`2`,title:`Update documentation`,done:!0},{id:`3`,title:`Fix login redirect bug`,done:!1,due:`Tomorrow`},{id:`4`,title:`Prepare sprint demo`,done:!1,due:`Fri`},{id:`5`,title:`Sync with design team`,done:!0}],X=class extends u{constructor(...e){super(...e),this.tasks=[...he]}static{this.styles=p`
        :host {
            display: block;
            padding: var(--wa-space-l);
            height: 100%;
    ...
    `}toggleTask(e){this.tasks=this.tasks.map(t=>t.id===e?{...t,done:!t.done}:t)}render(){return i`
            <ul class="taslist">
                ${this.tasks.map(e=>i`
                        <li class="tasitem ${e.done?`done`:``}">
                            ...
                            ${e.due?i`<span class="tasdue">${e.due}</span>`:``}
                        </li>
                    `)}
            </ul>
        `}};t([f()],X.prototype,`tasks`,void 0),X=t([o(`docks-dashboard-my-tasks`)],X);var Z=[{title:`Standup`,start:`9:00`,end:`9:15`,day:`Mon`,location:`Room A`},{title:`Sprint planning`,start:`14:00`,end:`15:30`,day:`Tue`,location:`Room B`},{title:`Design review`,start:`10:00`,end:`11:00`,day:`Wed`,location:`Call`},{title:`1:1 with manager`,start:`16:00`,end:`16:30`,day:`Thu`,location:`Room C`},{title:`Retrospective`,start:`11:00`,end:`12:00`,day:`Fri`,location:`Room A`}],Q=class extends u{static{this.styles=p`
        :host {
            display: block;
            padding: var(--wa-space-l);
            height: 100%;
    ...
    `}render(){let e=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`];return i`
            <div class="calendar-section">
                <div class="weeheader">
                    <span></span>
                    ${e.map(e=>i`<span class="day-col">${e}</span>`)}
                </div>
                <div class="meetings-grid">
                    <div class="time-slot"></div>
                    ${e.map(e=>i`
                            <div class="day-cell">
                                ${Z.filter(t=>t.day===e).map(e=>i`
        ...
        `}};Q=t([o(`docks-dashboard-meetings`)],Q),r.registerContribution(`dashboard-toolbar-top`,{label:`Dashboard`,slot:`start`,component:()=>i`
    <div
...
`});var $=class extends c{renderContent(){return i`<slot></slot>`}};$=t([o(`docks-view-wrapper`)],$);var ge=(e,t,n,r,i)=>({name:e,label:t,icon:n,closable:i??!1,toolbar:!1,component:e=>r()}),_e=[[`dashboard-home`,`Overview`,`house`,()=>i`<docks-dashboard-welcome></docks-dashboard-welcome>`,!1],[`dashboard-tasks`,`My Tasks`,`list-check`,()=>i`<docks-dashboard-my-tasks></docks-dashboard-my-tasks>`,!0],[`dashboard-meetings`,`Meetings`,`calendar-days`,()=>i`<docks-dashboard-meetings></docks-dashboard-meetings>`,!0]];for(let[e,t,n,i,a]of _e)r.registerContribution(l,ge(e,t,n,i,a)),r.registerContribution(`dashboard-views`,{label:t,icon:n,showLabel:!0,command:`open_view_as_editor`,params:{name:e}});r.registerContribution(`dashboard-views-toolbar-bottom`,{label:`Profile`,icon:`user`,command:`open_user_profile`}),r.registerContribution(`dashboard-views-toolbar-bottom`,{label:`Settings`,icon:`docks settings`,command:`open_settings`}),r.registerContribution(ee,{id:`dashboard`,name:`Dashboard`,label:`Dashboard`,icon:`table-cells`,component:()=>i`<style>
      .dashboard-shell {
        display: flex;
        flex-direction: column;
        height: 100vh;
    ...
    <div class="dashboard-shell">
      <div class="toolbar-top">
        ...
        <docks-toolbar id=${re}></docks-toolbar>
      </div>
    ...
    </div>`,onShow(){requestAnimationFrame(()=>{n.execute(`open_view_as_editor`,{params:{name:`dashboard-home`}}).catch(()=>{})})}}),r.registerContribution(te,{label:`Eclipse Docks`,slot:`start`,component:()=>i`
    <div
      style="
        display: inline-flex;
        align-items: center;
