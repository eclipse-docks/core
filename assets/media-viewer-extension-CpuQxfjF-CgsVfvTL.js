import{n as e}from"./fs-access-DTXPsV1W-Dp772n0E.js";import{P as t,_t as n,dt as r,ft as i,mt as a,n as o,o as s,ut as c,vt as l}from"./dist-DkbPbSj1.js";var u=[`.pdf`,`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],d=e=>{let t=e.toLowerCase();return t.endsWith(`.pdf`)?`file-pdf`:t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?`image`:`file`},f=e=>{let t=e.getName().toLowerCase();return u.some(e=>t.endsWith(e))},p=[`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],m=e=>{let t=e.getName().toLowerCase();return p.some(e=>t.endsWith(e))};o.registerEditorInputHandler({editorId:`system.media-viewer`,label:`Media viewer`,canHandle:t=>t instanceof e&&f(t),handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:d(e.getName()),state:{}};return t.component=e=>n`
    ...
    `}};t([r({attribute:!1})],h.prototype,`input`,void 0),t([c()],h.prototype,`mediaUrl`,void 0),t([c()],h.prototype,`imageNaturalWidth`,void 0),t([c()],h.prototype,`imageNaturalHeight`,void 0),t([c()],h.prototype,`overlays`,void 0),h=t([i(`docks-media-viewer`)],h);export{h as DocksMediaViewer};