import{n as e}from"./fs-access-Cjcg0_Me-BYL2BwWI.js";import{F as t,dt as n,ft as r,ht as i,n as a,o,pt as s,vt as c,yt as l}from"./dist-CK5IWWjX.js";var u=[`.pdf`,`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],d=e=>{let t=e.toLowerCase();return t.endsWith(`.pdf`)?`file-pdf`:t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?`image`:`file`},f=e=>{let t=e.getName().toLowerCase();return u.some(e=>t.endsWith(e))},p=[`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],m=e=>{let t=e.getName().toLowerCase();return p.some(e=>t.endsWith(e))};a.registerEditorInputHandler({editorId:`system.media-viewer`,label:`Media viewer`,canHandle:t=>t instanceof e&&f(t),handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:d(e.getName()),state:{}};return t.component=e=>c`
            <docks-media-viewer id="${e}" .input=${t}></docks-media-viewer>`,t},ranking:1e3});var h=class extends o{constructor(...e){super(...e),this.scrollMode=`native`,this.imageNaturalWidth=0,this.imageNaturalHeight=0,this.overlays=[],this.onImageLoad=e=>{let t=e.target;t?.naturalWidth&&t?.naturalHeight&&(this.imageNaturalWidth=t.naturalWidth,this.imageNaturalHeight=t.naturalHeight)}}getMediaUrl(){return this.mediaUrl}getIsImage(){return!!(this.input?.data instanceof e&&this.mediaUrl&&m(this.input.data))}getImageDimensions(){return{width:this.imageNaturalWidth,height:this.imageNaturalHeight}}setOverlays(e){this.overlays=e??[]}getOverlays(){return[...this.overlays]}clearOverlays(){this.overlays=[]}doClose(){this.mediaUrl&&this.mediaUrl.startsWith(`blob:`)&&URL.revokeObjectURL(this.mediaUrl),this.input=void 0,this.mediaUrl=void 0,this.overlays=[],this.imageNaturalWidth=0,this.imageNaturalHeight=0}async doInitUI(){await this.loadMedia()}async loadMedia(){if(!this.input?.data||!(this.input.data instanceof e))return;let t=await this.input.data.getContents({uri:!0});this.mediaUrl=t,this.overlays=[]}renderContent(){return this.mediaUrl?this.getIsImage()?c`
    ...
    `}};t([r({attribute:!1})],h.prototype,`input`,void 0),t([n()],h.prototype,`mediaUrl`,void 0),t([n()],h.prototype,`imageNaturalWidth`,void 0),t([n()],h.prototype,`imageNaturalHeight`,void 0),t([n()],h.prototype,`overlays`,void 0),h=t([s(`docks-media-viewer`)],h);export{h as DocksMediaViewer};