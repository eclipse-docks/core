import{P as e,W as t,_t as n,a as r,ft as i,m as a}from"./dist-DkbPbSj1.js";var o=class extends r{constructor(...e){super(...e),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){let e=performance.memory;if(!e)return n``;let t=(e.totalJSHeapSize/1048576).toFixed(1),r=(e.jsHeapSizeLimit/1048576).toFixed(0),i=e.totalJSHeapSize/e.jsHeapSizeLimit*100,a=i.toFixed(0);return n`
        ...
        `}};o=e([i(`docks-memory-usage`)],o),t.registerContribution(a,{target:a,label:`Memory`,component:`<docks-memory-usage></docks-memory-usage>`});