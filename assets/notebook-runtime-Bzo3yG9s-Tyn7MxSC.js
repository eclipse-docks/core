        ...
        `;return l`
            ...
            ${this.kernel?this.kernel.connect?l`
                <wa-button
                    ...
                    title=${n}
                >
                    <wa-icon name="circle" label="Kernel status" style=${m({color:i})}></wa-icon>
                    ${r}
                </wa-button>
            `:l`
...
`).length*19+10),u=r?l`
                    ...
                    <div class="cell code-cell ${r?`executing`:``}">
                        ...
                        ${n?l`
                            <div class="cell-output ${n.type===`error`?`output-error`:``}">
                                ...
                                `:``}
                                ${n.data?l`<pre><code>${n.data}</code></pre>`:``}
                            </div>
                        `:``}
                        ${this.renderFooterActions(t)}
                    </div>
    ...
    `}};s([u({attribute:!1})],S.prototype,`input`,void 0),s([h()],S.prototype,`notebook`,void 0),s([h()],S.prototype,`cellOutputs`,void 0),s([h()],S.prototype,`executingCells`,void 0),s([h()],S.prototype,`availableKernels`,void 0),s([h()],S.prototype,`selectedKernelId`,void 0),s([h()],S.prototype,`kernel`,void 0),s([h()],S.prototype,`kernelConnected`,void 0),s([h()],S.prototype,`kernelConnecting`,void 0),s([h()],S.prototype,`kernelVersion`,void 0),s([h()],S.prototype,`editingMarkdownCells`,void 0),s([h()],S.prototype,`executionCounter`,void 0),s([h()],S.prototype,`isRunningAll`,void 0),s([h()],S.prototype,`highlightedCellIndex`,void 0),s([h()],S.prototype,`cellHeights`,void 0),S=s([d(`docks-notebook-editor`)],S);export{S as DocksNotebookEditor};