...
`).length*19+10),c=r?g`
        ...
        `}renderCell(e,t){if(e.cell_type===`markdown`)return this.renderMarkdownCell(e,t);if(e.cell_type===`code`)return this.renderCodeCell(e,t);{let t=this.getCellSource(e);return g`
