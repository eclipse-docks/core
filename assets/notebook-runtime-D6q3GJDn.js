...
`).length,l=19,i=10,o=100,a=Math.max(o,r*l+i);t.style.height=`${a}px`;const c=se.create(t,{value:s,language:"python",theme:this.getMonacoTheme(),minimap:{enabled:!1},scrollBeyondLastLine:!1,lineNumbers:"on",renderLineHighlight:"all",automaticLayout:!0,fontSize:14,tabSize:4,wordWrap:"on"});let h=!1;c.onDidFocusEditorText(()=>{h=!0,this.focusedCellIndex=n}),c.onDidBlurEditorText(()=>{h=!1,this.focusedCellIndex===n&&(this.focusedCellIndex=-1)}),t.addEventListener("wheel",u=>{if(!h){const p=c.getScrollTop(),m=c.getScrollHeight(),f=c.getContentHeight(),y=m>f,M=u.deltaY<0&&p<=0||u.deltaY>0&&p+f>=m;(!y||M)&&u.stopImmediatePropagation()}},{passive:!0,capture:!0}),c.onDidContentSizeChange(()=>{const u=c.getContentHeight();t.style.height=`${Math.max(o,u+i)}px`,c.layout()}),c.onDidChangeModelContent(()=>{const u=c.getValue(),p=this.getCellSource(e);u!==p&&this.markDirty(!0)}),this.monacoEditors.set(n,c)}getMonacoTheme(){const t=document.documentElement;return t.classList.contains("wa-dark")?"vs-dark":t.classList.contains("wa-light")?"vs":"vs-dark"}openPackageManager(){const t=this.notebook?.metadata?.required_packages||[];qe.showPackageManager({packages:t,pyenv:this.pyenv,onPackageAdded:e=>{this.notebook&&(this.notebook.metadata||(this.notebook.metadata={}),this.notebook.metadata.required_packages||(this.notebook.metadata.required_packages=[]),this.notebook.metadata.required_packages.includes(e)||(this.notebook.metadata.required_packages.push(e),this.markDirty(!0)))},onPackageRemoved:e=>{if(!this.notebook?.metadata?.required_packages)return;const n=this.notebook.metadata.required_packages.indexOf(e);n>-1&&(this.notebook.metadata.required_packages.splice(n,1),this.markDirty(!0))}})}updated(t){super.updated(t),(t.has("pyConnected")||t.has("pyConnecting")||t.has("pyVersion")||t.has("isRunningAll"))&&this.updateToolbar(),this.notebook?.cells&&this.notebook.cells.forEach((e,n)=>{if(e.cell_type==="code"){const s=this.cellRefs.get(n);s?.value&&!this.monacoEditors.has(n)&&this.initializeMonacoEditor(s.value,e,n)}})}render(){return this.notebook?k`
    ...
    `;x([Ee({attribute:!1})],w.prototype,"input",2);x([$()],w.prototype,"notebook",2);x([$()],w.prototype,"cellOutputs",2);x([$()],w.prototype,"executingCells",2);x([$()],w.prototype,"pyenv",2);x([$()],w.prototype,"pyConnected",2);x([$()],w.prototype,"pyConnecting",2);x([$()],w.prototype,"pyVersion",2);x([$()],w.prototype,"editingMarkdownCells",2);x([$()],w.prototype,"executionCounter",2);x([$()],w.prototype,"isRunningAll",2);x([$()],w.prototype,"highlightedCellIndex",2);w=x([Pe("lyra-notebook-editor")],w);export{w as LyraNotebookEditor};
