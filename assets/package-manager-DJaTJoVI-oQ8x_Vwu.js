import{_ as e}from"./fs-access-DTXPsV1W-Dp772n0E.js";import{N as t,P as n,_t as r,dt as i,ft as a,j as o,pt as s,ut as c,vt as l}from"./dist-DkbPbSj1.js";var u=class extends s{constructor(...e){super(...e),this.open=!1,this.packages=[],this.loadingPackages=!1}configure(e){this.packages=e.packages||[],this.pyenv=e.pyenv,this.onPackageAdded=e.onPackageAdded,this.onPackageRemoved=e.onPackageRemoved}show(){this.open=!0}hide(){this.open=!1}addPackage(e){if(!e||e.trim()===``)return;let t=e.trim();this.packages.includes(t)||(this.packages=[...this.packages,t],this.onPackageAdded?.(t))}removePackage(e){this.packages.indexOf(e)>-1&&(this.packages=this.packages.filter(t=>t!==e),this.onPackageRemoved?.(e))}async reloadPackages(){if(this.pyenv){this.loadingPackages=!0,this.packageLoadError=void 0;try{await this.pyenv.loadPackages(this.packages)}catch(e){this.packageLoadError=String(e)}finally{this.loadingPackages=!1}}}render(){let e;return r`
            <wa-dialog 
                ...
                <div slot="footer" class="package-manager-footer">
                    ${this.pyenv&&this.packages.length>0?r`
                        <wa-button 
                            variant="default"
    ...
    `}};n([i({type:Boolean})],u.prototype,`open`,void 0),n([i({type:Array})],u.prototype,`packages`,void 0),n([i({attribute:!1})],u.prototype,`pyenv`,void 0),n([c()],u.prototype,`loadingPackages`,void 0),n([c()],u.prototype,`packageLoadError`,void 0),u=n([a(`docks-python-package-manager`)],u);var d=new class{showPackageManager(e){return this.managerInstance||(this.managerInstance=document.createElement(`docks-python-package-manager`),document.body.appendChild(this.managerInstance)),this.managerInstance.configure(e),this.managerInstance.show(),this.managerInstance}getManager(){return this.managerInstance}};e.put(`pythonPackageManagerService`,d);export{d as t};