...
`),cursorLine:o}}render(){let e=[];for(let t=1;t<=this.lineCount;t++)e.push(t);let t=this.gutterScrollHeight>0?`${this.gutterScrollHeight}px`:`100%`;return u`
  ...
  `}};e([a({attribute:!1})],P.prototype,`initialBytes`,void 0),e([a({type:Number})],P.prototype,`seed`,void 0),e([a({type:Boolean})],P.prototype,`readOnly`,void 0),e([i()],P.prototype,`bytes`,void 0),P=e([c(`docks-hexeditor`)],P);var F=await l(Object.assign({"./i18n.de.json":()=>f(()=>import(`./i18n.de-CcEUJHGN-aRiAceGJ.js`),[]),"./i18n.en.json":()=>f(()=>import(`./i18n.en-DM0IIbWc-Cn-XejRY.js`),[])}),!0),I=class extends s{constructor(...e){super(...e),this.scrollMode=`native`,this.readOnly=!1,this.ready=!1,this.hexMode=!1,this.textValue=``,this.bytes=new Uint8Array,this.hexSeed=0,this.hexInitialBytes=new Uint8Array,this.binaryViewTruncated=!1,this.binarySourceByteLength=0,this.textRef=t(),this.hexRef=t(),this.onTextChange=e=>{this.textValue=e.detail.value,this.bytes=new TextEncoder().encode(this.textValue),this.markDirty(!0)},this.onHexChange=e=>{this.bytes=e.detail.bytes,this.textValue=new TextDecoder(`utf-8`,{fatal:!1}).decode(this.bytes),this.markDirty(!0)},this.onHexViewToggle=e=>{let t=e.target.checked;t!==this.hexMode&&(t?(this.bytes=new TextEncoder().encode(this.textValue),this.hexInitialBytes=new Uint8Array(this.bytes),this.hexSeed+=1,this.hexMode=!0):(this.textValue=new TextDecoder(`utf-8`,{fatal:!1}).decode(this.bytes),this.hexMode=!1),this.requestUpdate())}}async doInitUI(){let e=await this.input.data.getContents({blob:!0});this.hexMode=await g(e),this.hexMode?(e.size>8192?(this.bytes=new Uint8Array(await e.slice(0,m).arrayBuffer()),this.binaryViewTruncated=!0,this.binarySourceByteLength=e.size):(this.bytes=new Uint8Array(await e.arrayBuffer()),this.binaryViewTruncated=!1,this.binarySourceByteLength=0),this.textValue=new TextDecoder(`utf-8`,{fatal:!1}).decode(this.bytes),this.hexInitialBytes=new Uint8Array(this.bytes),this.hexSeed=1):(this.bytes=new Uint8Array(await e.arrayBuffer()),this.binaryViewTruncated=!1,this.binarySourceByteLength=0,this.textValue=new TextDecoder(`utf-8`,{fatal:!1}).decode(this.bytes)),this.ready=!0}save(){if(this.binaryViewTruncated)return;let e=new Blob([new Uint8Array(this.bytes)]);this.input?.data.saveContents(e),this.markDirty(!1)}doClose(){this.ready=!1,this.binaryViewTruncated=!1,this.binarySourceByteLength=0}getContent(){if(this.hexMode){let e=this.hexRef.value?.getBytesSnapshot();return e?[...e].map(e=>e.toString(16).padStart(2,`0`)).join(` `):null}return this.textRef.value?.getValue()??this.textValue}getSelection(){return this.hexMode?null:this.textRef.value?.getSelection()??null}getSnippet(e=5){return this.hexMode?null:this.textRef.value?.getSnippet(e)??null}getLanguage(){return null}getFilePath(){return this.input?.data?.getWorkspacePath()??null}renderToolbar(){if(!this.ready)return o;let e=e=>e.toLocaleString(),t=this.binaryViewTruncated&&this.binarySourceByteLength>0?F.BINARY_VIEW_TRUNCATED({shown:e(m),total:e(this.binarySourceByteLength)}):null;return u`
    ...
    `}renderContent(){return this.ready?this.hexMode?u`
        <docks-hexeditor
          ${n(this.hexRef)}
      ...
      ></docks-texteditor>
    `:u`<div class="placeholder"></div>`}static{this.styles=d`
    :host {
      display: flex;
      flex-direction: column;
      min-height: 0;
  ...
  `}};e([a({attribute:!1})],I.prototype,`input`,void 0),e([a({type:Boolean})],I.prototype,`readOnly`,void 0),e([i()],I.prototype,`ready`,void 0),e([i()],I.prototype,`hexMode`,void 0),e([i()],I.prototype,`textValue`,void 0),e([i()],I.prototype,`hexSeed`,void 0),e([i()],I.prototype,`hexInitialBytes`,void 0),e([i()],I.prototype,`binaryViewTruncated`,void 0),I=e([c(`docks-plain-editor`)],I);