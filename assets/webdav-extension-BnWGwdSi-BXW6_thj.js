import{d as e,m as t,n,o as r,r as i,t as a,u as o}from"./fs-access-DTXPsV1W-Dp772n0E.js";import{C as s,G as c,N as l,U as u,dt as d,gt as f,i as p,lt as m}from"./dist-DEtSYi1q.js";var h=class{constructor(e){if(this.baseUrl=e.url,e.username!==void 0){let t=`${e.username}:${e.password??``}`;this.authHeader=`Basic ${btoa(t)}`}}async propfind(e,t=1){let n=await fetch(new URL(e,this.baseUrl).href,{method:`PROPFIND`,headers:this.buildHeaders({Depth:t.toString(),"Content-Type":`application/xml`}),body:`<?xml version="1.0" encoding="UTF-8"?>
