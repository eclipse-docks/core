import{ae as E,H as h,w as c,a0 as d,W as N,ad as V,r as b,k as F,ag as T,f as O,d as x,Z as D,t as $,ah as H}from"./config-BohSmpxh-KV7tAD5O.js";class U{constructor(e){if(this.baseUrl=e.url,e.username!==void 0){const t=`${e.username}:${e.password??""}`;this.authHeader=`Basic ${btoa(t)}`}}async propfind(e,t=1){const o=await fetch(new URL(e,this.baseUrl).href,{method:"PROPFIND",headers:this.buildHeaders({Depth:t.toString(),"Content-Type":"application/xml"}),body:`<?xml version="1.0" encoding="UTF-8"?>
