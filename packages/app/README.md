...
To create your own app, copy this package, adjust `src/main.ts` (register your app, choose extensions and optional `layout`), and add your own dependencies as needed.
