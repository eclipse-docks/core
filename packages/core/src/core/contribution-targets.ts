...
/** HTML attributions collected by `docks-attribution`. */
export const SYSTEM_ATTRIBUTIONS = "system.attributions"

/** About dialog tabs (`TabContribution` collected by `docks-tabs`). */
export const ABOUT_TABS = "about.tabs"
...
export const SIDEBAR_AUXILIARY_BOTTOM = "sidebar-auxiliary-bottom"
